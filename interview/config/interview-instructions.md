...
| `KEYWORD_GENERATOR_PROMPT.md`                 | Master keyword generation spec (v3)                      |
...
Each keyword within a file has 19 sections (see `INTERVIEW_PROMPT.md` v3 for full spec):
...
3. Generate keyword list using `KEYWORD_GENERATOR_PROMPT.md` v3 spec
...
2. Generate keywords using `KEYWORD_GENERATOR_PROMPT.md` v3
