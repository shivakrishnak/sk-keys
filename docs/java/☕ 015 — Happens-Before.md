...
difficulty: ★★★ 
depends_on: Java Memory Model, Memory Barrier, volatile, synchronized, Thread used_by: volatile, synchronized, final, Thread.start, Thread.join, Concurrent Collections 
tags: #java, #jvm, #concurrency, #memory, #internals, #deep-dive
