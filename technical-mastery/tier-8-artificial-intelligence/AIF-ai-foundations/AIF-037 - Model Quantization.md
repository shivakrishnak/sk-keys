...
nav_order: 37
permalink: /technical-mastery/ai-foundations/model-quantization/
id: AIF-041
...
Activation quantization (W8A8): weights AND activations in
  int8
...
int8 (GPTQ):      76.1% MMLU, 7GB VRAM  → -0.2% quality,
  2× smaller
int4 (GPTQ):      75.6% MMLU, 3.5GB VRAM → -0.7% quality,
  4× smaller
int3 (GGUF):      73.1% MMLU, 2.6GB VRAM → -3.2% quality,
  5.4× smaller
int2 (GPTQ):      68.0% MMLU, 1.75GB VRAM → -8.3% quality,
  8× smaller
```
