...
nav_order: 46
permalink: /technical-mastery/ai-foundations/responsible-ai/
id: AIF-048
...
1. FAIRNESS
   ...
   WARNING: Different fairness metrics are mathematically
            incompatible - choosing a metric is a values
              decision
...
2. ACCOUNTABILITY
   ...
   Requirements:
     ...
     Is there a human in the loop for high-stakes
       decisions?
   Structure:
...
3. TRANSPARENCY
   ...
   Levels:
     ...
     Decision transparency: why was this specific decision
       made?
     Process transparency: how was the system designed and
       tested?
   Tools: SHAP, LIME, attention visualisation, saliency
     maps
...
5. PRIVACY
   Requirements:
     ...
     Differential privacy: outputs don't reveal training
       data
...
DESIGN PHASE:
  ...
  ✓ Data governance: consent, provenance,
    representativeness
