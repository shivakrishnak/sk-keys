...
nav_order: 43
permalink: /technical-mastery/ai-foundations/model-evaluation-metrics/
id: AIF-045
...
AUC-ROC: Area under ROC curve (TPR vs FPR)
          → Model's ability to discriminate across
            thresholds
```
...
BLEU (Bilingual Evaluation Understudy):
  ...
  Problem: rewards repetition; misses paraphrase; low
    correlation
