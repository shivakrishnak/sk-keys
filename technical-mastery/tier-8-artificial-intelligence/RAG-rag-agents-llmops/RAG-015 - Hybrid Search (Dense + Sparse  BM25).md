...
nav_order: 15
permalink: /technical-mastery/rag/hybrid-search-dense-sparse-bm25/
---
...
Dense path:
  embed(query) -> cosine search -> [doc3:0.91, doc7:0.88,
    doc1:0.85]
  Rank: doc3=1, doc7=2, doc1=3

Sparse path (BM25):
  tokenise(query) -> BM25 score -> [doc1:12.3, doc3:9.8,
    doc11:8.1]
  Rank: doc1=1, doc3=2, doc11=3

RRF (k=60):
  doc3: 1/(60+1) + 1/(60+2) = 0.01639+0.01613 = 0.03252
    (winner)
