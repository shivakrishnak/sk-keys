...
difficulty: ★★☆
depends_on: RAG-009, RAG-016
used_by:
related: RAG-020, RAG-025
tags:
  - rag
  - intermediate
  - algorithm
...
nav_order: 16
permalink: /technical-mastery/rag/re-ranking-in-rag-cross-encoder-cohere-rerank/
---
...
for query, expected_doc_id in eval_set:
    ...
    post_score =
        expected_doc_id in [r.metadata["id"] for r in reranked]
...
- `RAG-016 - Hybrid Search`  -  hybrid retrieval often combined with re-ranking

**Builds On This (learn these next):**

- `RAG-020 - Query Transformation`  -  complementary recall improvement approach
- `RAG-025 - Advanced Retrieval Techniques`  -  contextual compression, parent-child retrieval

**Alternatives / Comparisons:**

- `RAG-018 - Metadata Filtering`  -  precision improvement via structural constraints vs relevance scoring
...
**Q2 (Scale):** Your re-ranker achieves 0.85 NDCG@5. Adding hybrid search (RAG-016) improves your candidate recall from 60% to 80%. Does re-ranking benefit more from (a) a better cross-encoder model or (b) better candidate recall? Why?
