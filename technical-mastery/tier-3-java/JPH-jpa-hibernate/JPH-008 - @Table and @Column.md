...
nav_order: 8
permalink: /technical-mastery/jpa-hibernate/table-column-annotations/
---
...
│ SOLVES       │ naming; provides DDL constraint generatio│
├──────────────┼──────────────────────────────────────────┤
...
├──────────────┼──────────────────────────────────────────┤
│ AVOID WHEN   │ Default naming matches DB; Flyway control│
...
│              │ classes; annotations couple code to schem│
├──────────────┼──────────────────────────────────────────┤
