...
nav_order: 40
permalink: /technical-mastery/jpa-hibernate/inheritance-mapping/
---
...
```
┌─────────────────────────────────────────────────────────┐
│ SINGLE_TABLE │ One table; discriminator col; fast querie│
│              │ nullable subtype cols; no NOT NULL enfmt │
│ JOINED       │ Parent + child tables; FK join; normalize│
