...
nav_order: 27
permalink: /technical-mastery/jpa-hibernate/n-plus-1-problem/
---
...
spring.jpa.properties.hibernate.session.events.log.LOG_QUER
...
```
┌─────────────────────────────────────────────────────────┐
│ DETECT       │ show-sql=true; look for N identical SELEC│
