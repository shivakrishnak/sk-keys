...
nav_order: 49
permalink: /technical-mastery/jpa-hibernate/hibernate-envers/
---
...
@Transactional: updatePrice(42, 29.99)
  ...
  4. commit() -> both main table + audit table committed
    atomically

Resulting audit table:
  id=42, price=19.99, REV=1000, REVTYPE=0  (original ADD)
  id=42, price=29.99, REV=1001, REVTYPE=1  (MOD: price
    updated)
```
...
class FinancialAuditTest {
    ...
    void statusChange_shouldBeAudited() {
        ...
        FinancialTransaction loaded =
            txRepo.findById(id).orElseThrow();
...
_Why they ask:_ Tests practical Envers implementation.
...
_Why they ask:_ Tests awareness of Envers limitations.
_Strong answer includes:_
