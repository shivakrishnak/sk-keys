...
nav_order: 39
permalink: /technical-mastery/jpa-hibernate/pessimistic-locking/
---
...
Transaction A: Transfer $100 from Account 1 to Account 2
  T=1: SELECT ... FROM accounts WHERE id=1 FOR UPDATE
    [Lock 1]
  T=2: SELECT ... FROM accounts WHERE id=2 FOR UPDATE
    [Wait for Lock 2]

Transaction B: Transfer $50 from Account 2 to Account 1
  T=1: SELECT ... FROM accounts WHERE id=2 FOR UPDATE
    [Lock 2]
  T=2: SELECT ... FROM accounts WHERE id=1 FOR UPDATE
    [Wait for Lock 1]
