...
nav_order: 32
permalink: /technical-mastery/jpa-hibernate/jpa-auditing-createddate-lastmodifieddate/
---
...
4. AuditorAware<UserId> bean (for
...
em.flush() with dirty product:
  ...
  -> AuditingEntityListener.touchForUpdate(product)
     -> @CreatedDate: NOT changed (skip @CreatedDate on
       update)
     -> Sets @LastModifiedDate = now()
...
public class ProductService {
    ...
    public Product updatePrice(Long id, BigDecimal price) {
        ...
        p.setPrice(price);
        // flush at method end:
        // updatedAt: set to now() by AuditingEntityListener at
        // PreUpdate
...
│ CREATED_AT   │ and @CreatedBy to prevent accidental writ│
├──────────────┼──────────────────────────────────────────┤
