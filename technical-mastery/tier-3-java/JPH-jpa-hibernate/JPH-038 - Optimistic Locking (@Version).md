...
nav_order: 38
permalink: /technical-mastery/jpa-hibernate/optimistic-locking/
---
...
T4: User B updates -> total=250  (version still 1 in
  memory)
...
│ INCREMENT    │ Hibernate increments version automaticall│
├──────────────┼──────────────────────────────────────────┤
