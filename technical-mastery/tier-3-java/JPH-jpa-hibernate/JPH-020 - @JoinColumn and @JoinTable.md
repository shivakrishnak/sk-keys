...
nav_order: 20
permalink: /technical-mastery/jpa-hibernate/joincolumn-jointable/
---
...
```
┌─────────────────────────────────────────────────────────┐
│ @JoinColumn  │ FK column name; on owning side (@ManyToOn│
...
│ updatable    │ or @MapsId to prevent "mapped twice" erro│
├──────────────┼──────────────────────────────────────────┤
