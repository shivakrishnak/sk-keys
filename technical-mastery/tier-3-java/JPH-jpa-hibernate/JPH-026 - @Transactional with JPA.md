...
nav_order: 26
permalink: /technical-mastery/jpa-hibernate/transactional-with-jpa/
---
...
4. Stores connection in ThreadLocal
...
├──────────────┼──────────────────────────────────────────┤
│ SELF-INVOKE  │ @Transactional ignored on same-class call│
