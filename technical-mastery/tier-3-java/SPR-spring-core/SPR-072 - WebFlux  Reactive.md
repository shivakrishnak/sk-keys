...
nav_order: 72
permalink: /technical-mastery/spring/webflux-reactive/
id: SPR-010
...
public class UserController {
    ...
    public Mono<Dashboard> getDashboard(
        ...
        // Both calls execute in parallel - combined when both
        // complete
...
# (Reactor's BlockHound throws exception on blocking in reactive
# context)
