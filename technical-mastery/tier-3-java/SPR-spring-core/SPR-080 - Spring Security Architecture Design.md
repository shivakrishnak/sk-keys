...
difficulty: ★★★
depends_on: SPR-030, SPR-075, SPR-079
used_by:
related: SPR-077, SPR-081, SPR-035
tags:
  - spring
  - java
  - advanced
...
nav_order: 80
permalink: /technical-mastery/spr/spring-security-architecture-design/
---
...
| Field          | Value                                                                                                                                                        |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Depends on** | [[SPR-030 - Spring Security]], [[SPR-075 - Spring Data JPA]], [[SPR-079 - Spring Boot Configuration Strategy]]                                               |
| **Used by**    | -                                                                                                                                                            |
| **Related**    | [[SPR-077 - Spring Architecture at Scale]], [[SPR-081 - Microservice Decomposition with Spring Cloud]], [[SPR-035 - Spring Security OAuth2 Resource Server]] |
...
- [[SPR-030 - Spring Security]] - Spring Security fundamentals
- [[SPR-064 - JDK Dynamic Proxy]] - how Spring Security creates proxy-based AOP guards
- [[SPR-020 - AOP (Aspect-Oriented Programming)]] - the AOP mechanism behind `@PreAuthorize`

**Builds On This (learn these next):**

- [[SPR-035 - Spring Security OAuth2 Resource Server]] - JWT and OIDC configuration
- [[SPR-080 - Spring Security Architecture Design]] - this entry
- [[SPR-081 - Microservice Decomposition with Spring Cloud]] - security in distributed Spring systems
...
| TRADE-OFF     | Centralised control vs filter complexity
  |
| ONE-LINER     | Filter chain = authentication first,
  then |
|               | authorisation, always before controllers
  |
| NEXT EXPLORE  | SPR-035 (OAuth2), SPR-030 (Security)
  |
+----------------------------------------------------------
```
