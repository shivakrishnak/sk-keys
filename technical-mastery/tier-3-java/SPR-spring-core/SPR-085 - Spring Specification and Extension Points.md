...
difficulty: ★★★
depends_on: SPR-006, SPR-007, SPR-015, SPR-060, SPR-061, SPR-082
used_by:
related: SPR-084, SPR-067, SPR-086
tags:
  - spring
  - java
  - advanced
...
nav_order: 85
permalink: /technical-mastery/spr/spring-specification-and-extension-points/
---
...
| Field          | Value                                                                                                                                                                                                                                        |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[SPR-006 - IoC (Inversion of Control)]], [[SPR-007 - DI (Dependency Injection)]], [[SPR-015 - Bean Lifecycle]], [[SPR-060 - BeanPostProcessor]], [[SPR-061 - BeanFactoryPostProcessor]], [[SPR-082 - Spring Framework Internals Deep Dive]] |
| **Used by**    | -                                                                                                                                                                                                                                            |
| **Related**    | [[SPR-084 - Spring Native and GraalVM Integration]], [[SPR-067 - Spring Boot Auto-configuration Deep Dive]], [[SPR-086 - IoC-First Thinking]]                                                                                                |
...
- [[SPR-060 - BeanPostProcessor]] - the most commonly used extension point
- [[SPR-061 - BeanFactoryPostProcessor]] - the definition-phase extension point
- [[SPR-082 - Spring Framework Internals Deep Dive]] - the container lifecycle these points plug into

**Builds On This (learn these next):**

- [[SPR-067 - Spring Boot Auto-configuration Deep Dive]] - auto-configuration uses `DeferredImportSelector` + `@Conditional`
- [[SPR-084 - Spring Native and GraalVM Integration]] - `BeanRegistrationAotProcessor` for native-compatible extensions
- [[SPR-086 - IoC-First Thinking]] - how to design systems that use extension points correctly
...
|               | instances; SmartLifecycle: start/stop
  |
| NEXT EXPLORE  | SPR-067 (Auto-configuration),
  |
|               | SPR-086 (IoC-First Thinking)
  |
+----------------------------------------------------------
```
