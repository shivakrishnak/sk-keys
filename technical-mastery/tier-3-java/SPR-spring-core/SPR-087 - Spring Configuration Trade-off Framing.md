...
difficulty: ★★★
depends_on: SPR-016, SPR-019, SPR-067, SPR-079, SPR-086
used_by:
related: SPR-088, SPR-085, SPR-082
tags:
  - spring
  - java
  - advanced
...
nav_order: 87
permalink: /technical-mastery/spr/spring-configuration-trade-off-framing/
---
...
| Field          | Value                                                                                                                                                                                                                                   |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[SPR-016 - @Component and Stereotype Annotations]], [[SPR-019 - @Configuration and @Bean]], [[SPR-067 - Spring Boot Auto-configuration Deep Dive]], [[SPR-079 - Spring Boot Configuration Strategy]], [[SPR-086 - IoC-First Thinking]] |
| **Used by**    | -                                                                                                                                                                                                                                       |
| **Related**    | [[SPR-088 - Framework Selection Mental Model]], [[SPR-085 - Spring Specification and Extension Points]], [[SPR-082 - Spring Framework Internals Deep Dive]]                                                                             |
...
- [[SPR-016 - @Component and Stereotype Annotations]] - the component scan mechanism
- [[SPR-019 - @Configuration and @Bean]] - the `@Bean` factory method mechanism
- [[SPR-067 - Spring Boot Auto-configuration Deep Dive]] - the auto-configuration layer
- [[SPR-086 - IoC-First Thinking]] - the design philosophy that informs these choices

**Builds On This (learn these next):**

- [[SPR-088 - Framework Selection Mental Model]] - extends this framing to framework-level decisions
- [[SPR-085 - Spring Specification and Extension Points]] - the extension API for library authors
...
| USE WHEN      | Every time you register a new Spring
  bean|
...
|               | autoconfig=library default with override
  |
| NEXT EXPLORE  | SPR-088 (Framework Selection Mental
  Model)|
+----------------------------------------------------------
```
