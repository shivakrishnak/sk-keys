...
nav_order: 55
permalink: /technical-mastery/spring/spring-cloud-load-balancer/
id: SPR-075
...
```
AtomicInteger position = new
  AtomicInteger(random.nextInt(1000))
chosen = instances.get(Math.abs(pos.incrementAndGet()) %
  instances.size())
```
