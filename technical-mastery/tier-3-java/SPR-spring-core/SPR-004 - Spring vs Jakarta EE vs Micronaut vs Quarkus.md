...
nav_order: 4
permalink: /technical-mastery/spr/spring-vs-jakarta-ee-vs-micronaut-vs-quarkus/
---
...
```
+----------------------------------------------------------
| WHAT IT IS    | Decision framework for Java backend
  choice|
...
| USE WHEN      | Starting a new Java backend service
  |
| AVOID WHEN    | Mid-project framework switches (high
  cost) |
