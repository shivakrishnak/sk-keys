...
difficulty: ★★★
depends_on: SPR-001, SPR-006, SPR-007, SPR-082
used_by:
related: SPR-085, SPR-087, SPR-088
tags:
  - spring
  - java
  - advanced
...
nav_order: 86
permalink: /technical-mastery/spr/ioc-first-thinking/
---
...
| Field          | Value                                                                                                                                                                                        |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[SPR-001 - What Is Spring - History and Philosophy]], [[SPR-006 - IoC (Inversion of Control)]], [[SPR-007 - DI (Dependency Injection)]], [[SPR-082 - Spring Framework Internals Deep Dive]] |
| **Used by**    | -                                                                                                                                                                                            |
| **Related**    | [[SPR-085 - Spring Specification and Extension Points]], [[SPR-087 - Spring Configuration Trade-off Framing]], [[SPR-088 - Framework Selection Mental Model]]                                |
...
- [[SPR-006 - IoC (Inversion of Control)]] - the principle being applied
- [[SPR-007 - DI (Dependency Injection)]] - the mechanism
- [[SPR-001 - What Is Spring - History and Philosophy]] - why IoC is Spring's core design

**Builds On This (learn these next):**

- [[SPR-087 - Spring Configuration Trade-off Framing]] - when to choose `@Bean` vs `@Component`
- [[SPR-088 - Framework Selection Mental Model]] - IoC as a framework selection criterion
- [[SPR-085 - Spring Specification and Extension Points]] - IoC applied to framework extension
...
|               | coupling from field injection brevity
  |
| ONE-LINER     | Declare needs via constructor; let
  Spring|
|               | satisfy them; never reach for getBean()
  |
| NEXT EXPLORE  | SPR-087 (Config Trade-offs),
  |
|               | SPR-085 (Extension Points)
  |
+----------------------------------------------------------
```
