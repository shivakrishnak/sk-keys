...
nav_order: 15
permalink: /technical-mastery/spring/bean-lifecycle/
id: SPR-056
...
```java
// Implement DisposableBean and call explicitly, or use
...
│              │ @PostConstruct; shutdown cleanup: @PreDes│
├──────────────┼──────────────────────────────────────────┤
│ AVOID WHEN   │ Never put init logic in constructors when│
│              │ using field/setter injection             │
├──────────────┼──────────────────────────────────────────┤
│ TRADE-OFF    │ Guaranteed ordering vs lifecycle complexi│
