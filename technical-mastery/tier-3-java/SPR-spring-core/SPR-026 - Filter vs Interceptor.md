...
nav_order: 26
permalink: /technical-mastery/spring/filter-vs-interceptor/
id: SPR-060
...
DispatcherServlet entry
    HandlerMapping: determine handler ← Interceptor gains
      handler knowledge HERE
    ↓
...
public class RequestIdFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        ((HttpServletRequest) req).setAttribute("REQUEST_ID",
            requestId);
...
```java
@Component
public class ExecutionLoggingInterceptor implements
    HandlerInterceptor {
