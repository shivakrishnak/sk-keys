...
difficulty: ★★★
depends_on: SPR-003, SPR-067, SPR-082
used_by:
related: SPR-083, SPR-085, SPR-033
tags:
  - spring
  - java
  - advanced
...
nav_order: 84
permalink: /technical-mastery/spr/spring-native-and-graalvm-integration/
---
...
| Field          | Value                                                                                                                                                               |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[SPR-003 - Why Spring Boot Changed Java Development]], [[SPR-067 - Spring Boot Auto-configuration Deep Dive]], [[SPR-082 - Spring Framework Internals Deep Dive]]  |
| **Used by**    | -                                                                                                                                                                   |
| **Related**    | [[SPR-083 - Spring Reactive Model (Project Reactor Internals)]], [[SPR-085 - Spring Specification and Extension Points]], [[SPR-033 - Spring Boot AOT Compilation]] |
...
- [[SPR-082 - Spring Framework Internals Deep Dive]] - Phase 1 (BeanDefinition) that AOT processes
- [[SPR-067 - Spring Boot Auto-configuration Deep Dive]] - what auto-configuration registers that AOT must handle

**Builds On This (learn these next):**

- [[SPR-033 - Spring Boot AOT Compilation]] - the Spring-specific AOT layer detail
- [[SPR-085 - Spring Specification and Extension Points]] - writing `RuntimeHintsRegistrar`
...
|               | GraalVM; no JVM at runtime
  |
| PROBLEM       | JVM startup time (3-15s) unacceptable
  for|
...
|               | 100ms startup; reflect-config required
  |
| NEXT EXPLORE  | SPR-033 (AOT Compilation Detail)
  |
+----------------------------------------------------------
```
