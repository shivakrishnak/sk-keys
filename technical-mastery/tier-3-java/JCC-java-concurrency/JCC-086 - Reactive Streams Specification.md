...
difficulty: ★★★
depends_on: JCC-022, JCC-084, JCC-050
used_by:
related: JCC-038, JCC-023, JCC-062
tags:
  - java
  - concurrency
  - async
...
nav_order: 86
permalink: /technical-mastery/java-concurrency/reactive-streams-specification/
---
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-022 CompletableFuture Composition, JCC-084 Project Loom, JCC-050 ExecutorService |
| Related    | JCC-038 CompletableFuture, JCC-023 Parallel Streams, JCC-062 Structured Concurrency |
...
Wired as:
  source -> MapOperator -> FilterOperator -> TakeOperator
    -> s
...
- [[JCC-022 - CompletableFuture Composition Patterns]] - single-
  value async; Reactive Streams extends to multi-value streams
- [[JCC-050 - ExecutorService]] - the thread pool that schedulers
  wrap
...
- [[JCC-084 - Project Loom Design Rationale]] - virtual threads
  as a simpler model for many reactive use cases
- [[JCC-023 - Parallel Streams]] - CPU-bound batch processing
