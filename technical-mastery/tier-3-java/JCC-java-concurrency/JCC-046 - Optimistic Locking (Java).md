...
nav_order: 46
permalink: /technical-mastery/java-concurrency/optimistic-locking/
id: JCC-064
...
[Transaction: read Product{stock=10, version=3}]
    → [No lock held: compute new stock=9]      ← YOU ARE
      HERE
...
public class InventoryService {
    ...
    public void decrementStock(Long productId) {
        ...
        // Hibernate saves on transaction commit: version check
        // automatic
    }
}
```
