...
difficulty: ★★☆
depends_on: JCC-050, JCC-014, JCC-022
used_by: JCC-077
related: JCC-021, JCC-051, JCC-038
tags:
  - java
  - concurrency
  - async
...
nav_order: 26
permalink: /technical-mastery/java-concurrency/completionservice/
---
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-050 ExecutorService, JCC-014 Future, JCC-022 CompletableFuture Composition |
| Used by    | JCC-077 Thread Pinning                             |
| Related    | JCC-021 ScheduledExecutorService, JCC-051 ThreadPoolExecutor, JCC-038 CompletableFuture |
...
Call future[1].get() -> already done (was done in 1s),
  returns
...
CompletionService wraps ExecutorCompletionService
  ...
  |
  +--> QueueingFuture.done(): (called by worker on
    complete)
...
- [[JCC-050 - ExecutorService]] - the underlying thread pool
- [[JCC-014 - Future]] - the result type returned by `take()`
- [[JCC-022 - CompletableFuture Composition Patterns]] - the
...
- [[JCC-051 - ThreadPoolExecutor]] - tune the underlying pool

**Alternatives / Comparisons:**
- [[JCC-038 - CompletableFuture]] - richer composability for
  small known task sets
- [[JCC-062 - Structured Concurrency]] - Java 21 replacement with
