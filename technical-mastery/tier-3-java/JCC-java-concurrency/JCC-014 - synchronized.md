...
nav_order: 14
permalink: /technical-mastery/java-concurrency/synchronized/
id: JCC-038
...
// Uses CAS (hardware atomic) - faster than synchronized for single
// ops
```
...
[Thread T1: enters synchronized(sharedObj)]
    → [JVM: monitorenter - acquires monitor]  ← YOU ARE
      HERE
...
│              │ (ReadWriteLock); single atomic ops (Atomi│
├──────────────┼──────────────────────────────────────────┤
