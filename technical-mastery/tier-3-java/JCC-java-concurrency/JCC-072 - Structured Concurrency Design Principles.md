...
difficulty: ★★★
depends_on: JCC-058, JCC-049, JCC-009, JCC-054
used_by:
related: JCC-058, JCC-049, JCC-009
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 72
permalink: /technical-mastery/jcc/structured-concurrency-design-principles/
---
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | JCC-058, JCC-049, JCC-009, JCC-054 |     |
| **Related:**    | JCC-058, JCC-049, JCC-009          |     |
...
- [[JCC-058 - Structured Concurrency (Java 21)]] - the API and basic usage
- [[JCC-049 - Virtual Threads (Project Loom)]] - the enabling technology
- [[JCC-009 - Future]] - the older async result model

**Builds On This (learn these next):**

- [[JCC-066 - Concurrent System Design at Scale]] - applying structured concurrency in system design

**Alternatives / Comparisons:**

- [[JCC-054 - CompletableFuture]] - the older, unstructured async composition model
...
│ NEXT EXPLORE  │ JCC-066 Concurrent System Design   │
└────────────────────────────────────────────────────┘
```
