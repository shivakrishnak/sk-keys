...
nav_order: 53
permalink: /technical-mastery/java-concurrency/jcc-038-phaser/
id: JCC-071
...
Thread C: arriveAndDeregister() → arrived=3, reg=3,
  unarr=0?
                                 Wait - deregister
                                   decrements
                                 registered too:
...
This edge case shows why arrive-and-deregister ordering
  matters.
```
...
(each discovers children: register new threads,
  arriveAndDeregister self)
```
