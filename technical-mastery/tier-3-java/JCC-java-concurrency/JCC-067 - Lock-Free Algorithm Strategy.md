...
difficulty: ★★★
depends_on: JCC-045, JCC-046, JCC-057, JCC-056
used_by: JCC-070
related: JCC-045, JCC-056, JCC-070
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 67
permalink: /technical-mastery/jcc/lock-free-algorithm-strategy/
---
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | JCC-045, JCC-046, JCC-057, JCC-056 |     |
| **Used by:**    | JCC-070                            |     |
| **Related:**    | JCC-045, JCC-056, JCC-070          |     |
...
- [[JCC-045 - CAS (Compare-And-Swap)]] - the hardware primitive underlying all lock-free algorithms
- [[JCC-056 - Atomic Classes]] - the standard library lock-free implementations

**Builds On This (learn these next):**

- [[JCC-070 - Lock-Free Data Structure Design]] - applying the strategy to complete data structures

**Alternatives / Comparisons:**

- [[JCC-040 - ReentrantLock]] - when locks outperform lock-free (long critical sections)
- [[JCC-046 - Optimistic Locking (Java)]] - related optimistic approach at a higher level
...
│ NEXT EXPLORE  │ JCC-070 Lock-Free Data Structures  │
└────────────────────────────────────────────────────┘
```
