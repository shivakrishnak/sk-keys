...
nav_order: 45
permalink: /technical-mastery/java-concurrency/cas-compare-and-swap/
id: JCC-063
...
- If fail: retry (2-3 attempts on average at high
  contention)
...
[T1 reads 5, T2 reads 5 simultaneously]
    ...
    → [T2: CMPXCHG(expected=5, new=6): FAILS - value=6,
      not 5]
