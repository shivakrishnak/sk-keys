...
nav_order: 25
permalink: /technical-mastery/java-concurrency/thread-interruption-and-cancellation/
---
...
SET (true)
    |
    +-- isInterrupted() checks: returns true, flag stays
      SET
    |
    +-- Thread.interrupted() checks: returns true, flag ->
      CLEARED
    |
