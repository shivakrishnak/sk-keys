...
difficulty: ★★★
depends_on: JCC-067, JCC-045, JCC-057, JCC-069
used_by:
related: JCC-067, JCC-045, JCC-057, JCC-069
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 70
permalink: /technical-mastery/jcc/lock-free-data-structure-design/
---
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | JCC-067, JCC-045, JCC-057, JCC-069 |     |
| **Related:**    | JCC-067, JCC-045, JCC-057, JCC-069 |     |
...
- [[JCC-067 - Lock-Free Algorithm Strategy]] - CAS loop template and ABA analysis
- [[JCC-045 - CAS (Compare-And-Swap)]] - the fundamental primitive
- [[JCC-057 - VarHandle]] - portable CAS in Java 9+

**Builds On This (learn these next):**

- [[JCC-071 - Concurrent Algorithm Research]] - advanced concurrent algorithms

**Alternatives / Comparisons:**

- [[JCC-044 - Java Memory Model (JMM)]] - the memory ordering that makes CAS safe
...
│ NEXT EXPLORE  │ JCC-071 Concurrent Algorithm Res.  │
└────────────────────────────────────────────────────┘
```
