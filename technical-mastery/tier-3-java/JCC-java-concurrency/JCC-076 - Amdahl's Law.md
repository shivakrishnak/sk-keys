...
difficulty: ★★★
depends_on: JCC-023, JCC-024, JCC-004
used_by: JCC-079, JCC-082
related: JCC-068, JCC-051, JCC-018
tags:
  - java
  - concurrency
  - performance
...
nav_order: 76
permalink: /technical-mastery/java-concurrency/amdahls-law/
---
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-023 Parallel Streams, JCC-024 Fork-Join Framework, JCC-004 Concurrency vs Parallelism |
| Used by    | JCC-079 Lock-Free Data Structures, JCC-082 Busy-Wait vs Blocking |
| Related    | JCC-068 Concurrency vs Parallelism, JCC-051 ThreadPoolExecutor, JCC-018 ForkJoinPool |
...
```
p_serial = 0.05 (5%)
Max speedup = 1 / 0.05 = 20x. Buying a 100-core server
  won't
...
1 core:   [====serial====][=======parallel (1
  thread)=======]
4 cores:  [====serial====][=parallel=]
                          [=parallel=] (3 idle during
                            serial)
                          [=parallel=]
                          [=parallel=]
                           ^-- 3 cores idle during serial
                             phase
```
...
If p_serial changes with N, coordination overhead is
  significant
```
...
- [[JCC-023 - Parallel Streams]] - practical Java parallelism
- [[JCC-024 - Fork-Join Framework Pattern]] - where Amdahl's serial
...
- [[JCC-079 - Lock-Free Data Structures]] - reducing p_serial by
  eliminating lock-based coordination
- [[JCC-082 - Busy-Wait vs Blocking]] - coordination cost's role
