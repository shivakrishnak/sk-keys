...
nav_order: 77
permalink: /technical-mastery/java-concurrency/thread-pinning-virtual-threads-problem/
---
...
VT enters synchronized block
  |
monitorenter: carrier thread pointer registered as monitor
  owner
  |
