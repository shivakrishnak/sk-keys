...
nav_order: 63
permalink: /technical-mastery/java-concurrency/actor-model/
id: JCC-026
...
Client request
  ...
  → TransferActor receives Success, tells AccountActorB
    "Credit 100"
  → AccountActorB processes, replies "Success"
  → TransferActor replies to HTTP handler "Transfer
    complete"
```
