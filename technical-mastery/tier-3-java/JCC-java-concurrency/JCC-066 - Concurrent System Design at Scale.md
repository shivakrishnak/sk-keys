...
difficulty: ★★★
depends_on: JCC-064, JCC-065, JCC-044, JCC-017
used_by: JCC-068
related: JCC-064, JCC-065, JCC-068
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 66
permalink: /technical-mastery/jcc/concurrent-system-design-at-scale/
---
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | JCC-064, JCC-065, JCC-044, JCC-017 |     |
| **Used by:**    | JCC-068                            |     |
| **Related:**    | JCC-064, JCC-065, JCC-068          |     |
...
- [[JCC-064 - Concurrency Architecture Patterns in Java]] - patterns used in system design
- [[JCC-017 - ExecutorService]] - the thread pool API used in designs

**Builds On This (learn these next):**

- [[JCC-068 - Thread Model Selection Framework]] - systematic model selection
- [[JCC-075 - Thread Safety Trade-off Framing]] - trade-off evaluation at design time

**Alternatives / Comparisons:**

- [[JCC-065 - Virtual Thread Migration Strategy (Loom)]] - thread model dimension of system design
...
│ NEXT EXPLORE  │ JCC-068 Selection, JCC-075 Tradeoff│
└────────────────────────────────────────────────────┘
```
