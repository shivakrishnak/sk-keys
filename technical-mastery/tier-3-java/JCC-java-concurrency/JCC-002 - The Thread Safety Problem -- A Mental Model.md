...
nav_order: 2
permalink: /technical-mastery/jcc/the-thread-safety-problem-a-mental-model/
---
...
```
Immutable ──► Stateless ──► Thread-Safe ──► Conditional
  ──► Not Safe
(String)   (no fields)   (AtomicInteger)   (syncList)
  (ArrayList)
```
