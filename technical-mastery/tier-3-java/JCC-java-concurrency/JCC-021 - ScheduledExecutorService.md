...
difficulty: ★★☆
depends_on: JCC-050, JCC-051
used_by: JCC-022, JCC-024
related: JCC-049, JCC-018, JCC-009
tags:
  - java
  - concurrency
  - async
...
nav_order: 21
permalink: /technical-mastery/java-concurrency/scheduledexecutorservice/
---
...
| Field        | Value                                      |
|--------------|--------------------------------------------|
| Depends on   | JCC-050 ExecutorService, JCC-051 ThreadPoolExecutor |
| Used by      | JCC-022 CompletableFuture Composition, JCC-024 Fork-Join Pattern |
| Related      | JCC-049 Executor, JCC-018 ForkJoinPool, JCC-009 Future |
...
- [[JCC-050 - ExecutorService]] - the parent interface; understand
  submit/shutdown before scheduled variants
- [[JCC-051 - ThreadPoolExecutor]] - the internal engine;
  `ScheduledThreadPoolExecutor` extends it
- [[JCC-009 - Future]] - the `ScheduledFuture` return type

**Builds On This (learn these next):**
- [[JCC-022 - CompletableFuture Composition Patterns]] - async
  pipelines wired with delayed executors
- [[JCC-024 - Fork-Join Framework Pattern]] - parallelism for
  divide-and-conquer vs scheduling for time-based tasks
- [[JCC-027 - Condition Interface (Lock Conditions)]] - explicit
  waiting patterns that complement scheduling

**Alternatives / Comparisons:**
- [[JCC-049 - Executor]] - simpler, no scheduling; use for
...
|                 | .scheduleWithFixedDelay(...)   |
+-----------------+--------------------------------+
| NEXT EXPLORE    | JCC-022 CompletableFuture,     |
