...
difficulty: ★★★
depends_on: JCC-047, JCC-078, JCC-061
used_by: JCC-080, JCC-088
related: JCC-056, JCC-054, JCC-060
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 79
permalink: /technical-mastery/java-concurrency/lock-free-data-structures/
---
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-047 CAS (Compare-And-Swap), JCC-078 JMM Happens-Before, JCC-061 VarHandle |
| Used by    | JCC-080 Memory Visibility Diagnostics, JCC-088 Lock-Free Algorithm Theory |
| Related    | JCC-056 Atomic Classes, JCC-054 ConcurrentHashMap, JCC-060 Atomic Classes |
...
throughput: 500k ops/sec on 16 cores under low-medium
  contention
```
...
Dequeue:
  loop:
    ...
    if CAS(this.head, head, first): return first.value  //
      SUCCESS
```
...
- [[JCC-078 - JMM Happens-Before - Deep Rules]] - the visibility
  semantics of successful CAS
- [[JCC-061 - VarHandle]] - fine-grained CAS access from Java 9+

**Builds On This (learn these next):**
- [[JCC-080 - Memory Visibility Diagnostics (jstack, JFR)]] - detect
  CAS storms and contention in production
- [[JCC-088 - Lock-Free Algorithm Theory (CAS Foundations)]] - formal
  proofs and consistency models

**Alternatives / Comparisons:**
- [[JCC-054 - ConcurrentHashMap]] - partially lock-free, JDK built-in
- [[JCC-060 - Atomic Classes]] - building blocks for custom lock-free
  structures
...
|              | JCC-080 Memory Visibility Diag     |
+--------------------------------------------------+
```
