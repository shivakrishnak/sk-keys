...
difficulty: ★★★
depends_on: JCC-001, JCC-002, JCC-044, JCC-073
used_by: JCC-073, JCC-075
related: JCC-073, JCC-075, JCC-001
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 74
permalink: /technical-mastery/jcc/shared-state-risk-intuition/
---
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | JCC-001, JCC-002, JCC-044, JCC-073 |     |
| **Used by:**    | JCC-073, JCC-075                   |     |
| **Related:**    | JCC-073, JCC-075, JCC-001          |     |
...
Read a field declaration
   ...
   Is it local?          YES -> SAFE (stack)
        |NO
   Is it final/immutable? YES -> CHECK: is referenced
     object safe?
        |NO
   Is object published?  NO  -> confined: SAFE (if truly
     confined)
        |YES
...
- [[JCC-044 - Java Memory Model (JMM)]] - visibility rules for shared state

**Builds On This (learn these next):**

- [[JCC-073 - Concurrency-First Thinking]] - applying intuition at design time
- [[JCC-075 - Thread Safety Trade-off Framing]] - choosing the right mechanism

**Alternatives / Comparisons:**

- [[JCC-038 - volatile]] - the minimal synchronization for visibility-only shared state
...
│ NEXT EXPLORE  │ JCC-075 Thread Safety Trade-offs   │
└────────────────────────────────────────────────────┘
```
