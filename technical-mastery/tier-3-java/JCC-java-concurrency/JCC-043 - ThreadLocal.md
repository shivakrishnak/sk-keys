...
nav_order: 43
permalink: /technical-mastery/java-concurrency/thread-local/
id: JCC-061
...
```
[Request arrives: filter sets userId ThreadLocal]  ← YOU
  ARE HERE
...
```
┌─────────────────────────────────────────────────────────┐
│ WHAT IT IS   │ Variable with a different value per threa│
...
│              │ Without remove(): stale data + memory lea│
│              │ on thread reuse                          │
├──────────────┼──────────────────────────────────────────┤
