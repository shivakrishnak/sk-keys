...
nav_order: 68
permalink: /technical-mastery/jvm/jvm-first-debugging-mental-model/
---
...
java \
  ...
  \
  # GC layer: always-on
  -Xlog:gc*:file=/var/log/gc.log:time,uptime,tags:filecount=5,
      filesize=20m \
  \
...
# Compare thread names: do thread A and B appear in each others'
# stacks?
