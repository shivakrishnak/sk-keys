...
difficulty: ★★★
depends_on: JVM-045, JVM-046, JVM-047
used_by:
related: JVM-048, JVM-049, JVM-050, JVM-052
tags:
  - jvm
  - java
  - jit
...
nav_order: 66
permalink: /technical-mastery/jvm/jit-compilation-research-truffle-graal-ir/
---
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-045 - JIT Compiler]], [[JVM-046 - C1 and C2 Compiler]], [[JVM-047 - Tiered Compilation]] |
| **Used by** | (none - research entry) |
| **Related** | [[JVM-048 - Method Inlining]], [[JVM-049 - Deoptimization]], [[JVM-050 - OSR (On-Stack Replacement)]], [[JVM-052 - GraalVM]] |
...
- [[JVM-045 - JIT Compiler]] - How JIT compilation works fundamentally
- [[JVM-046 - C1 and C2 Compiler]] - The compilers Graal replaces/improves upon
- [[JVM-047 - Tiered Compilation]] - How Graal fits into the compilation tiers

**Builds On This (learn these next):**
- (none - this is a frontier research entry)

**Alternatives / Comparisons:**
- [[JVM-048 - Method Inlining]] - Key optimisation in both C2 and Graal
- [[JVM-049 - Deoptimization]] - Required by both speculative JITs
- [[JVM-052 - GraalVM]] - Full GraalVM ecosystem including Native Image
...
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-052 GraalVM overview,       |
|               | JVM-049 Deoptimization           |
+--------------------------------------------------+
```
