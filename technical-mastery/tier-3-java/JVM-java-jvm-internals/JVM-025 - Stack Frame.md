...
nav_order: 25
permalink: /technical-mastery/java/stack-frame/
id: JVM-017
...
Bytecode execution:
  ...
  ireturn      → pop 12, remove frame, push 12 onto
    caller's stack
```
...
java.lang.NullPointerException
  at com.example.ServiceA.process(ServiceA.java:42) ← top
    frame
  at com.example.Controller.handle(Controller.java:18)
  at com.example.Main.run(Main.java:9)             ←
    bottom frame
```
...
│              │ thread stack: locals + operand scratch pa│
├──────────────┼──────────────────────────────────────────┤
