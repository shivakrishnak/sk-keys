...
nav_order: 14
permalink: /technical-mastery/java/young-generation/
id: JVM-026
...
Step 2: All application threads pause (STW)
  ↓
Step 3: Enumerate GC Roots → find all live roots in Young
  Gen
...
```text
┌─────────────────────────────────────────────────────────┐
│ WHAT IT IS   │ Heap region for all new object allocation│
