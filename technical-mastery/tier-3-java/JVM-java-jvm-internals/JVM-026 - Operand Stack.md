...
nav_order: 26
permalink: /technical-mastery/java/operand-stack/
id: JVM-018
...
Step 3: iadd        Stack: [a+b]      (popped a,b; pushed
  sum)
Step 4: iload_3     Stack: [a+b, c]
Step 5: imul        Stack: [(a+b)*c]  (popped both; pushed
  product)
Step 6: istore_4    Stack: []         (popped to
  local[4]=result)
```
