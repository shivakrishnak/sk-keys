...
nav_order: 51
permalink: /technical-mastery/java/aot-ahead-of-time-compilation/
id: JVM-055
...
[./myservice starts]
    ...
    → [Application-level init (already fast: pre-inited
      heap)]
...
[Third-party library not compatible with native image]
    → [Build fails: unsupported feature (dynamic proxy,
      CGLIB)]
