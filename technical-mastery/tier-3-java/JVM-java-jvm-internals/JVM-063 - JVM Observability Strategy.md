...
difficulty: ★★★
depends_on: JVM-021, JVM-055, JVM-059
used_by:
related: JVM-060, JVM-062, JVM-068
tags:
  - jvm
  - java
  - observability
...
nav_order: 63
permalink: /technical-mastery/jvm/jvm-observability-strategy/
---
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-021 - GC Logs]], [[JVM-055 - Safepoint]], [[JVM-059 - GC Tuning Strategy for Production JVMs]] |
| **Used by** | (none - terminal observability entry) |
| **Related** | [[JVM-060 - JVM Architecture Decisions at Scale]], [[JVM-062 - Heap Sizing and Memory Planning Strategy]], [[JVM-068 - JVM-First Debugging Mental Model]] |
...
java \
  ...
  \
  # GC logging
  -Xlog:gc*:file=/var/log/gc.log:time,uptime,level,tags:filecount=5,
      filesize=20m \
  \
...
# If OOMKilled: heap dump incomplete; pod restarted before dump
# finished
```
...
- [[JVM-021 - GC Logs]] - GC log format and interpretation
- [[JVM-055 - Safepoint]] - Safepoint impact on application threads
- [[JVM-059 - GC Tuning Strategy for Production JVMs]] - Using GC log data for tuning

**Builds On This (learn these next):**
- [[JVM-068 - JVM-First Debugging Mental Model]] - Using observability data to debug incidents

**Alternatives / Comparisons:**
- [[JVM-060 - JVM Architecture Decisions at Scale]] - Fleet-level observability standardisation
- [[JVM-062 - Heap Sizing and Memory Planning Strategy]] - Memory metrics interpretation
...
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-068 debugging mental model,  |
|               | JVM-060 fleet observability       |
+--------------------------------------------------+
```
...
*Hint:* Research safepoint operations beyond GC in [[JVM-055 - Safepoint]]; specifically look at JFR's `jdk.SafepointStatisticsLog` events and what operations trigger them.
