...
nav_order: 54
permalink: /technical-mastery/java/tlab-thread-local-allocation-buffer/
id: JVM-058
...
[TLAB exhausted or object too large]
    → fill remaining TLAB space with int[] dummy (TLAB
      waste)
...
│ SOLVES       │ under concurrent multi-threaded allocatio│
├──────────────┼──────────────────────────────────────────┤
