...
difficulty: ★★★
depends_on: JVM-001, JVM-052, JVM-053
used_by: JVM-061
related: JVM-059, JVM-063, JVM-069
tags:
  - jvm
  - java
  - architecture
...
nav_order: 60
permalink: /technical-mastery/jvm/jvm-architecture-decisions-at-scale/
---
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-001 - What Is the JVM - A Mental Model]], [[JVM-052 - GraalVM]], [[JVM-053 - Native Image]] |
| **Used by** | [[JVM-061 - JVM Selection Framework (HotSpot vs GraalVM)]] |
| **Related** | [[JVM-059 - GC Tuning Strategy for Production JVMs]], [[JVM-063 - JVM Observability Strategy]], [[JVM-069 - Performance Intuition via JVM Internals]] |
...
- [[JVM-061 - JVM Selection Framework (HotSpot vs GraalVM)]] - Systematic decision framework

**Alternatives / Comparisons:**
- [[JVM-059 - GC Tuning Strategy for Production JVMs]] - Per-service GC decisions
- [[JVM-063 - JVM Observability Strategy]] - Fleet-wide monitoring
...
|               | GC logging                        |
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-061 selection framework,     |
|               | JVM-063 observability             |
+--------------------------------------------------+
```
...
*Hint:* Consider the build pipeline complexity, reflection configuration, closed-world assumption limitations, and the loss of runtime-adaptive JIT optimisation described in [[JVM-061 - JVM Selection Framework (HotSpot vs GraalVM)]].
