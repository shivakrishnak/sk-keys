...
nav_order: 47
permalink: /technical-mastery/java/tiered-compilation/
id: JVM-051
...
[Very high startup load]
    ...
    → [Application runs at 50% of peak throughput
      indefinitely]
    → [Fix: reduce initial load, or increase
      CICompilerCount]
```
...
```bash
top -H -p <pid>
# Look for JIT threads (named "C1 CompilerThread" or "C2
# CompilerThread")
