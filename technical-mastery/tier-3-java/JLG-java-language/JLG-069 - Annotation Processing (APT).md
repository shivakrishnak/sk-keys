...
nav_order: 69
permalink: /technical-mastery/java-language/annotation-processing-apt/
id: JLG-047
...
[Developer annotates class with @Mapper]
    ...
    → [Both UserMapper.class + UserMapperImpl.class
      produced]
    → [Application starts: uses generated impl, no
      reflection]
```
...
[Processor finds invalid annotation usage]
    ...
    → [Build log shows processor error with source
      location]
...
```
┌─────────────────────────────────────────────────────────┐
│ WHAT IT IS   │ Compile-time plugin that reads annotation│
...
│              │ compile time - mappers, builders, DI wiri│
├──────────────┼──────────────────────────────────────────┤
...
│              │ IDE support requires correct configuratio│
├──────────────┼──────────────────────────────────────────┤
