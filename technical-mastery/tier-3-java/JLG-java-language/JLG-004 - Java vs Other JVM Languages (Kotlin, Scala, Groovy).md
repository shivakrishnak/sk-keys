...
nav_order: 4
permalink: /technical-mastery/jlg/java-vs-other-jvm-languages-kotlin-scala-groovy/
---
...
```
+----------------------------------------------------------
| WHAT IT IS    | Four primary JVM languages: Java,
  Kotlin,|
...
|               | complexity premium without benefit
  |
| KEY INSIGHT   | Domain determines language:
  Android=Kotlin|
