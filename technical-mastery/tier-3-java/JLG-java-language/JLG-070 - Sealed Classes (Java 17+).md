...
nav_order: 70
permalink: /technical-mastery/java-language/sealed-classes/
id: JLG-048
...
[Developer adds Disputed to PaymentResult permits]
    ...
    → [Compiler updates PermittedSubclasses attr]  ← YOU
      ARE HERE
...
├──────────────┼──────────────────────────────────────────┤
│ KEY INSIGHT  │ Adding a new permitted subtype immediatel│
...
├──────────────┼──────────────────────────────────────────┤
│ ONE-LINER    │ "A closed menu of types where the compile│
