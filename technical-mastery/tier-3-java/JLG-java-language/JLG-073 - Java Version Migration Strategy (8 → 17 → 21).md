...
difficulty: ★★★
depends_on: JLG-005, JLG-075
related: JLG-002, JLG-078, JLG-081
tags:
  - java
  - advanced
  - production
...
nav_order: 73
permalink: /technical-mastery/jlg/java-version-migration-strategy-8-17-21/
---
...
| Field          | Value                                                                                                                                                                     |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[JLG-005 - Java Versioning and LTS Release Strategy]], [[JLG-075 - Java Modularity Strategy (JPMS)]]                                                                     |
| **Used by**    | -                                                                                                                                                                         |
| **Related**    | [[JLG-002 - The Java Ecosystem Map (SE, EE, ME, Android)]], [[JLG-078 - Java Language Specification Deep Dive]], [[JLG-081 - Java Language Design History and Rationale]] |
...
- [[JLG-075 - Java Modularity Strategy (JPMS)]] - the module system driving encapsulation changes

**Builds On This (learn these next):**

- [[JLG-078 - Java Language Specification Deep Dive]] - understanding the JVM spec changes
- [[JLG-076 - Java Performance Profiling at Scale]] - profiling after migration
...
| ONE-LINER     | Run jdeps first; upgrade libraries; then
  |
|               | Java; then javax-to-jakarta; then Java
  21|
| NEXT EXPLORE  | JLG-078 (JLS Deep Dive),
  |
|               | JLG-075 (JPMS details)
  |
+----------------------------------------------------------
```
