...
nav_order: 72
permalink: /technical-mastery/java-language/invokedynamic/
id: JLG-050
...
[Source: list.stream().map(x -> x * 2)]
    ...
    → [invokedynamic call site at lambda use]  ← YOU ARE
      HERE
...
[Bootstrap method throws LambdaConversionException]
    ...
    → [Typically: serializable lambda requires
      Serializable]
    ...
    public static CallSite bootstrap(
        ...
        MethodHandle target = lookup
            .findStatic(Dispatcher.class,
                       "handle_" +
                           type.parameterType(0).getSimpleName(),
                       type);
