...
nav_order: 71
permalink: /technical-mastery/java-language/pattern-matching/
id: JLG-049
...
[switch (paymentResult) {...]
    ...
    → [Types tested in case order]             ← YOU ARE
      HERE
...
[New sealed subtype Disputed added to PaymentResult]
    ...
    → [Compile error: switch with result type not
      exhaustive]
...
│              │ - new types cause compile errors, not bug│
├──────────────┼──────────────────────────────────────────┤
