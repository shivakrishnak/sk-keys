...
nav_order: 78
permalink: /technical-mastery/jlg/java-language-specification-deep-dive/
---
...
| TRADE-OFF     | Visibility guarantee costs memory
  barrier|
|               | instructions (2-20 cycles each on x86)  |
| ONE-LINER     | HB chain: volatile write HB volatile
  read|
|               | = guaranteed visibility across threads  |
| NEXT EXPLORE  | JLG-079 (Valhalla), JLG-081 (JLS
  history)|
+----------------------------------------------------------
```
