...
nav_order: 68
permalink: /technical-mastery/java-language/reflection/
id: JLG-046
...
[Application starts]
    ...
    → [getDeclaredFields() seeking @Autowired]  ← YOU ARE
      HERE
...
├──────────────┼──────────────────────────────────────────┤
│ KEY INSIGHT  │ Bypasses compile-time type safety. 10–100│
