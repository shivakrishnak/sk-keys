...
used_by:
related: JLG-077, JLG-079, JLG-081
tags:
  - java
  - advanced
  - internals
...
nav_order: 80
permalink: /technical-mastery/jlg/project-panama-foreign-function-and-memory-api/
---
...
| **Used by** | (none yet) |
| **Related** | [[JLG-077 - Java in Polyglot Architecture]], [[JLG-079 - Project Valhalla - Value Types and Primitives]], [[JLG-081 - Java Language Design History and Rationale]] |
...
- [[JLG-078 - Java Language Specification Deep Dive]] - memory ordering at native boundary

**Builds On This (learn these next):**
- [[JLG-077 - Java in Polyglot Architecture]] - FFM as one polyglot integration mechanism
...
|               | exactly; wrong FunctionDescriptor =
  crash|
| ONE-LINER     | Linker.downcallHandle(symbol, desc) =   |
|               | direct C function call from pure Java   |
| NEXT EXPLORE  | JLG-077 (Polyglot architecture),        |
|               | JLG-079 (Valhalla value types)          |
+----------------------------------------------------------
```
