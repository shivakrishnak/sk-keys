...
nav_order: 33
permalink: /technical-mastery/java-language/serialization-deserialization/
id: JLG-070
...
[Object: UserDto{id=1, name="Alice"}]
    ...
    → [Jackson reflection: reads fields/getters]  ← YOU
      ARE HERE
...
[New field added to UserDto: private List<Role> roles]
    → [Old JSON in cache: {"id":1,"name":"Alice"} - no
      roles]
...
│ SOLVES       │ over network or persisted without convers│
├──────────────┼──────────────────────────────────────────┤
...
│              │ event streaming. Java serialization: neve│
├──────────────┼──────────────────────────────────────────┤
...
├──────────────┼──────────────────────────────────────────┤
│ NEXT EXPLORE │ Records → Spring Core (Jackson auto-confi│
