...
difficulty: ★★★
depends_on: JLG-001, JLG-078
used_by: JLG-083
related: JLG-080, JLG-081, JLG-084
tags:
  - java
  - advanced
  - internals
...
nav_order: 79
permalink: /technical-mastery/jlg/project-valhalla-value-types-and-primitives/
---
...
| Field | Value |
|---|---|
| **Depends on** | [[JLG-001 - What Is Java - History and Philosophy]], [[JLG-078 - Java Language Specification Deep Dive]] |
| **Used by** | [[JLG-083 - Language Feature Trade-off Framing]] |
| **Related** | [[JLG-080 - Project Panama - Foreign Function and Memory API]], [[JLG-081 - Java Language Design History and Rationale]], [[JLG-084 - Java Ecosystem Selection Framework]] |
...
- [[JLG-078 - Java Language Specification Deep Dive]] - JMM implications for value types

**Builds On This (learn these next):**
- [[JLG-080 - Project Panama - Foreign Function and Memory API]] - native memory layout; complements value types
- [[JLG-083 - Language Feature Trade-off Framing]] - when to adopt preview features
...
| USE WHEN      | (Java 25+ when finalised) numerical
  data,|
