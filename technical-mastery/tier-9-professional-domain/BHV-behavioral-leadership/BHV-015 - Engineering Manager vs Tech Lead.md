...
nav_order: 15
permalink: /technical-mastery/leadership/engineering-manager-vs-tech-lead/
id: BHV-007
...
PEOPLE DEVELOPMENT
  ...
  Career conversations (where they want to go; how to get
    there)
...
TEAM HEALTH
  Psychological safety: is team safe to take risks, speak
    up?
...
GROWING TECHNICAL SKILLS
  ...
  Identifying technical challenges that grow junior
    engineers
```
...
```
EM AND TL BOTH OWN:
  Team priorities (EM: capacity; TL: technical
    dependencies)
  Onboarding (EM: culture; TL: codebase/architecture)
  Team meetings (EM: runs retros/planning; TL: runs tech
    review)
  Representation externally (EM: to leadership; TL: to
    other teams)
...
People: growth plan        → EM        → TL (tech skill
  gaps)
...
3. Are there people changes that affect technical plans?
  (both)
...
├──────────────┼──────────────────────────────────────────┤
│ EM OWNS      │ 1:1s · growth plans · hiring · performanc│
