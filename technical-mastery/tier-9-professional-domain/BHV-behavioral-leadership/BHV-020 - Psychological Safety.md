...
nav_order: 20
permalink: /technical-mastery/leadership/psychological-safety/
id: BHV-024
...
When this calculation is made for every team member in
  every meeting:
...
CREATES SAFETY:
  ...
  □ Acting on feedback publicly:
    "Bob raised a concern last week. Here's what we
      changed."
...
(R) = reverse scored. Higher score = higher psychological
  safety.
```
...
print(f"Overall: {result['overall_mean']} (
...
3. RETROSPECTIVE PROMPT:
   ...
   → Anonymous survey: "Was there something you wanted
     to say this sprint but didn't? If so, what stopped
       you?"
