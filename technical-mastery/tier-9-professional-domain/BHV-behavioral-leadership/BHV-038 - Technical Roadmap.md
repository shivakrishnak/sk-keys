...
nav_order: 38
permalink: /technical-mastery/leadership/technical-roadmap/
id: BHV-051
...
6. RISKS & DEPENDENCIES
   ...
   What are we assuming about capacity, technology,
     priority?
...
INPUT: Current state + Business direction + Technical
  strategy
    ↓
...
| ------------------------------------- | -------------- | ------ | --------------------------- |
| IaC migration (Terraform)             | Platform team  | L (
    8w) | Zero config drift incidents |
| Observability consolidation (Datadog) | Platform +
    SRE | M (4w) | 100% service coverage       |

### Q4 2024 (Planned)

| Initiative              | Owner         | Size   | Success Metric                    |
| ----------------------- | ------------- | ------ | --------------------------------- |
| CI/CD standardisation   | Platform team | L (
    8w) | All services on standard pipeline |
| Build time optimisation | Engineering   | M (
    4w) | < 10min P95 build time            |
...
3. Do quarterly planning conversations reference the
  roadmap?
