...
nav_order: 24
permalink: /technical-mastery/leadership/agile-principles/
id: BHV-021
...
VALUE 2: WORKING SOFTWARE > COMPREHENSIVE DOCUMENTATION
  ...
  Anti-pattern: 40-page design documents that nobody reads;
                architecture diagrams that are 2 years out
                  of date
...
VALUE 3: CUSTOMER COLLABORATION > CONTRACT NEGOTIATION
  What it means: the customer understands the problem
    better
                 than you do. The contract cannot capture
                   all
                 their needs. Working with them
                   continuously
                 produces better outcomes than arguing
                   about
...
VALUE 4: RESPONDING TO CHANGE > FOLLOWING A PLAN
  ...
  Anti-pattern: "We can't change the scope - it was
    committed
                 in January." (Spoken in September.)
  Practice: short iterations; backlog as a living document;
            planning at multiple timeframes (quarterly
              roadmap +
...
"Continuous attention to technical excellence and good
  design
 enhances agility."
 → Technical debt reduction is an agile value, not a
   blocker
...
"The best architectures, requirements, and designs emerge
 ...
 → Teams closest to the work make the best technical
   decisions
...
AGILE THEATRE:
  ...
  → Sprint planning where backlog is not prioritised by
    value
...
INSPECT AGAINST PRINCIPLES:
  ...
  If not: design one specific change to this sprint to
    improve it.

START WITH WORKING SOFTWARE:
  "When did a user last see working software from this
    team?"
...
RETROSPECTIVE IMPROVEMENT:
  ...
  is broken. Fix the retrospective before fixing anything
    else.

CHANGE WELCOME:
  When next requirement change arrives:
  → Don't ask "was this in the scope?"
  → Ask: "Is this more valuable than what we currently
    have planned?"
  → Reprioritise accordingly. Celebrate the team's ability
    to adapt.
```
