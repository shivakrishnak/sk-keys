...
nav_order: 11
permalink: /technical-mastery/leadership/confluence-documentation-tooling/
id: BHV-050
...
Knowledge Created (decision made / system built)
      │
      ▼
Documentation Written (page / ADR / runbook)  ← YOU ARE
  HERE
      │
      ▼
...
- Runbooks use template: [Runbook Template](
