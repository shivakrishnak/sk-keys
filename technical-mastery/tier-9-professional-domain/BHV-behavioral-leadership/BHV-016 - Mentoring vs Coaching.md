...
nav_order: 16
permalink: /technical-mastery/leadership/mentoring-vs-coaching/
id: BHV-018
...
USE MENTORING WHEN:
  ...
  They are blocked by missing information
    ...
    → Tell them (don't ask "what do you think it
      supports?")
...
YES → Mentoring mode
  ...
  Check: "Does that help? / Does that apply to your
    situation?"
...
Conversation
    ↓
Close:
  Mentoring: "Does that answer your question? What will
    you do?"
...
Target ratio: at least 1 coaching question per advice
  given.
If your advice:question ratio is > 3:1, you are
  over-mentoring.
```
