...
nav_order: 41
permalink: /technical-mastery/leadership/incident-command/
id: BHV-036
...
WITH ICS:
  ...
  SME: investigates assigned domain
       ...
       DOES NOT: communicate externally; make response
         calls
...
SEV-2 (Major): Significant degradation; major feature
  unavailable
...
SEV-4 (Low): Minimal impact; monitoring alert; no customer
  effect
...
INCIDENT DECLARED:
  ...
  t=45: Resolution declared; CL posts resolution
    notification
