...
nav_order: 37
permalink: /technical-mastery/leadership/scope-of-influence/
id: BHV-050
...
SCOPE LEVEL 4: ORGANISATION
  ...
  How: RFCs that establish org-wide patterns;
       ...
       engineering strategy that shapes multi-year
         direction
...
If they can't name one:
  ...
  → Next step: attend architecture reviews outside their
    team;
