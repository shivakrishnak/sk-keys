...
nav_order: 7
permalink: /technical-mastery/leadership/scrum/
id: BHV-051
...
INSPECTION:
  ...
  frequency to detect problems. Daily Scrum: daily
    inspection
  of Sprint progress. Sprint Review: inspection of
    Increment.
...
Sprint end: Done Increment
    ↓
Sprint Review: stakeholder feedback → Product Backlog
  updated
    ↓
...
NEXT SPRINT PLANNING:
  ...
  This is the primary Review question - not "did we
    complete
  all the stories?"
...
├─────────────┼──────────────────────────────────────────-┤
│ ARTEFACTS   │ Product Backlog | Sprint Backlog | Increme│
├─────────────┼──────────────────────────────────────────-┤
