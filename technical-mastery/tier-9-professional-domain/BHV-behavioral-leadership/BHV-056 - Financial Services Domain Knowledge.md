...
nav_order: 56
permalink: /technical-mastery/leadership/financial-services-domain-knowledge/
id: BHV-008
...
Client submits order via FIX/API
      │
      ▼
Order Management System (OMS) validates order ← YOU ARE
  HERE
      │
      ▼
...
- Was the settlement instruction sent to correct CSD
  account?
```
