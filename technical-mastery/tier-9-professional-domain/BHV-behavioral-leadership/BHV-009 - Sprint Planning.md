...
nav_order: 9
permalink: /technical-mastery/leadership/sprint-planning/
id: BHV-007
...
QUESTION 1: WHY IS THIS SPRINT VALUABLE?
  ...
  GOOD Sprint Goals:
    ...
    "Eliminate the P0 performance regression on the mobile
      app"
...
QUESTION 2: WHAT CAN BE DONE THIS SPRINT?
  ...
  Guidance: velocity as historical forecast; DoD as
    quality floor
...
QUESTION 3: HOW WILL THE WORK BE DONE?
  ...
  Note: tasks are a planning tool; they are not mandatory
        in modern Scrum. Some teams task-break; others
          don't.
```
...
3. COUNT ONLY COMPLETED STORIES IN VELOCITY:
   → Rolled-over stories: count only in the sprint they
     complete
   → This reveals true velocity; prevents false-high
     planning

4. CELEBRATE COMPLETION:
   → If sprint ends with all stories Done AND buffer
     remaining:
     that is SUCCESS, not laziness
   → Recognise reliable delivery as a team achievement
   → Reinforces: committing to complete > committing to
     impress
```
