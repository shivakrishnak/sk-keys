...
nav_order: 31
permalink: /technical-mastery/microservices/domain-driven-design-ddd/
---
...
DOMAIN SERVICE:
  ...
  Example: PricingService.calculateDiscount(order,
    customer).
...
Context Map:
  order-service: Customer-Supplier with payment-service
    (order-service is customer; payment-service is
      supplier)
