...
nav_order: 32
permalink: /technical-mastery/microservices/bounded-context/
---
...
1. Terminology shift: "Customer" in billing = account
  holder;
...
3. Lifecycle divergence: Order lifecycle (draft ->
  submitted
   -> processing -> shipped -> delivered) is independent
   of Payment lifecycle (pending -> processing ->
     completed)
