...
nav_order: 1
permalink: /technical-mastery/microservices/monolith-vs-microservices/
---
...
Microservices:
```
1 change → 1 service build → 1 service deploy (that
  service only)
Timeline: minutes per service
Risk: service contract breaks can cause distributed
  failures
```
...
│              │ or deployed together = worst of both worl│
├──────────────┼──────────────────────────────────────────┤
