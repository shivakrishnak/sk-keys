...
nav_order: 34
permalink: /technical-mastery/microservices/ubiquitous-language/
---
...
4. ENFORCE IN CODE:
   ...
   Method names: order.submit(), payment.process(),
                 cart.checkout()
   NOT: order.save(), order.setStatus(),
     createPaymentRecord()
...
1. EVENT STORMING WORKSHOP:
   Output: list of domain events (past tense, business
     terms)
...
3. CODE REVIEW CHECKLIST:
   ...
   "Is a technical CRUD name used where a domain name
     exists?"
