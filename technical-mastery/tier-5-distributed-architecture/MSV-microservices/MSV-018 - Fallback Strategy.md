...
nav_order: 18
permalink: /technical-mastery/microservices/fallback-strategy/
---
...
Homepage calls 5 services:
  ...
  - Inventory Service  (optional: fallback to "check
    store")
...
DEGRADATION MATRIX:
  ...
  Product down:        500 (nothing to show without
    products)
...
│              │ Alert on circuit open + high fallback rat│
├──────────────┼──────────────────────────────────────────┤
