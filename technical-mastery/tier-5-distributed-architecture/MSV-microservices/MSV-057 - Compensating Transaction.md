...
nav_order: 57
permalink: /technical-mastery/microservices/compensating-transaction/
---
...
COMPENSATING TRANSACTIONS (C) - reverse of T:
  ...
  C1: CancelOrder      -> undo T1 (T4 not needed if
    aborted)
...
COMPENSATION:
  T=3: CancelShipment     -> (T=2 failed; nothing to
    cancel)
...
├──────────────┼──────────────────────────────────────────┤
│ LIMITATIONS  │ Cannot unsend emails, unreversible effect│
│              │ Use "best effort" compensations for these│
├──────────────┼──────────────────────────────────────────┤
│ ONE-LINER    │ "Business undo for committed transactions│
│              │  Saga's rollback; idempotent; reverse ord│
└─────────────────────────────────────────────────────────┘
```
