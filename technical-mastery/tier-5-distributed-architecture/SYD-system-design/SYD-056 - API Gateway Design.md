...
nav_order: 56
permalink: /technical-mastery/syd/api-gateway-design/
---
...
2. Authentication:
   ...
   Alternative: forward token to Auth Service for
     validation.
...
4. Rate Limiting:
   ...
   Counters stored in Redis (shared across gateway
     instances).
...
│                │ routing, load balance, response transfo│
├────────────────┼────────────────────────────────────────┤
