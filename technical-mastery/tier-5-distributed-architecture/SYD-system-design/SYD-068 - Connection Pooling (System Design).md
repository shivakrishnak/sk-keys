...
nav_order: 68
permalink: /technical-mastery/syd/connection-pooling-system-design/
---
...
[App-1: 50 threads] ─┐
[App-2: 50 threads] ─┼──→ [PgBouncer      ] ──→
  [PostgreSQL]
[App-3: 50 threads] ─┘    [Pool: 50 conns ]     [200 conns
  MAX]
...
All app instances → PgBouncer (unlimited client
  connections)
