...
nav_order: 81
permalink: /technical-mastery/syd/microservices-vs-monolith-decision/
---
...
4. Different reliability requirements
   User authentication: 99.99% availability (affects all
     users).
   Recommendation engine: 99.9% acceptable (degrade
     gracefully).
...
The goal is "extract services where there is a clear
  reason."
