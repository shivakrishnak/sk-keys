...
nav_order: 51
permalink: /technical-mastery/syd/search-system-design/
---
...
Elasticsearch cluster:
  ...
  Shard: a single Lucene instance; physical partition of
    index
...
Query flow:
  ...
  → Scatter: query sent to all 10 primary (or replica)
    shards
