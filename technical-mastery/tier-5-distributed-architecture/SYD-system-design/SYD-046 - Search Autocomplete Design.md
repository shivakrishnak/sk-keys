...
nav_order: 46
permalink: /technical-mastery/syd/search-autocomplete-design/
---
...
Query: "apple"
        ...
        e   t
        |   |
        [top-K at "appl": ["apple","apple pie","apple
          music"]]
        |
        e
        [top-K at "apple": ["apple","apple pie","apple
          watch"]]
...
Without precomputed top-K:
  ...
  DFS all descendants to find all queries starting with
    "appl"
  Sort by score
  Return top 5
