...
nav_order: 57
permalink: /technical-mastery/syd/event-driven-architecture/
---
...
BAD event naming: PlaceOrder, CreateOrder (commands, not
  events)
GOOD event naming: OrderPlaced, OrderConfirmed (facts that
  happened)
...
├─────────────┼──────────────────────────────────────────┤
  │
│ IDEMPOTENCY │ Include event_id. Consumers track processe│
