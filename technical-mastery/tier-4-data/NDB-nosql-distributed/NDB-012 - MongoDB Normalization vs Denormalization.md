...
nav_order: 12
permalink: /technical-mastery/nosql/mongodb-normalization-denormalization/
id: NDB-017
...
Subset           Full array too large     Embed top-K
  items,
                 for working set          reference rest

Outlier          Rare docs violate        isOverflow flag +
                 normal bounds            overflow
                   collection

Computed         Aggregation too slow     Pre-compute &
  store
                 at read time             on write

Bucket           High-write time-series   Group N events
  per
