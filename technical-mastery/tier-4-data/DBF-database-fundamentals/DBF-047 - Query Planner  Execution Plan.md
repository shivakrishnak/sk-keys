...
nav_order: 47
permalink: /technical-mastery/databases/query-planner/
id: DBF-044
...
```
cost = disk_pages × seq_page_cost + heap_fetches ×
  random_page_cost + rows × cpu_tuple_cost
```
...
→ [QUERY PLANNER ← YOU ARE HERE: enumerate + estimate +
  choose]
→ Execution plan tree generated
→ Executor walks plan tree (Seq Scan / Index Scan / Hash
  Join / ...)
