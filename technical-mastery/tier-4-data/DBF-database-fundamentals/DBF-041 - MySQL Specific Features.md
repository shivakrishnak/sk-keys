...
nav_order: 41
permalink: /technical-mastery/databases/mysql-specific-features/
id: DBF-019
...
→ Secondary index lookup: email → row_pointer (physical
  address)
...
```
→ Secondary index lookup: email → user_id (PK already in
  index)
