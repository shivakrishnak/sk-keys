...
nav_order: 18
permalink: /technical-mastery/databases/non-repeatable-read/
id: DBF-035
...
→ Logical inconsistency: write assumes old value, DB has
  new value
...
│              │ committed data - the change is the proble│
├──────────────┼──────────────────────────────────────────┤
│ USE WHEN     │ REPEATABLE READ for read-compute-write;  │
│              │ or SELECT FOR UPDATE at READ COMMITTED   │
├──────────────┼──────────────────────────────────────────┤
│ AVOID WHEN   │ Don't use REPEATABLE READ for long-runnin│
