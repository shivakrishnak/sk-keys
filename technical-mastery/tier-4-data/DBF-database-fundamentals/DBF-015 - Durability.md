...
nav_order: 15
permalink: /technical-mastery/databases/durability/
id: DBF-026
...
```
Crash before WAL fsync → COMMIT not returned → Atomicity
  handles rollback
Crash after WAL fsync, before page flush → Durability
  holds:
...
│              │ the foundation of database trustworthines│
├──────────────┼──────────────────────────────────────────┤
