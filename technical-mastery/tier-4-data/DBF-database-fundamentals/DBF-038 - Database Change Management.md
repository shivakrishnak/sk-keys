...
nav_order: 38
permalink: /technical-mastery/databases/database-change-management/
id: DBF-018
...
Phase 2 (App deploy): Write to BOTH columns; read from
  cust_nm
Phase 3 (Migration V6): Backfill customer_name from cust_nm
Phase 4 (App deploy): Write to BOTH; read from
  customer_name
Phase 5 (App deploy): Write to customer_name only; stop
  cust_nm
