...
nav_order: 43
permalink: /technical-mastery/data-fundamentals/master-data-management/
id: DAT-045
...
**FAILURE PATH:**
```
Entity resolution false positive: two different customers
  merged
→ "Jane Smith NZ" and "Jane Smith AU" merged as same person
→ cross-sell recommendations and financial reports wrong
→ observable: business analyst notices customer with two
  addresses
