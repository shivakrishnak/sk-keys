...
nav_order: 16
permalink: /technical-mastery/data-fundamentals/data-compression/
id: DAT-014
...
LZ output (simplified):
  "the quick brown fox jumped over " + <back-ref: pos=0,
    len=9>
...
│              │ CPU - faster compression → faster pipelin│
├──────────────┼──────────────────────────────────────────┤
│ USE WHEN     │ All data pipelines; all REST APIs; all   │
│              │ Kafka topics with significant payload siz│
├──────────────┼──────────────────────────────────────────┤
