...
nav_order: 38
permalink: /technical-mastery/data-fundamentals/data-fabric/
id: DAT-025
...
**NORMAL FLOW:**
```
Source Change → Crawler detects → [DATA FABRIC ← YOU ARE
  HERE]
...
→ observable: crawler failure logs + staleness flag in
  catalog
```
