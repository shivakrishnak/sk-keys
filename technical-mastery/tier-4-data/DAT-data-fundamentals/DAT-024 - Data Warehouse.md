...
nav_order: 24
permalink: /technical-mastery/data-fundamentals/data-warehouse/
id: DAT-030
...
**NORMAL FLOW:**
```
OLTP/APIs → ETL Pipeline → Staging → [DATA WAREHOUSE ← YOU
  ARE HERE]
...
→ observable: row count check alert; timestamp of
  last_loaded field
```
