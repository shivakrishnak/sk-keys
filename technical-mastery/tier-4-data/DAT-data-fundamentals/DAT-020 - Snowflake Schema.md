...
nav_order: 20
permalink: /technical-mastery/data-fundamentals/snowflake-schema/
id: DAT-015
...
dim_product:  product_id, category_key, subcategory_key,
  brand_key
dim_category: category_key=1, name="Electronics"  ← stored
  ONCE
dim_subcategory: subcategory_key=1, name="Mobile" ← stored
  ONCE
```
...
├──────────────┼──────────────────────────────────────────┤
│ USE WHEN     │ Deep hierarchies (>3 levels) with frequen│
