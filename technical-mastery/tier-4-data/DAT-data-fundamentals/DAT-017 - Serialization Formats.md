...
nav_order: 17
permalink: /technical-mastery/data-fundamentals/serialization-formats/
id: DAT-022
...
// field 2 (name): tag + length + 10 chars = 1 + 1 + 10 =
  12
// field 3 (email): tag + length + 20 chars = 1 + 1 + 20 =
  22
...
Encoded "Customer{id:1001, name:'Alice', active:true}":
  ...
  Total: 12 bytes
  (JSON equivalent:
    {"id":1001,"name":"Alice","active":true} = 43 bytes)
```
