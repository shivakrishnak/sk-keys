...
nav_order: 21
permalink: /technical-mastery/react/useeffect-hook/
---
...
No array:
  ...
  Use case: effects that intentionally respond to all
    renders.

[]:
  Effect runs once after first render (mount).
  Never re-runs. Cleanup runs on unmount.
  Use case: one-time setups (analytics init, global
    listeners).
...
7. React re-renders component (still shows user 123
  briefly)
8. React commits DOM
