...
nav_order: 13
permalink: /technical-mastery/react/event-handling-in-react/
---
...
```
onClick         - mouse click, keyboard enter/space on
  interactive elements
onChange        - value change in inputs/selects (fires on
  every keystroke)
onSubmit        - form submission (attach to <form>, not
  submit button)
