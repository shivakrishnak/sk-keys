...
nav_order: 5
permalink: /technical-mastery/react/react-ecosystem-landscape/
---
...
3. React Server Component runs on server:
   - Fetches initial product data directly (no client
     roundtrip)
...
7. React Query caches result (next filter change is
  instant)
8. React Router handles navigation to /products/42
  client-side
   (no full page reload)
```
