...
nav_order: 16
permalink: /technical-mastery/react/one-way-data-binding/
---
...
3. Render child components with props derived from (1) and
  (2)
...
With two-way binding:
  ...
  → Must trace bidirectional flows across multiple
    components
...
With one-way binding:
  ...
  - Find who called setState → that is the source of the
    change
