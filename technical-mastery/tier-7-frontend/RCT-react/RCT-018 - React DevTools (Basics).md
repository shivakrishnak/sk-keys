...
nav_order: 18
permalink: /technical-mastery/react/react-devtools-basics/
---
...
1. FIND COMPONENT FOR DOM ELEMENT:
   ...
   - React DevTools jumps to that component in Components
     tab
...
3. EDIT LIVE:
   ...
   - Press Enter to apply - component re-renders
     immediately
   - Useful for testing edge cases (empty strings, null
     values)
...
3. "WHY DID THIS RENDER?":
   ...
   - Right panel shows: "This component rendered
     because..."
   - Lists: props that changed, state that changed,
     context change
