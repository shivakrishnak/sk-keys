...
nav_order: 10
permalink: /technical-mastery/javascript/var-let-const/
id: JSC-010
category: JavaScript
difficulty: ★☆☆
...
const arr = []; arr.push(1);  // OK - mutation, not
  reassignment
const obj = {}; obj.key = 1;  // OK - mutation, not
  reassignment
```
...
```
┌─────────────────────────────────────────────────────────┐
│ KEY IDEA     │ var=function-scoped+hoisted; let=block+TD│
