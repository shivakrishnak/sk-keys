...
nav_order: 33
has_children: true
permalink: /technical-mastery/git/
---
...
|----|---------|------------|
| GIT-001 | What Is Git and Why Version Control Matters | ★☆☆ |
| GIT-002 | The Git Mental Model (DAG of Commits) | ★☆☆ |
| GIT-003 | Git vs Other VCS (SVN, Mercurial) | ★☆☆ |
| GIT-004 | The Git Ecosystem Map (GitHub, GitLab, Bitbucket) | ★☆☆ |
| GIT-005 | Git in Teams -- What to Expect | ★☆☆ |
| GIT-006 | Git Basics (init, clone, add, commit, push, pull) | ★☆☆ |
| GIT-007 | Git Staging Area (Index) | ★☆☆ |
| GIT-008 | Git Branches -- Create, Switch, Delete | ★☆☆ |
| GIT-009 | Git Merge | ★☆☆ |
| GIT-010 | Git Rebase | ★☆☆ |
