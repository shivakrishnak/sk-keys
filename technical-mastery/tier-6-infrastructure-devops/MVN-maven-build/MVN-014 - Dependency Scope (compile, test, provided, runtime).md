...
nav_order: 14
permalink: /technical-mastery/maven-build/dependency-scope/
id: MVN-022
...
<dependency>
  ...
  <scope>runtime</scope>  <!-- Code uses java.sql.*,
      not pg-specific -->
</dependency>
```
...
mvn package produces target/my-app.war containing:
  ...
  [jakarta.servlet-api.jar ABSENT] ✓ (provided - Tomcat
    supplies)
