...
nav_order: 33
permalink: /technical-mastery/maven-build/maven-release-plugin/
id: MVN-037
...
3. mvn deploy (to release repository in
...
# Then manually: git tag -d v2.0.0 (if tag was pushed: git push
# --delete origin v2.0.0)
...
<plugin>
  ...
  <configuration>
    ...
    <!-- Don't build twice in perform (
        use already-built artifacts from prepare) -->
    <useReleaseProfile>false</useReleaseProfile>
    <!-- Goals to run during perform (
        just deploy; compile+test already done) -->
