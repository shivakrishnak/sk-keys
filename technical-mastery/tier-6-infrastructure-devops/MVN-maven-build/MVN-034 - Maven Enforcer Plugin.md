...
nav_order: 34
permalink: /technical-mastery/maven-build/maven-enforcer-plugin/
id: MVN-038
...
[ERROR] Rule 0:
  org.apache.maven.plugins.enforcer.BannedDependencies
    failed
Dependency commons-logging:commons-logging:1.2 found
  (excluded: commons-logging:commons-logging)
```
