...
nav_order: 17
permalink: /technical-mastery/maven-build/nexus-artifactory/
id: MVN-020
...
mvn deploy (with version 1.0.0-SNAPSHOT)
    ...
    → URL:
      .../my-snapshots/com/example/my-app/1.0.0-SNAPSHOT/
    → each deploy generates:
      my-app-1.0.0-20241201.123456-1.jar
...
# Should show: Downloading from nexus-central:
