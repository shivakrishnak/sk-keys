...
nav_order: 23
permalink: /technical-mastery/maven-build/dependency-convergence/
id: MVN-017
...
[INFO]    \- com.google.guava:guava:jar:28.0-jre:compile
  (omitted for conflict with 30.0-jre)
...
Rule 0:
  ...
  Dependency convergence error for
    com.google.guava:guava:30.0-jre paths to dependency
      are:
...
├──────────────┼──────────────────────────────────────────┤
│ ENFORCE IT   │ maven-enforcer-plugin dependencyConvergen│
├──────────────┼──────────────────────────────────────────┤
