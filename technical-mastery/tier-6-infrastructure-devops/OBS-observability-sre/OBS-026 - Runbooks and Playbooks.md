...
nav_order: 26
permalink: /technical-mastery/obs/runbooks-and-playbooks/
---
...
_Hint: Think about the 80/20 principle applied to runbooks
and what "high-use runbook" means as a reliability signal._
...
_Hint: Think about how you could make the runbook validation
automated - not just dependent on engineers reporting stale
steps after an incident._
...
_Hint: Consider what "safe to automate" means - what actions
...
_Why they ask:_ Tests ability to implement SRE practices
...
evolves?**
_Why they ask:_ Tests understanding that runbook maintenance
...
_Why they ask:_ Tests precision in operational vocabulary and
