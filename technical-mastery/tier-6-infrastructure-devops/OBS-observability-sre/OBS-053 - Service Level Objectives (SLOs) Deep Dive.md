...
nav_order: 53
permalink: /technical-mastery/observability-sre/service-level-objectives-slos-deep-dive/
---
...
BAD SLI: "server-side success rate"
  ...
  Counts non-critical background requests (user doesn't
    care)
...
Step 1: Measure baseline reliability (90-day window)
  p_natural = avg(SLI over last 90 days excluding
    incidents)
...
Quarterly SLO Review Agenda:
  1. Did we breach SLO this quarter? If yes: postmortem
    review.
