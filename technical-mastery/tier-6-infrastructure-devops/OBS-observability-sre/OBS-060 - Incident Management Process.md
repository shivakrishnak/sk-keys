...
nav_order: 60
permalink: /technical-mastery/obs/incident-management-process/
---
...
*Hint: Think about the signal-to-noise problem in alerting and
how SLO burn rate alerts differ from individual threshold alerts
in terms of false positive rate and actionability.*
...
*Hint: Consider how companies like Stripe, Netflix, and Google
...
after 90 days.
*Hint: Consider what cultural changes must happen alongside
process changes, how you measure "blameless culture" adoption,
and how compliance requirements affect the postmortem format.*
...
*Why they ask:* Tests whether the candidate understands incident
...
*Why they ask:* Tests ability to operationalize abstract
...
*Why they ask:* Tests nuanced understanding of psychological
