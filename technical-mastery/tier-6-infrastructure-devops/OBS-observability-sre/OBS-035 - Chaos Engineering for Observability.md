...
nav_order: 35
permalink: /technical-mastery/obs/chaos-engineering-for-observability/
---
...
# If pods in production namespace appear affected: execute
# ROLLBACK_CMD immediately
```
...
├──────────────┼──────────────────────────────────────────┤
│ KEY TOOLS    │ Litmus Chaos: Kubernetes-native, CRD-base│
...
├──────────────┼──────────────────────────────────────────┤
│ SAFETY RULES │ Blast radius: minimum fault, short durati│
│              │ Rollback command ready before injection  │
│              │ Production-isolated staging infrastructur│
├──────────────┼──────────────────────────────────────────┤
