...
nav_order: 43
permalink: /technical-mastery/obs/observability-driven-development-strategy/
---
...
```
Feature planning:
  ├── Define SLI: what is the user-observable success
    metric?
...
Feature development:
  ...
  ├── Add RED metrics (counter for rate, counter for
    errors,
...
- [ ] Trace span for all external calls - Service name,
    operation name, success/error attribute
