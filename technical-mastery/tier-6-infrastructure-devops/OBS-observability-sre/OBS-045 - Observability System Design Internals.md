...
nav_order: 45
permalink: /technical-mastery/obs/observability-system-design-internals/
---
...
Symptom:
  ...
  Kubernetes OOM killer terminates at 16GB (container
    limit)
...
```
# In Loki query log:
msg="query stats" entries=5000  # exactly at limit =
  truncated
