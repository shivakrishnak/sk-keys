...
*Hint: Consider the difference between verifying "can I connect?"
at probe time vs maintaining a background connection whose cached
health state is read by the endpoint handler.*
...
*Hint: Think about how Kubernetes interprets different HTTP status
codes and how you represent partial degradation in observability
tooling separately from the traffic routing decision.*
...
*Why they ask:* Tests understanding of the three-probe model and
...
*Why they ask:* Tests understanding of health check resource
...
implementation.**
*Why they ask:* Tests ability to design tiered health checks with
...
*Why they ask:* Tests production intuition - distinguishing
