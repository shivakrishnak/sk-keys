...
nav_order: 23
permalink: /technical-mastery/obs/datadog-observability-platform/
---
...
_Hint: Think about which log levels actually require indexed
storage vs cold archive vs log-based metrics - not all log
lines have equal diagnostic value._
...
_Hint: Investigate how distributed trace context can be carried
in message headers and how Datadog's Kafka integration
propagates trace context._
...
_Hint: Think about who owns the unified tag schema, how you
enforce it in CI/CD, and how you attribute cost back to the
team that caused the increase._
...
fix first?**
_Why they ask:_ Tests understanding that Datadog's value comes
...
_Why they ask:_ Tests understanding of cardinality's cost impact
on Datadog billing.
_Strong answer includes:_
...
do not configure it?**
_Why they ask:_ Tests production APM knowledge beyond basic
...
_Why they ask:_ Tests operational knowledge of the agent
