...
nav_order: 62
permalink: /technical-mastery/obs/log-aggregation-at-scale/
---
      ...
      Fluent Bit starts dropping logs (or pauses) →
        Log gap appears in Elasticsearch →
          Gap is visible in Kibana as "no log data" →
            Incident investigation during outage is
              impaired
```
...
```
# Loki LogQL: find all ERROR logs from payment-api in last
  1h
# Loki indexes labels only; log content is compressed in
  chunks
...
*Hint: Think about horizontal scaling of Kafka partitions
...
per week on average?
*Hint: Use rough cost estimates: Elasticsearch $30/GB/month
...
*Why they ask:* Tests operational knowledge of Elasticsearch
...
spending $5M/year?**
*Why they ask:* Tests ability to design tiered storage
...
*Why they ask:* Tests understanding of pipeline reliability
