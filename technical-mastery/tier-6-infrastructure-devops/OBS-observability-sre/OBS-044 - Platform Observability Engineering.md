...
nav_order: 44
permalink: /technical-mastery/obs/platform-observability-engineering/
---
...
│              │ Prometheus/Thanos + Tempo + Loki + Grafan│
├──────────────┼──────────────────────────────────────────┤
...
├──────────────┼──────────────────────────────────────────┤
│ SCALE TRAP   │ Cardinality explosion from high-cardinali│
