...
nav_order: 52
permalink: /technical-mastery/observability-sre/opentelemetry-collector-pipeline/
---
...
5. tail_sampling processor:
   Makes sampling decisions after seeing all spans in a
     trace.
...
Fix:
  ...
  processors:
    memory_limiter:
      check_interval: 1s
      limit_mib: 400        # 80% of container limit
        (500MB)
