...
nav_order: 31
permalink: /technical-mastery/obs/golden-signals/
---
...
[Pool exhaustion]
  ...
  Errors: 0.07% → 8%            ← pool timeouts = 5xx
    errors
  Traffic: 1,200 → 950 req/s    ← failed requests dropping
    off
...
├──────────────┼──────────────────────────────────────────┤
│ SATURATION   │ Most constrained resource for this servic│
...
├──────────────┼──────────────────────────────────────────┤
│ NEXT EXPLORE │ SLO-Based Alerting, Platform Observabilit│
└─────────────────────────────────────────────────────────┘
```
