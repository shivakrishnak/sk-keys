...
nav_order: 36
permalink: /technical-mastery/obs/post-mortem-and-blameless-culture/
---
...
Root cause: No automated schema validation in CI/CD
  pipeline
Action item: Add schema validation step to CI/CD (owner:
  @db-team, 2 weeks)
```
...
Incident occurs → Resolved → Postmortem written
   ...
   │                                    │
   │                         Items enter engineering
     backlog
   │                                    │
   │                         Items completed or carried
     over
   │                                    │
