...
nav_order: 28
permalink: /technical-mastery/cloud-aws/elasticache/
id: AWS-042
category: "Cloud - AWS"
difficulty: "★★☆"
...
Redis (ElastiCache for Redis / Valkey):
  ...
  Use: caching, sessions, rate limiting, leaderboards,
    pub/sub
...
public class ProductService {
    ...
    public void cacheRateLimitCounter(String userId, String action) {
        ...
        ValueOperations<String,
            Object> ops = redisTemplate.opsForValue();
    ...
    public void recordScore(String gameId, String userId,
        double score) {
        redisTemplate.opsForZSet().add("leaderboard:" + gameId,
            userId, score);
    }
...
aws elasticache describe-replication-groups \
  --query 'ReplicationGroups[].{Id:ReplicationGroupId,Status:Status,
      Nodes:NodeGroups[0].NodeGroupMembers[*].ReadEndpoint.Address}'
