...
nav_order: 7
permalink: /technical-mastery/cloud-aws/region-az-edge-location/
id: AWS-053
category: "Cloud - AWS"
difficulty: "★☆☆"
...
Regional:
  EC2, ECS, EKS, Lambda, RDS, DynamoDB, S3 (data in
    region),
  SQS, SNS, ALB, VPC, ElastiCache, Kinesis, API Gateway

AZ-scoped:
  EC2 instance, EBS volume, Subnet, NAT Gateway, RDS
    instance

  Note: EBS volume must be in same AZ as EC2 instance
  Note: NAT Gateway per AZ (don't share across AZs =
...
# https://cloudping.info - browser-based latency test to all AWS
# regions
```
