...
nav_order: 25
permalink: /technical-mastery/cloud-aws/s3-storage-classes/
id: AWS-012
category: "Cloud - AWS"
difficulty: "★★☆"
depends_on: ["S3"]
...
```
Storage Class          | Storage Cost  | Retrieval | Min
  Duration
-----------------------|---------------|-----------|-------
Standard               | $0.023/GB     | Instant   | None
Intelligent-Tiering    | $0.023→0.002  | Instant   | None
Standard-IA            | $0.0125/GB    | Instant   | 30
  days
One Zone-IA            | $0.01/GB      | Instant   | 30
  days
Glacier Instant        | $0.004/GB     | Instant   | 90
  days
Glacier Flexible       | $0.0036/GB    | 1-12hr    | 90
  days
Glacier Deep Archive   | $0.00099/GB   | 12-48hr   | 180
  days
...
Data type:
  ...
  Non-critical, single AZ OK?  → One Zone-IA (15% cheaper
    than Standard-IA)
