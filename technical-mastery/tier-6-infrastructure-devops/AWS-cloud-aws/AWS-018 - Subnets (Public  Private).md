...
nav_order: 18
permalink: /technical-mastery/cloud-aws/subnets-public-private/
id: AWS-018
category: "Cloud - AWS"
difficulty: "★★☆"
...
Public subnet characteristics:
  ...
  ✅ Resources reachable from internet (if Security Group
    allows)
...
Solution 2: VPC CNI prefix delegation (allocates /28
  blocks)
