...
nav_order: 51
permalink: /technical-mastery/cloud-aws/nacls/
id: AWS-060
category: "Cloud - AWS"
difficulty: "★★★"
...
NACL vs Security Group:
  NACL:       subnet level, stateless, allow + deny,
    numbered rules
  Sec Group:  resource level, stateful, allow only, all
    rules combined
...
```
# Public subnet NACL - allows web traffic + admin SSH from
  specific IP
...
100    | HTTPS      | TCP      | 443        | 0.0.0.0/0
  | ALLOW
110    | HTTP       | TCP      | 80         | 0.0.0.0/0
  | ALLOW
120    | SSH        | TCP      | 22         |
  203.0.113.1/32  | ALLOW (admin IP)
