...
nav_order: 30
permalink: /technical-mastery/cloud-aws/sns/
id: AWS-018
category: "Cloud - AWS"
difficulty: "★★☆"
...
Message filtering:
  Subscription filter policies: subscribers receive only
    matching messages
...
public class OrderEventPublisher {
    ...
    public void publishOrderCreated(Order order) {
        ...
        // Spring Cloud AWS auto-adds message attributes from
        // SnsNotificationMessage
        snsTemplate.sendNotification(ordersTopicArn, event,
            "ORDER_CREATED");
    }
...
aws sns publish \
  ...
  --message-attributes '{"eventType":{"DataType":"String",
