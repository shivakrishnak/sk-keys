...
nav_order: 70
permalink: /technical-mastery/ci-cd/terraform-sentinel-policy/
id: CCD-072
category: CI/CD
difficulty: ★★★
...
3. Sentinel policies in applicable policy sets are
  evaluated
4. Policy results:
   - All pass → Apply allowed
   - Soft-mandatory fail → Apply blocked; override
     available
