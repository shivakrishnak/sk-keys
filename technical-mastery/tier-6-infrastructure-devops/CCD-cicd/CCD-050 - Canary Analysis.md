...
nav_order: 50
permalink: /technical-mastery/ci-cd/canary-analysis/
id: CCD-033
category: CI/CD
difficulty: ★★★
...
10% canary stage:
  ...
  → Alert: "Canary rollback: sha-abc failed error rate
    analysis"
...
│ SOLVES       │ and unavailable for high-frequency deploy│
├──────────────┼──────────────────────────────────────────┤
...
│              │ A/B Testing infrastructure → Rollout Blis│
└─────────────────────────────────────────────────────────┘
```
