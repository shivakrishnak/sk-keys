...
nav_order: 24
permalink: /technical-mastery/ci-cd/environment-promotion/
id: CCD-030
category: CI/CD
difficulty: ★★☆
...
```
┌─────────────────────────────────────────────────────────┐
│ WHAT IT IS   │ Moving the same immutable artefact throug│
│              │ environments with quality gates between  │
├──────────────┼──────────────────────────────────────────┤
│ PROBLEM IT   │ Uncontrolled deployments causing         │
│ SOLVES       │ production incidents from untested change│
├──────────────┼──────────────────────────────────────────┤
