...
nav_order: 71
permalink: /technical-mastery/ci-cd/terragrunt/
id: CCD-073
category: CI/CD
difficulty: ★★★
...
```
infra-live/
├── terragrunt.hcl           ← root config (backend
  template)
├── dev/
...
terraform {
  source =
      "git::https://github.com/myorg/terraform-aws-vpc.git?ref=v2.1.0"
}
...
terraform {
  source =
      "git::https://github.com/myorg/terraform-aws-eks.git?ref=v3.0.0"
}
