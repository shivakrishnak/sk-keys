...
nav_order: 48
permalink: /technical-mastery/ci-cd/dora-metrics/
id: CCD-031
category: CI/CD
difficulty: ★★★
...
Team begins gaming metrics:
  ...
  → But: CFR rises to 25% (bad - real code quality
    worsening)
...
class DoraCalculator:
    ...
    def lead_time_hours(self):
        ...
        for deploy in resp.json()[:20]:
            ...
            commit_time =
                commit_resp.json()["commit"]["committer"]["date"]
            deploy_time = deploy["created_at"]

            t0 = datetime.fromisoformat(commit_time.replace("Z",
                "+00:00"))
            t1 = datetime.fromisoformat(deploy_time.replace("Z",
                "+00:00"))
