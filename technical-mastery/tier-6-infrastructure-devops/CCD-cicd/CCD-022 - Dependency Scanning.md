...
nav_order: 22
permalink: /technical-mastery/ci-cd/dependency-scanning/
id: CCD-020
category: CI/CD
difficulty: ★★☆
...
Developer adds new dependency: `axios@0.21.0`
  ...
  → Dependency scan: scan package-lock.json [← YOU ARE
    HERE]
  → axios@0.21.0 → CVE-2021-3749 (SSRF) / CVSS 7.5 / High
  → Policy: High → block PR
  → GitHub PR: ✗ "Dependency scan: High CVE in
    axios@0.21.0"
...
│ SOLVES       │ libraries sitting undetected in productio│
├──────────────┼──────────────────────────────────────────┤
│ KEY INSIGHT  │ Scan lock files (exact versions), not jus│
