...
nav_order: 39
permalink: /technical-mastery/ci-cd/sca/
id: CCD-024
category: CI/CD
difficulty: ★★★
...
(Day 0): Application deployed - all deps clean
  ...
  → Snyk continuous monitoring detects match in deployed
    app
  → Alert: "New Critical CVE in production:
    jackson-databind"
...
│              │ each against CVE databases for known vuln│
├──────────────┼──────────────────────────────────────────┤
│ PROBLEM IT   │ 80% of modern apps are open-source code  │
│ SOLVES       │ with continuously discovered vulnerabilit│
├──────────────┼──────────────────────────────────────────┤
