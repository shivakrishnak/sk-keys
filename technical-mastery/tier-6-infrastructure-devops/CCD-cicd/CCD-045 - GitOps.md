...
nav_order: 45
permalink: /technical-mastery/ci-cd/gitops/
id: CCD-057
category: CI/CD
difficulty: ★★★
  ...
  apps/
    myapp/
      ...
      overlays/
        ...
        production/
          kustomization.yaml   # patches: replicas=5,
            image=sha-abc
```
```yaml
...
│              │ continuously converge cluster to Git stat│
├──────────────┼──────────────────────────────────────────┤
...
│              │ secrets-in-git complexity + strict proces│
├──────────────┼──────────────────────────────────────────┤
