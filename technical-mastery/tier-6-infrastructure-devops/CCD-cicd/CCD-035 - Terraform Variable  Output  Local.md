...
nav_order: 35
permalink: /technical-mastery/ci-cd/terraform-variable-output-local/
id: CCD-051
category: CI/CD
difficulty: ★★☆
...
```
  ...
  Remote state:
    data.terraform_remote_state.X.outputs.vpc_id
```
...
cat prod.tfvars
# environment = "prod"
# vpc_config = { cidr = "10.0.0.0/16", azs = ["us-east-1a"],
# enable_nat = true }
