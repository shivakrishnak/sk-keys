...
nav_order: 47
permalink: /technical-mastery/ci-cd/mean-time-to-recovery/
id: CCD-059
category: CI/CD
difficulty: ★★★
...
Error rate spike at 14:05 (T0)
  ...
  → Sees: DB query timeout in order-service [← YOU ARE
    HERE]
...
pd incidents list --since "30d" \
  | jq '.incidents[] | {created_at,
      first_trigger: .first_trigger_log_entry.created_at}'
```
...
├──────────────┼──────────────────────────────────────────┤
│ TRADE-OFF    │ Investment in monitoring/runbooks/rollbac│
