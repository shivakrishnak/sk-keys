...
nav_order: 69
permalink: /technical-mastery/ci-cd/terraform-lifecycle-rules/
id: CCD-071
category: CI/CD
difficulty: ★★★
...
resource "aws_instance" "app_checked" {
  ...
  lifecycle {
    precondition {
      condition     = contains(["t3.micro", "t3.medium",
          "m5.large"], var.instance_type)
    ...
    postcondition {
      ...
      error_message =
          "Instances must not have public IPs in production."
    }
  }
}
```
