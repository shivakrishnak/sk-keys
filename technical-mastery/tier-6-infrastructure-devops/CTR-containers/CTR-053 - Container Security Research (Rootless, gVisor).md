...
difficulty: ★★★
depends_on: CTR-018, CTR-035, CTR-048
used_by: CTR-023
related: CTR-048, CTR-053
tags:
  - containers
  - security
  - deep-dive
...
nav_order: 53
permalink: /technical-mastery/ctr/container-security-research-rootless-gvisor/
---
...
| Metadata        |                          |     |
| :-------------- | :----------------------- | :-- |
| **Depends on:** | CTR-018, CTR-035, CTR-048 |     |
| **Used by:**    | CTR-023                  |     |
| **Related:**    | CTR-048, CTR-053         |     |
...
- [[CTR-018 - Linux Namespaces]] - user namespaces (the rootless mechanism)
- [[CTR-035 - Container Security]] - baseline container security
- [[CTR-048 - Container Security Architecture]] - defense-in-depth framework
...
- [[CTR-048 - Container Security Architecture]] - standard security controls
- [[CTR-053 - Linux Namespace and Cgroup Architecture]] - the underlying mechanism
...
│ NEXT EXPLORE│ CTR-023 Security Mental Model       │
└────────────────────────────────────────────────────┘
```
