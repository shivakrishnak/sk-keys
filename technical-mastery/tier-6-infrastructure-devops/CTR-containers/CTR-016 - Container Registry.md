...
difficulty: ★★☆
depends_on: CTR-025, CTR-006, CTR-020, CTR-029
used_by: CTR-019, CTR-029, CTR-040, CTR-027
related: CTR-006, CTR-029, CTR-019, CTR-020, CTR-025
tags:
  - containers
  - docker
  - devops
...
nav_order: 16
permalink: /technical-mastery/containers/container-registry/
---
...
│  ├── Repositories                                       │
│  │    └── myorg/myapp                                   │
│  │         ├── Tags: {1.0 → sha256:abc, latest → sha256:│
...
→ mitigation: image pull-through cache prevents single
  point of failure
```
...
# Shows: Failed to pull image: ... registry <HOST>: ... connection
# refused
