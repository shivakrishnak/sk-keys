...
nav_order: 54
permalink: /technical-mastery/ctr/container-trade-off-framing/
---
...
Axis 1: PORTABILITY
  5 = runs identical in
    dev/test/staging/prod/cloud-A/cloud-B
...
8-12         Containers possible but alternatives worth
  evaluating
<8           Containers likely wrong choice; use VM or
  managed service
```
