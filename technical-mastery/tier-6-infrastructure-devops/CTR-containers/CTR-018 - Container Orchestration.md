...
difficulty: ★★☆
depends_on: CTR-024, CTR-025, CTR-034, CTR-026, CTR-015
used_by: K8S-001, CTR-028
related: CTR-015, K8S-001, CTR-021, CTR-034, CTR-017
tags:
  - containers
  - kubernetes
  - orchestration
...
nav_order: 18
permalink: /technical-mastery/containers/container-orchestration/
---
...
spec:
  ...
  - port: 80
    targetPort: 8080
  type: ClusterIP
  # internal cluster DNS: my-app.default.svc.cluster.local
```
...
├──────────────┼──────────────────────────────────────────┤
│ KEY INSIGHT  │ Declarative desired state + reconciliatio│
