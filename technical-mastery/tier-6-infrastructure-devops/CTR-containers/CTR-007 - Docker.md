...
difficulty: ★☆☆
depends_on: CTR-024, CTR-018, CTR-010, CTR-020
used_by: CTR-006, CTR-007, CTR-015, CTR-016, CTR-014
related: CTR-024, CTR-041, CTR-021, CTR-020, CTR-008
tags:
  - containers
  - docker
  - devops
...
nav_order: 7
permalink: /technical-mastery/containers/docker/
---
...
**NORMAL FLOW:**
```
Developer writes Dockerfile → docker build → [IMAGE ← YOU
  ARE HERE]
→ docker push → Registry → CI/CD pulls → docker run on
  server
...
**FAILURE PATH:**
```
docker run fails with "image not found" or daemon
  unavailable
