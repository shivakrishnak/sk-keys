...
difficulty: ★☆☆
depends_on: CTR-025, CTR-006, CTR-009, CTR-024
used_by: CTR-013, CTR-014, CTR-040, CTR-035
related: CTR-009, CTR-014, CTR-013, CTR-040, CTR-035
tags:
  - containers
  - docker
  - devops
...
nav_order: 9
permalink: /technical-mastery/containers/dockerfile/
---
...
→ layers created + cached → image tagged → pushed to
  registry
...
```
# .dockerignore - prevent these from entering the build
  context
node_modules/
.git/
.gitignore
