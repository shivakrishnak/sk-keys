...
difficulty: ★☆☆
depends_on: CTR-025, CTR-024, CTR-007, CTR-020
used_by: CTR-009, CTR-014, CTR-016, CTR-029, CTR-036
related: CTR-009, CTR-007, CTR-016, CTR-014, CTR-029
tags:
  - containers
  - docker
  - devops
...
nav_order: 8
permalink: /technical-mastery/containers/docker-image/
---
...
→ if image already on host → docker run still works
  (cached)
→ new images cannot be deployed until registry is
  accessible
```
...
│ SOLVES       │ and production causing different behaviou│
├──────────────┼──────────────────────────────────────────┤
...
│              │ avoid mutable image states (always rebuil│
├──────────────┼──────────────────────────────────────────┤
