...
difficulty: ★★★
depends_on: CTR-025, CTR-035, CTR-015, CTR-007, CTR-026
used_by: CTR-035
related: CTR-035, CTR-040, CTR-019, CTR-036
tags:
  - containers
  - docker
  - security
...
nav_order: 42
permalink: /technical-mastery/containers/docker-secrets/
---
...
**NORMAL FLOW:**
```
Admin creates secret: docker secret create db-pass
  ./pass.txt
...
# --source=v2: which secret to use; --target=db-password: same path in
# container
