...
difficulty: ★★★
depends_on: CTR-025, CTR-024, CTR-018, CTR-010, CTR-020
used_by: CTR-046, K8S-001
related: CTR-025, CTR-046, CTR-020, CTR-041, CTR-027
tags:
  - containers
  - docker
  - internals
...
nav_order: 33
permalink: /technical-mastery/containers/containerd/
---
...
containerd image pull fails (registry unreachable):
  ...
  → fix: check network policy, registry credentials
    (imagePullSecret)
```
