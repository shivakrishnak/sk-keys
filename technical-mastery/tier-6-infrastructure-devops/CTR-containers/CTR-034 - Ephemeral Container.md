...
difficulty: ★★★
depends_on: CTR-024, CTR-025, K8S-001, CTR-018
used_by: CTR-035, K8S-001
related: CTR-038, CTR-039, K8S-001, CTR-036, CTR-035
tags:
  - containers
  - kubernetes
  - debugging
...
nav_order: 34
permalink: /technical-mastery/containers/ephemeral-container/
---
...
Production pod running (distroless Java app)
  ↓
Developer: kubectl debug -it <pod>
  --image=eclipse-temurin:21-jdk
                         --target=myapp
  ↓
...
│              │ or need a permanent companion (use sideca│
├──────────────┼──────────────────────────────────────────┤
│ TRADE-OFF    │ Live-state debugging vs no resource limit│
