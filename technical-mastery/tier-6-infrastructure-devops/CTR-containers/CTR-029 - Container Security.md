...
difficulty: ★★★
depends_on: CTR-018, CTR-010, CTR-025, CTR-024, CTR-026
used_by: CTR-019, CTR-036, CTR-046, CTR-027
related: CTR-018, CTR-010, CTR-019, CTR-036, CTR-028
tags:
  - containers
  - security
  - docker
...
nav_order: 29
permalink: /technical-mastery/containers/container-security/
---
...
**FAILURE PATH:**
```
Application tries to bind port 80 as non-root (common
  mistake)
→ "Permission denied: bind: EACCES" (NET_BIND_SERVICE not
  granted)
→ fix: docker run --cap-add=NET_BIND_SERVICE
→ or better: run on port 3000 and use load balancer to
  expose 80
```
