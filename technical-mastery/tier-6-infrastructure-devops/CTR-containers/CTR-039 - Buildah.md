...
difficulty: ★★★
depends_on: CTR-025, CTR-007, CTR-020, CTR-041, CTR-018
used_by: CTR-019
related: CTR-041, CTR-040, CTR-014, CTR-020, CTR-035
tags:
  - containers
  - build
  - security
...
nav_order: 39
permalink: /technical-mastery/containers/buildah/
---
...
CI pipeline (non-root user)
  → git checkout
  → buildah bud -f Dockerfile -t myapp:main-sha . ← YOU
    ARE HERE
