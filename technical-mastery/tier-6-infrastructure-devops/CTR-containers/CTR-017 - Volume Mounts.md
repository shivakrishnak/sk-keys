...
difficulty: ★★☆
depends_on: CTR-024, CTR-025, CTR-018, CTR-007
used_by: CTR-015, CTR-035, CTR-017, CTR-030
related: CTR-015, CTR-035, CTR-030, CTR-037, CTR-025
tags:
  - containers
  - docker
  - devops
...
nav_order: 17
permalink: /technical-mastery/containers/volume-mounts/
---
...
→ observable: data inconsistency, Postgres cluster ID
  mismatch
...
```bash
# Create named volume explicitly (optional - docker creates it on
# first use)
...
│              │ persistent. Stateful data lives in volume│
├──────────────┼──────────────────────────────────────────┤
