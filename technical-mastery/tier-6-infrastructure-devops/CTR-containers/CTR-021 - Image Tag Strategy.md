...
difficulty: ★★☆
depends_on: CTR-006, CTR-025, CTR-016, CTR-020
used_by: CTR-019, CTR-027
related: CTR-016, CTR-020, CTR-019
tags:
  - containers
  - docker
  - devops
...
nav_order: 21
permalink: /technical-mastery/containers/image-tag-strategy/
---
...
# GitLab Registry: uses digest references by default in K8s
# integration
...
# Also update 'latest' for developer convenience (never for prod
# deployments)
...
# BEST - digest reference: impossible to be tricked by tag
# reassignment
