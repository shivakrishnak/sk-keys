...
difficulty: ★★☆
depends_on: CTR-024, CTR-010, CTR-018, CTR-025, K8S-001
used_by: K8S-001, CTR-017
related: CTR-010, CTR-027, CTR-017
tags:
  - containers
  - kubernetes
  - performance
...
nav_order: 19
permalink: /technical-mastery/containers/container-resource-limits/
---
...
**NORMAL FLOW:**
```
kubectl apply deployment.yaml (requests: 250m/256Mi,
  limits: 500m/512Mi)
  → scheduler: finds node with 250m CPU + 256Mi RAM
    allocatable
  → kubelet: creates cgroup with cpu.max 500m, memory.max
    512Mi
  → containerd: starts container in that cgroup ← YOU ARE
    HERE
