...
difficulty: ★★★
depends_on: CTR-006, CTR-009, CTR-024, CTR-025
used_by: CTR-021, CTR-046, CTR-019
related: CTR-025, CTR-021, CTR-046, CTR-019, CTR-041
tags:
  - containers
  - docker
  - internals
...
nav_order: 32
permalink: /technical-mastery/containers/oci-standard/
---
...
```
OCI Image
├── manifest.json          (index of all parts, with
  digests)
├── config.json            (metadata: entrypoint, env,
  labels)
└── layers/
