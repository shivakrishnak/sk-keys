...
difficulty: ★★★
depends_on: CTR-018, CTR-024, OSY-001, LNX-001
used_by: CTR-024, CTR-025, CTR-028, CTR-035, CTR-021
related: CTR-018, CTR-028, CTR-024, CTR-035, CTR-017
tags:
  - containers
  - linux
  - internals
...
nav_order: 27
permalink: /technical-mastery/containers/cgroups/
---
...
→ observable: OOMKilled exit code + docker inspect
  OOMKilled=true
```
...
cat /sys/fs/cgroup/memory/docker/$(
    docker inspect -f '{{.Id}}' my-app)/memory.limit_in_bytes
```
...
CGROUP=$(cat /proc/$(
    docker inspect -f '{{.State.Pid}}' my-app)/cgroup \
