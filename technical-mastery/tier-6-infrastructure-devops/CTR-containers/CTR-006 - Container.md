...
difficulty: ★☆☆
depends_on: CTR-018, OSY-001
used_by: CTR-025, CTR-006, CTR-027, K8S-001
related: CTR-025, CTR-008, CTR-018, CTR-010, CTR-046
tags:
  - containers
  - docker
  - linux
...
nav_order: 6
permalink: /technical-mastery/containers/container/
---
...
OverlayFS layering:
  ...
  App layer (conf + html)         ├──► Merged view
    (container
...
cat /sys/fs/cgroup/memory/docker/$(
    docker inspect -f '{{.Id}}' my-nginx)/memory.limit_in_bytes
