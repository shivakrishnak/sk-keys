...
difficulty: ★★★
depends_on: CTR-024, CTR-025, CTR-018, CTR-010, CTR-020
used_by: CTR-022, CTR-035, CTR-027
related: CTR-025, CTR-021, CTR-022, CTR-040, CTR-035
tags:
  - containers
  - docker
  - security
...
nav_order: 38
permalink: /technical-mastery/containers/podman/
---
...
Developer: podman run -d nginx ← YOU ARE HERE
  ...
  → container starts as unprivileged process (UID 100000
    on host)
...
Rootless limitation: requires port < 1024
  ...
  → Error: permission denied (port 80 requires root on IP
    stack)
