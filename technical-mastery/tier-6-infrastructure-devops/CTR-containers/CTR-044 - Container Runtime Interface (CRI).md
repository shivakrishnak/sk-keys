...
difficulty: ★★★
depends_on: CTR-024, CTR-021, K8S-001, CTR-020, CTR-025
used_by: K8S-001
related: CTR-021, K8S-001, CTR-020, CTR-027
tags:
  - containers
  - kubernetes
  - internals
...
nav_order: 44
permalink: /technical-mastery/containers/container-runtime-interface-cri/
---
...
CRI socket unavailable (containerd crash):
  ...
  → existing containers: shim keeps them running (shim
    model)
