...
difficulty: ★★★
depends_on: CTR-024, K8S-001, CTR-034, CTR-018
used_by: CTR-030
related: CTR-038, CTR-037
tags:
  - containers
  - kubernetes
  - pattern
...
nav_order: 36
permalink: /technical-mastery/containers/sidecar-container/
---
...
Client sends HTTP request to Service A
  ...
  → Envoy sidecar (inbound): mTLS termination ← YOU ARE
    HERE
...
│ SOLVES       │ tracing) scattered across 30 app codebase│
├──────────────┼──────────────────────────────────────────┤
...
│              │ changes vs CPU/memory overhead + debuggin│
│              │ complexity                               │
├──────────────┼──────────────────────────────────────────┤
