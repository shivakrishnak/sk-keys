...
nav_order: 8
permalink: /technical-mastery/code-quality/style-guide/
id: CDQ-008
...
Rationale: Wider lines reduce the ability to view diffs 
           side-by-side on standard displays. 100
             characters
           allows two files on a 24" monitor at 14pt font.
Exception: Lines that cannot be split (long URLs in
  comments,
...
public UserProfileResponseDto
  getUserProfileByUserIdAndTenantContextAndIncludeArchivedF
