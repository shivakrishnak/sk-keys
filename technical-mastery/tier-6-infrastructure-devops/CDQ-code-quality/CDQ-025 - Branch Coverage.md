...
nav_order: 25
permalink: /technical-mastery/code-quality/branch-coverage/
id: CDQ-029
...
├──────────────┼──────────────────────────────────────────┤
│ USE WHEN     │ All projects; especially conditional-heav│
│              │ business logic (discount, auth, validatio│
├──────────────┼──────────────────────────────────────────┤
│ AVOID WHEN   │ Never skip; but 100% branch coverage on  │
│              │ defensive guards may not justify cost    │
├──────────────┼──────────────────────────────────────────┤
│ TRADE-OFF    │ Catches untested conditionals vs. require│
