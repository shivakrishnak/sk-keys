...
nav_order: 35
has_children: true
permalink: /technical-mastery/code-quality/
---
...
|----|---------|------------|
| CDQ-001 | What Is Code Quality and Why It Matters | ★☆☆ |
| CDQ-002 | The Code Quality Landscape -- A Map | ★☆☆ |
| CDQ-003 | Technical Debt -- A Mental Model | ★☆☆ |
| CDQ-004 | Code Quality vs Velocity Trade-off | ★☆☆ |
| CDQ-005 | The Code Quality Ecosystem Map (SonarQube, Checkstyle) | ★☆☆ |
| CDQ-006 | Code Standards | ★☆☆ |
