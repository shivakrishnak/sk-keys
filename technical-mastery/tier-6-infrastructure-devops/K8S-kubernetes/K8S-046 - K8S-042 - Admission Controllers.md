...
nav_order: 46
permalink: /technical-mastery/kubernetes/admission-controllers/
id: K8S-046
category: "Kubernetes"
difficulty: "★★★"
  ...
  - name: inject-sidecar.example.com
    ...
    clientConfig:
      service:
        ...
        path: /inject
      caBundle: <base64-CA>
      # API Server uses this to verify webhook TLS
    rules:
      - apiGroups: [""]
        apiVersions: ["v1"]
        resources: ["pods"]
...
```go
func (h *SidecarHandler) Handle(ctx context.Context,
    ...
    return admission.PatchResponseFromRaw(req.Object.Raw,
        marshaledPod)
}
```
...
kubectl apply -f pod.yaml
  ...
  → Mutating admission:
      → Send AdmissionReview to
        MutatingWebhookConfiguration services
