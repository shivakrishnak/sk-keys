...
nav_order: 30
permalink: /technical-mastery/kubernetes/readiness-vs-liveness-vs-startup-probe/
id: K8S-030
category: "Kubernetes"
difficulty: "★★☆"
...
Container starts:
  ...
  │
  ├─ livenessProbe begins (after startup or
    initialDelaySeconds)
  │   └─ failureThreshold consecutive failures → restart
    container
  │
  └─ readinessProbe begins (after startup or
    initialDelaySeconds)
...
4. Rolling update PAUSED (maxSurge reached, no new Pods
  until current Ready)
