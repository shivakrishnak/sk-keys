...
nav_order: 56
permalink: /technical-mastery/kubernetes/gitops-with-kubernetes/
id: K8S-056
category: "Kubernetes"
difficulty: "★★★"
...
ArgoCD/FluxCD (GitOps operator):
  Every 3 minutes:
    ...
    3. Cluster has replicas: 2 (drift!) → apply
      deployment.yaml
...
CI pipeline cannot directly modify cluster (no kubeconfig
  in CI).
```
