...
nav_order: 12
permalink: /technical-mastery/kubernetes/deployment/
id: K8S-012
category: "Kubernetes"
difficulty: "★★☆"
...
```
CI pushes new image → kubectl set image deployment/my-app
  app=my-app:1.1
  → Deployment creates ReplicaSet rs-v2
  → rs-v2 starts 1 new Pod (maxSurge=1)
  → New Pod passes readinessProbe
  → rs-v1 terminates 1 old Pod (maxUnavailable=0: only
    after new is ready)
