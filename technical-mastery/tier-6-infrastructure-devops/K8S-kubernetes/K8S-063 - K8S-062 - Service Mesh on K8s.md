...
nav_order: 63
permalink: /technical-mastery/kubernetes/service-mesh-on-k8s/
id: K8S-063
category: "Kubernetes"
difficulty: "★★★"
...
With service mesh (Istio):
  1. mTLS: all service-to-service calls automatically
...
Control Plane (istiod):
  - Pilot: service discovery,
    VirtualService/DestinationRule distribution
  - Citadel: certificate management (SVID issuance,
    rotation)
...
Result: Pod A app ↔ Pod B app via automatic mTLS, no code
  changes
```
