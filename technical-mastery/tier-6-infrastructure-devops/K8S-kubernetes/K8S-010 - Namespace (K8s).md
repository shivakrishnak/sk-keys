...
nav_order: 10
permalink: /technical-mastery/kubernetes/namespace-k8s/
id: K8S-010
category: "Kubernetes"
difficulty: "★☆☆"
...
Service "api" in namespace "team-alpha":
  ...
  From other namespace:
    api.team-alpha.svc.cluster.local
...
Alice: kubectl get pods -n team-beta   ❌ denied (no
  RoleBinding there)
Alice: kubectl get nodes               ❌ denied
