...
nav_order: 23
permalink: /technical-mastery/kubernetes/persistentvolume-pvc/
id: K8S-023
category: "Kubernetes"
difficulty: "★★☆"
...
PVC created with storageClassName=fast-ssd
  ...
  → CSI driver: AWS API CreateVolume (gp3, 20Gi,
    us-east-1a)
...
kubectl describe pvc db-storage
# Look for: "no persistent volumes available" or "no matching
# StorageClass"
