...
|----|---------|------------|
| LLM-001 | What Is a Large Language Model | ★☆☆ |
| LLM-002 | The LLM Mental Model (Next Token Prediction) | ★☆☆ |
| LLM-003 | LLMs vs Traditional NLP -- What Changed | ★☆☆ |
| LLM-004 | The LLM Ecosystem Map (GPT, Claude, Gemini, Llama) | ★☆☆ |
| LLM-005 | LLMs in Production -- What Engineers Face | ★☆☆ |
| LLM-006 | Prompt Engineering Basics | ★☆☆ |
| LLM-007 | Zero-Shot, One-Shot, Few-Shot Prompting | ★☆☆ |
| LLM-008 | Temperature and Sampling Parameters | ★☆☆ |
| LLM-009 | System Prompts and Personas | ★☆☆ |
