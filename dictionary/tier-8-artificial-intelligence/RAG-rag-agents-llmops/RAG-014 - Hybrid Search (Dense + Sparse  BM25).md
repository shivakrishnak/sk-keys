...
- `RAG-015 - Re-ranking in RAG` — the post-retrieval refinement step applied after hybrid search
- `RAG-016 - Metadata Filtering` — adding structured filters to hybrid search

**Alternatives / Comparisons:**

- `RAG-018 - Query Transformation` — alternative approach to improving retrieval recall
...
+--------------------------------------------------+
| NEXT EXPLORE  | RAG-015, RAG-016, RAG-018        |
+--------------------------------------------------+
```
