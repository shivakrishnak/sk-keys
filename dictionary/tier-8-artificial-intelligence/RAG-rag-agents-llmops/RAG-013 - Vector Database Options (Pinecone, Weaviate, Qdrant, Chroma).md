...
- `RAG-014 - Hybrid Search` — combining dense and sparse search within a vector DB
- `RAG-016 - Metadata Filtering` — filtering strategies within vector DB queries

**Alternatives / Comparisons:**

- `RAG-043 - Production RAG Architecture` — how vector DB choice fits into overall system design
...
+--------------------------------------------------+
| NEXT EXPLORE  | RAG-014, RAG-016, RAG-043        |
+--------------------------------------------------+
```
