...
- `RAG-015 - Re-ranking` — post-retrieval precision improvement (complementary technique)
- `RAG-023 - Advanced Retrieval Techniques` — contextual compression and parent-child retrieval

**Alternatives / Comparisons:**

- `RAG-016 - Metadata Filtering` — precision improvement via structure vs vocabulary transformation
...
**Q3 (Design Trade-off):** You have a RAG system with low recall (0.62 context_recall). You must choose one improvement: (A) add multi-query transformation or (B) add re-ranking (RAG-015). Based on what each technique optimises for, which is the correct fix for low recall?
