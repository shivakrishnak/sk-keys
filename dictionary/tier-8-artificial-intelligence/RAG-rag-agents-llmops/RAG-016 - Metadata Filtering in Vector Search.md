...
nav_order: 16
permalink: /rag/metadata-filtering-in-vector-search/
---
...
- `RAG-013 - Vector Database Options` — each DB has different filter capabilities
- `RAG-014 - Hybrid Search` — combining metadata filters with hybrid search

**Alternatives / Comparisons:**

- `RAG-015 - Re-ranking` — relevance-based precision improvement vs structure-based filtering
...
+--------------------------------------------------+
| NEXT EXPLORE  | RAG-013, RAG-014, RAG-015        |
+--------------------------------------------------+
```
