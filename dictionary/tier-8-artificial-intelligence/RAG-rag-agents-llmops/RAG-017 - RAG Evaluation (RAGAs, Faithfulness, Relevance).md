...
Test sample: {question, context, answer, [ground_truth]}
    ...
    (LLM checks            (LLM checks           (LLM generates
    claim support)         chunk utility)         question back)
            |
            v
...
- `RAG-029 - RAG Testing and Quality Gates` — integrating RAGAs into CI/CD
- `RAG-005 - LLMOps` — production monitoring and drift detection

**Alternatives / Comparisons:**

- `RAG-029 - Advanced RAG Evaluation` — ARES, TruLens, component testing
