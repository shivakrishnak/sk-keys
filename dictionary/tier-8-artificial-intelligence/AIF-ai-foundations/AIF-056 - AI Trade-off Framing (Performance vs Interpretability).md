...
nav_order: 56
permalink: /aif/ai-trade-off-framing-performance-vs-interpretability/
---

# AIF-056 - AI Trade-off Framing (Performance vs Interpretability)
...
Scorecard models              Black-box AutoML models
  ...
  (LIME, SHAP as approximation)   (LIME, SHAP, Attention maps)
```
