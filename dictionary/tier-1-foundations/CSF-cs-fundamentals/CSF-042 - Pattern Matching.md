...
| CSF-042         | Category: CS Fundamentals - Paradigms | Difficulty: ★★★ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-015, CSF-040, CSF-045             |                 |
| **Used by:**    | CSF-045, CSF-046, CSF-047             |                 |
| **Related:**    | CSF-015, CSF-040, CSF-045, CSF-046    |                 |
...
│ NEXT EXPLORE    CSF-045, CSF-046, Java sealed classes  │
└─────────────────────────────────────────────────────┘
```
