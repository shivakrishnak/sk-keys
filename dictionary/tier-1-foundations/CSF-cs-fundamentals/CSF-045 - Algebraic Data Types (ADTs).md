...
| CSF-045         | Category: CS Fundamentals - Paradigms | Difficulty: ★★★ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-026, CSF-041, CSF-042             |                 |
| **Used by:**    | CSF-046, CSF-047, CSF-079, CSF-080    |                 |
| **Related:**    | CSF-041, CSF-042, CSF-046, CSF-037    |                 |
...
matching (CSF-042) is the canonical way to consume sum types.
...
│ NEXT EXPLORE    CSF-046, CSF-042, sealed classes       │
└─────────────────────────────────────────────────────┘
```
