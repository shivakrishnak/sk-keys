...
| CSF-071         | Category: CS Fundamentals - Paradigms       | Difficulty: ★★★ |
| :-------------- | :------------------------------------------ | :-------------- |
| **Depends on:** | CSF-054, CSF-070                            |                 |
| **Used by:**    | CSF-068, CSF-074                            |                 |
| **Related:**    | CSF-054, CSF-070, CSF-068, CSF-074, CSF-081 |                 |
...
│ NEXT EXPLORE    CSF-071, CSF-081, ADR template          │
└─────────────────────────────────────────────────────┘
```
