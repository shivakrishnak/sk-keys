...
# CSF-051 - Structural vs Nominal Typing
...
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-026, CSF-040, CSF-050             |                 |
| **Used by:**    | CSF-073, CSF-080                      |                 |
| **Related:**    | CSF-026, CSF-040, CSF-050, CSF-073    |                 |
...
- [[CSF-040 - Interfaces vs Abstract Classes]]

**Builds On This (learn these next):**

- [[CSF-073 - Type System Design for Large Codebases]]
...
│ NEXT EXPLORE    CSF-073, TypeScript branded types      │
└─────────────────────────────────────────────────────┘
```
