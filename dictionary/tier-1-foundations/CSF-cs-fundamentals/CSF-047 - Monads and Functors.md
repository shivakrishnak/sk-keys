...
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-004, CSF-039, CSF-046             |                 |
| **Used by:**    | CSF-048, CSF-074, CSF-075             |                 |
| **Related:**    | CSF-004, CSF-046, CSF-048, CSF-074    |                 |
...
│ NEXT EXPLORE    CSF-048, CSF-074, Haskell do-notation  │
└─────────────────────────────────────────────────────┘
```
