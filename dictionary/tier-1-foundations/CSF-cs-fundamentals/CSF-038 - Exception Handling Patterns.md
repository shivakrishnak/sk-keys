...
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-017, CSF-015, CSF-016             |                 |
| **Used by:**    | CSF-052, CSF-061                      |                 |
| **Related:**    | CSF-017, CSF-037, CSF-048, CSF-052    |                 |
...
- Result types (CSF-017/Rust) — error as a value vs exception
...
│ NEXT EXPLORE    CSF-017, Spring @ControllerAdvice      │
└─────────────────────────────────────────────────────┘
```
