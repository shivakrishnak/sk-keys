...
| CSF-016         | Category: CS Fundamentals - Paradigms       | Difficulty: ★☆☆ |
| :-------------- | :------------------------------------------ | :-------------- |
| **Depends on:** | CSF-006, CSF-014, CSF-015                   |                 |
| **Used by:**    | CSF-019, CSF-030, CSF-031, CSF-032, CSF-035 |                 |
| **Related:**    | CSF-030, CSF-031, CSF-032, CSF-033, CSF-035 |                 |
...
- [[CSF-032 - Higher-Order Functions]]
- [[CSF-035 - Closures]]
...
│                 for pieces of logic                   │
│ NEXT EXPLORE    CSF-030, CSF-031, CSF-032, CSF-033     │
└─────────────────────────────────────────────────────┘
```
