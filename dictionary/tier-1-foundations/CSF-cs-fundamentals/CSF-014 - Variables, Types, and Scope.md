...
| CSF-014         | Category: CS Fundamentals - Paradigms | Difficulty: ★☆☆ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-006, CSF-026, CSF-010             |                 |
| **Used by:**    | CSF-018, CSF-019, CSF-035, CSF-050    |                 |
| **Related:**    | CSF-026, CSF-010, CSF-018, CSF-035    |                 |
...
│ NEXT EXPLORE    CSF-035, CSF-036, CSF-037, CSF-050     │
└─────────────────────────────────────────────────────┘
```
