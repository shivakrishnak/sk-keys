...
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-036, CSF-043, CSF-064             |                 |
| **Used by:**    | CSF-064                               |                 |
| **Related:**    | CSF-036, CSF-043, CSF-064             |                 |
...
| "ThreadLocal prevents all races"               | ThreadLocal prevents sharing, but leaks in thread pools (see CSF-048)           |
...
│ NEXT EXPLORE    CSF-064, ThreadSanitizer, Akka         │
└─────────────────────────────────────────────────────┘
```
