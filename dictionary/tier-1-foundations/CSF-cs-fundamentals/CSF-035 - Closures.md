...
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-014, CSF-016, CSF-031             |                 |
| **Used by:**    | CSF-032, CSF-036, CSF-047             |                 |
| **Related:**    | CSF-031, CSF-032, CSF-047, CSF-007    |                 |
...
- Currying (CSF-033) — uses closures to partially apply arguments
...
│                 birthplace                          │
│ NEXT EXPLORE    CSF-032, CSF-047, CSF-033            │
└─────────────────────────────────────────────────────┘
```
