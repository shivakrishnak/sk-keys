...
| CSF-047         | Category: CS Fundamentals - Paradigms | Difficulty: ★★★ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-004, CSF-031, CSF-035, CSF-046    |                 |
| **Used by:**    | CSF-079, CSF-080                      |                 |
| **Related:**    | CSF-035, CSF-046, CSF-064, CSF-075    |                 |
...
- Monadic bind (CSF-046) as structured CPS
...
│                 class value                          │
│ NEXT EXPLORE    CSF-046, CSF-079, coroutines           │
└─────────────────────────────────────────────────────┘
```
