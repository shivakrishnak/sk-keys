...
| CSF-041         | Category: CS Fundamentals - Paradigms | Difficulty: ★★★ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-026, CSF-040, CSF-014             |                 |
| **Used by:**    | CSF-045, CSF-046, CSF-050             |                 |
| **Related:**    | CSF-040, CSF-045, CSF-050, CSF-051    |                 |
...
│ NEXT EXPLORE    CSF-045, CSF-050, PECS rule           │
└─────────────────────────────────────────────────────┘
```
