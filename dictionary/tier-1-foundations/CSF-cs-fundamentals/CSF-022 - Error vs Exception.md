...
| CSF-022         | Category: CS Fundamentals - Paradigms | Difficulty: ★☆☆ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-021, CSF-020                      |                 |
| **Used by:**    | CSF-036, CSF-049, CSF-053             |                 |
| **Related:**    | CSF-036, CSF-031, CSF-049             |                 |
...
│                 it and continue                       │
│ NEXT EXPLORE    CSF-036, CSF-047, Rust Result type     │
└─────────────────────────────────────────────────────┘
```
