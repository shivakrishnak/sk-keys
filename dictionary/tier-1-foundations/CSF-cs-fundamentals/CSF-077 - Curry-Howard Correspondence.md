...
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-075, CSF-076                      |                 |
| **Used by:**    | CSF-078, CSF-080                      |                 |
| **Related:**    | CSF-075, CSF-076, CSF-078, CSF-080    |                 |
...
- [[CSF-075 - Church-Turing Thesis]]
- [[CSF-076 - Lambda Calculus]]
...
| NEXT EXPLORE    CSF-080, Agda, Coq, Lean             |
+-----------------------------------------------------+
```
