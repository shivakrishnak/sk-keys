...
# CSF-081 - Language Design Rationale (Rust, Go, Kotlin)
...
| CSF-081         | Category: CS Fundamentals - Paradigms       | Difficulty: ★★★ |
| :-------------- | :------------------------------------------ | :-------------- |
| **Depends on:** | CSF-065, CSF-071, CSF-080                   |                 |
| **Used by:**    | CSF-083, CSF-084                            |                 |
| **Related:**    | CSF-065, CSF-071, CSF-074, CSF-083, CSF-084 |                 |
...
Frontend/Node.js/browser?
  ...
  |
None of the above:
  |-> Apply CSF-071 Language Evaluation Framework
```
...
- [[CSF-080 - Type Theory (System F, HM Inference)]]

**Builds On This (learn these next):**

- [[CSF-083 - Trade-off Framing (Any Language Choice)]]
- [[CSF-084 - First-Principles Language Selection]]
...
|                 Kotlin=Java+modern                  |
| NEXT EXPLORE    CSF-083, CSF-084, ADR template      |
+-----------------------------------------------------+
```
