...
| CSF-057         | Category: CS Fundamentals - Paradigms | Difficulty: ★★★ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-023, CSF-035, CSF-050             |                 |
| **Used by:**    | CSF-061                               |                 |
| **Related:**    | CSF-023, CSF-035, CSF-061             |                 |
...
│                 it at compile time                 │
│ NEXT EXPLORE    CSF-061, Rust ownership, ASan       │
└─────────────────────────────────────────────────────┘
```
