...
| CSF-015         | Category: CS Fundamentals - Paradigms | Difficulty: ★☆☆ |
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-006, CSF-014                      |                 |
| **Used by:**    | CSF-016, CSF-030, CSF-038, CSF-042    |                 |
| **Related:**    | CSF-016, CSF-030, CSF-038, CSF-042    |                 |
...
- [[CSF-042 - Pattern Matching]]

**Alternatives / Comparisons:**

- Recursive control flow (CSF-030) — no explicit loops
- Monadic control flow (CSF-046) — effects sequenced via bind
...
│ NEXT EXPLORE    CSF-030, CSF-038, CSF-042, CSF-043    │
└─────────────────────────────────────────────────────┘
```
