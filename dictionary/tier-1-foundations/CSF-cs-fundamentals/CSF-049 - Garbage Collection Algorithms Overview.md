...
| :-------------- | :------------------------------------ | :-------------- |
| **Depends on:** | CSF-018, CSF-027                      |                 |
| **Used by:**    | CSF-048, CSF-063                      |                 |
| **Related:**    | CSF-018, CSF-048, CSF-063             |                 |
...
# Solution: heap dump + leak analysis (see CSF-048)
```
...
│ NEXT EXPLORE    CSF-063, ZGC, JFR GC analysis         │
└─────────────────────────────────────────────────────┘
```
