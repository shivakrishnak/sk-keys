...
difficulty: ★★☆
depends_on: CSF-016, CSF-017, DSA-015, DSA-022
used_by: DSA-024, DSA-026, DSA-040
related: DSA-020, DSA-046, DSA-063
tags:
  - algorithm
  - foundational
  - mental-model
...
# DSA-045 - Recursion vs Iteration Trade-offs
...
| Metadata | Value |
|---|---|
| **Depends on** | [[CSF-016 - Recursion]], [[CSF-017 - Tail Recursion]], [[DSA-015 - Time Complexity Big-O]], [[DSA-022 - Memoization]] |
| **Used by** | [[DSA-024 - Divide and Conquer]], [[DSA-026 - Dynamic Programming]], [[DSA-040 - Backtracking]] |
| **Related** | [[DSA-020 - Space Complexity]], [[DSA-046 - Space-Time Trade-off]], [[DSA-063 - In-Place vs Out-of-Place]] |
...
```
**Fix:** Add memoization (top-down DP) or convert to iterative tabulation (bottom-up DP). See [[DSA-022 - Memoization]] and [[DSA-023 - Tabulation (Bottom-Up DP)]].
...
- [[CSF-016 - Recursion]] - base concept: what recursion is and how it terminates
- [[CSF-017 - Tail Recursion]] - the subset of recursion that can be optimised away
- [[DSA-015 - Time Complexity Big-O]] - the framework for comparing both approaches

**Builds On This (learn these next):**
- [[DSA-024 - Divide and Conquer]] - the primary production use case for recursion
- [[DSA-026 - Dynamic Programming]] - recursion + memoization unified
- [[DSA-040 - Backtracking]] - recursion exploring a combinatorial decision tree

**Alternatives / Comparisons:**
- [[DSA-020 - Space Complexity]] - the axis on which iteration usually wins
- [[DSA-046 - Space-Time Trade-off]] - generalises this comparison
- [[DSA-022 - Memoization]] - bridges recursive expressiveness with iterative efficiency
...
├──────────────────────────────────────────────────┤
│ NEXT EXPLORE  │ DSA-024 Divide and Conquer       │
│               │ DSA-026 Dynamic Programming      │
└──────────────────────────────────────────────────┘
```
