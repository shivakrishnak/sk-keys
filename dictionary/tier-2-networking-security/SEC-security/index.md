...
| SEC-016 | Security Misconfiguration | ★☆☆ |
| SEC-017 | Credentials and Secrets Management Basics | ★☆☆ |
| SEC-018 | Cross-Site Scripting (XSS) | ★★☆ |
...
| SEC-033 | OWASP Top 10 - Deep Dive Per Vulnerability | ★★☆ |
| SEC-034 | Command Injection | ★★☆ |
| SEC-035 | Path Traversal | ★★☆ |
...
| SEC-058 | SSRF at Scale - Cloud Metadata Exploitation | ★★★ |
| SEC-059 | DDoS Attack Patterns and Defense | ★★★ |
| SEC-060 | Security Architecture Design Patterns | ★★★ |
| SEC-061 | DevSecOps Strategy and Pipeline Security | ★★★ |
| SEC-062 | Zero Trust Architecture Design | ★★★ |
| SEC-063 | Compliance-Driven Security (GDPR, SOC2, PCI-DSS) | ★★★ |
| SEC-064 | Cryptographic Primitive Design | ★★★ |
| SEC-065 | Security Protocol Formal Analysis | ★★★ |
| SEC-066 | Formal Verification of Security Properties | ★★★ |
| SEC-067 | SAST and DAST Pipeline Design and Automation | ★★★ |
| SEC-068 | Adversarial Thinking as Engineering Mindset | ★★★ |
| SEC-069 | Security Trade-off Framing | ★★★ |
| SEC-070 | Threat Modeling as First-Principles Tool | ★★★ |
