...
difficulty: ★★★
depends_on: JCC-028, JCC-025, JCC-046
used_by: JCC-048, JCC-050
related: JCC-028, JCC-046, JCC-050
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 47
permalink: /jcc/virtual-thread-migration-strategy-loom/
---
...
| Metadata        |                           |     |
| :-------------- | :------------------------ | :-- |
| **Depends on:** | JCC-028, JCC-025, JCC-046 |     |
...
Start: Java 21+, want Virtual Threads
    ...
    |   Connection pool too small? -> starves  <- YOU ARE HERE
    |
    +- Step 3: Fix
...
- [[JCC-028 - Virtual Threads (Project Loom)]] - VT fundamentals before migration
- [[JCC-025 - ExecutorService]] - the service being replaced

**Builds On This (learn these next):**

- [[JCC-048 - Concurrent System Design at Scale]] - system design with VTs
- [[JCC-050 - Thread Model Selection Framework]] - when to use VTs vs. reactive

**Alternatives / Comparisons:**

- [[JCC-046 - Concurrency Architecture Patterns in Java]] - patterns context
- [[JCC-028 - Virtual Threads (Project Loom)]] - the underlying feature
