...
difficulty: ★★★
depends_on: JCC-013, JCC-020, JCC-025, JCC-028, JCC-036
used_by: JCC-048, JCC-050
related: JCC-045, JCC-048, JCC-050
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 46
permalink: /jcc/concurrency-architecture-patterns-in-java/
---
...
| Metadata        |                                             |     |
| :-------------- | :------------------------------------------ | :-- |
| **Depends on:** | JCC-013, JCC-020, JCC-025, JCC-028, JCC-036 |     |
| **Used by:**    | JCC-048, JCC-050                            |     |
| **Related:**    | JCC-045, JCC-048, JCC-050                   |     |
...
BlockingQueue<ProcessedData> stage2Out = new LinkedBlockingQueue<>(500);
...
# If one queue grows while others are stable, that stage is the bottleneck
```
...
- [[JCC-025 - ExecutorService]] - the Thread Pool pattern implementation
- [[JCC-035 - BlockingQueue]] - the Producer-Consumer queue
- [[JCC-028 - Virtual Threads (Project Loom)]] - enables Thread-Per-Task at scale

**Builds On This (learn these next):**

- [[JCC-048 - Concurrent System Design at Scale]] - applying patterns at distributed scale
- [[JCC-050 - Thread Model Selection Framework]] - systematic pattern selection

**Alternatives / Comparisons:**

- [[JCC-045 - Actor Model]] - message-passing alternative to shared-state patterns
...
│ NEXT EXPLORE  │ JCC-048 Scale, JCC-050 Selection    │
└────────────────────────────────────────────────────┘
```
