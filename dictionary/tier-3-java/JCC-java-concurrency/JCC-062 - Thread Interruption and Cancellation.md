...
difficulty: ★★☆
depends_on: JCC-006, JCC-015, JCC-029
used_by: JCC-043, JCC-066
related: JCC-016, JCC-044, JCC-058
tags:
  - java
  - concurrency
  - pattern
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-006 Thread (Java), JCC-015 Thread Lifecycle, JCC-029 ExecutorService |
| Used by    | JCC-043 Deadlock Detection (Java), JCC-066 Thread Pinning |
| Related    | JCC-016 ReentrantLock, JCC-044 Structured Concurrency, JCC-058 ScheduledExecutorService |
