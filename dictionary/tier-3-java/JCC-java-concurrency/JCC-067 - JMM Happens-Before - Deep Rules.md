...
difficulty: ★★★
depends_on: JCC-024, JCC-017, JCC-014
used_by: JCC-068, JCC-069
related: JCC-018, JCC-026, JCC-072
tags:
  - java
  - concurrency
  - internals
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-024 Java Memory Model (JMM), JCC-017 synchronized, JCC-014 CompletableFuture |
| Used by    | JCC-068 Lock-Free Data Structures, JCC-069 Memory Visibility Diagnostics |
| Related    | JCC-018 volatile, JCC-026 CAS (Compare-And-Swap), JCC-072 JSR 133 |
...
- [[JCC-024 - Java Memory Model (JMM)]] - the overall framework
  within which happens-before is defined
- [[JCC-018 - volatile]] - the primary declaration that creates HB
  edges for individual fields
- [[JCC-017 - synchronized]] - the monitor-based HB mechanism

**Builds On This (learn these next):**
- [[JCC-068 - Lock-Free Data Structures]] - apply HB knowledge to
...
- [[JCC-026 - CAS (Compare-And-Swap)]] - uses volatile semantics
  internally (provides HB)
- [[JCC-043 - VarHandle]] - fine-grained HB control with access
  modes
