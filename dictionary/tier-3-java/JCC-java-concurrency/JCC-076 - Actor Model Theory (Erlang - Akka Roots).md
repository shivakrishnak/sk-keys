...
difficulty: ★★★
depends_on: JCC-049, JCC-075, JCC-073
used_by:
related: JCC-074, JCC-059, JCC-035
tags:
  - java
  - concurrency
  - advanced
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-049 Actor Model, JCC-075 Reactive Streams Specification, JCC-073 Project Loom Design Rationale |
| Related    | JCC-074 Structured Concurrency Theory, JCC-059 CompletableFuture Composition, JCC-035 Semaphore |
...
- [[JCC-049 - Actor Model]] - the Java/Akka practical entry point
- [[JCC-075 - Reactive Streams Specification]] - how Reactive Streams
...
- [[JCC-074 - Structured Concurrency Theory]] - Java-native task
  tree model vs actor hierarchy
- [[JCC-059 - CompletableFuture Composition]] - simpler for small
