...
difficulty: ★★★
depends_on: JCC-032, JCC-033, JCC-013
used_by: JCC-069
related: JCC-034, JCC-044, JCC-062
tags:
  - java
  - concurrency
  - performance
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-032 Virtual Threads (Project Loom), JCC-033 Carrier Thread, JCC-013 Future |
| Used by    | JCC-069 Memory Visibility Diagnostics              |
| Related    | JCC-034 Continuation, JCC-044 Structured Concurrency, JCC-062 Thread Interruption |
...
- [[JCC-032 - Virtual Threads (Project Loom)]] - the feature that
  makes pinning relevant
- [[JCC-033 - Carrier Thread]] - the OS thread that virtual threads
  mount/unmount from
- [[JCC-034 - Continuation]] - the continuation that is blocked
  during pinning

**Builds On This (learn these next):**
- [[JCC-069 - Memory Visibility Diagnostics (jstack, JFR)]] - JFR
  tools used to detect pinning
- [[JCC-044 - Structured Concurrency]] - structured approach to
  virtual thread coordination

**Alternatives / Comparisons:**
- [[JCC-016 - ReentrantLock]] - the fix for `synchronized` pinning
- [[JCC-062 - Thread Interruption and Cancellation]] - cancellation
...
+--------------+------------------------------------+
| NEXT EXPLORE | JCC-069 Memory Visibility Diag,    |
