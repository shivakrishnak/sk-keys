...
difficulty: ★★★
depends_on: JCC-067, JCC-024, JCC-018
used_by: JCC-077
related: JCC-043, JCC-026, JCC-068
tags:
  - java
  - concurrency
  - internals
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-067 JMM Happens-Before Deep Rules, JCC-024 Java Memory Model, JCC-018 volatile |
| Used by    | JCC-077 Lock-Free Algorithm Theory                 |
| Related    | JCC-043 VarHandle, JCC-026 CAS (Compare-And-Swap), JCC-068 Lock-Free Data Structures |
...
- [[JCC-067 - JMM Happens-Before - Deep Rules]] - the main rules
  JSR 133 formalises
- [[JCC-024 - Java Memory Model (JMM)]] - the practical application
- [[JCC-018 - volatile]] - the primary declaration that maps to
  JSR 133 happens-before edges

**Builds On This (learn these next):**
- [[JCC-077 - Lock-Free Algorithm Theory (CAS Foundations)]] - proof
  techniques built on JSR 133 formal model
- [[JCC-043 - VarHandle]] - Java 9 extension to JSR 133 access modes
