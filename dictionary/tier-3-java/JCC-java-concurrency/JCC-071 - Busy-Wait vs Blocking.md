...
difficulty: ★★★
depends_on: JCC-065, JCC-070, JCC-016
used_by:
related: JCC-026, JCC-039, JCC-064
tags:
  - java
  - concurrency
  - performance
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-065 Amdahl's Law, JCC-070 False Sharing, JCC-016 ReentrantLock |
| Used by    | (foundational performance trade-off)               |
| Related    | JCC-026 CAS (Compare-And-Swap), JCC-039 BlockingQueue, JCC-064 Condition Interface |
...
- [[JCC-065 - Amdahl's Law]] - quantifies the CPU core cost of
  busy-wait as serial work unavailable to other tasks
- [[JCC-070 - False Sharing (Java Context)]] - busy-wait on shared
  variables causes false sharing
- [[JCC-016 - ReentrantLock]] - uses hybrid spin internally
...
- [[JCC-026 - CAS (Compare-And-Swap)]] - the update atomic in
  busy-wait retry loops
- [[JCC-039 - BlockingQueue]] - canonical Java blocking pattern
- [[JCC-064 - Condition Interface]] - blocking with selective wakeup
