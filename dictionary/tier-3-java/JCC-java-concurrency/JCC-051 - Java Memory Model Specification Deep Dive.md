...
difficulty: ★★★
depends_on: JCC-020, JCC-013, JCC-014
used_by:
related: JCC-020, JCC-039, JCC-022
tags:
  - java
  - concurrency
  - advanced
...
| Metadata        |                           |     |
| :-------------- | :------------------------ | :-- |
| **Depends on:** | JCC-020, JCC-013, JCC-014 |     |
| **Related:**    | JCC-020, JCC-039, JCC-022 |     |
...
- [[JCC-020 - Java Memory Model (JMM)]] - the foundational JMM entry
- [[JCC-013 - synchronized]] - implements JMM monitor rules
- [[JCC-014 - volatile]] - implements JMM volatile rules

**Builds On This (learn these next):**

- [[JCC-039 - VarHandle]] - fine-grained JMM access modes
- [[JCC-022 - CAS (Compare-And-Swap)]] - CAS semantics under the JMM

**Alternatives / Comparisons:**

- [[JCC-016 - ReentrantLock]] - lock semantics equivalent to monitor in JMM terms
...
│ NEXT EXPLORE  │ JCC-039 VarHandle                  │
└────────────────────────────────────────────────────┘
```
