...
difficulty: ★★★
depends_on: JCC-024, JCC-067, JCC-065
used_by: JCC-071
related: JCC-026, JCC-068, JCC-042
tags:
  - java
  - concurrency
  - performance
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-024 Java Memory Model (JMM), JCC-067 JMM Happens-Before, JCC-065 Amdahl's Law |
| Used by    | JCC-071 Busy-Wait vs Blocking                      |
| Related    | JCC-026 CAS (Compare-And-Swap), JCC-068 Lock-Free Data Structures, JCC-042 Atomic Classes |
...
- [[JCC-024 - Java Memory Model (JMM)]] - the memory model within
  which cache coherence operates
- [[JCC-067 - JMM Happens-Before - Deep Rules]] - volatile ordering
  that coexists with (but does not solve) false sharing
- [[JCC-065 - Amdahl's Law]] - false sharing is a hidden serial
  fraction that Amdahl's model does not reveal

**Builds On This (learn these next):**
- [[JCC-071 - Busy-Wait vs Blocking]] - busy-wait combined with
  false sharing is catastrophic for performance
- [[JCC-068 - Lock-Free Data Structures]] - `LongAdder`'s Striped64
  uses @Contended to solve false sharing at scale

**Alternatives / Comparisons:**
- [[JCC-042 - Atomic Classes]] - `AtomicLong` still false-shares
...
+--------------+------------------------------------+
| NEXT EXPLORE | JCC-071 Busy-Wait vs Blocking,     |
