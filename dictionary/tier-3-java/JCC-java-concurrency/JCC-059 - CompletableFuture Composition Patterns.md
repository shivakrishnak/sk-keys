...
difficulty: ★★☆
depends_on: JCC-014, JCC-029, JCC-058
used_by: JCC-063, JCC-066
related: JCC-009, JCC-013, JCC-060
tags:
  - java
  - concurrency
  - async
...
nav_order: 59
permalink: /java-concurrency/completablefuture-composition-patterns/
---
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-014 CompletableFuture, JCC-029 ExecutorService, JCC-058 ScheduledExecutorService |
| Used by    | JCC-063 CompletionService, JCC-066 Thread Pinning  |
| Related    | JCC-009 Future, JCC-013 Future, JCC-060 Parallel Streams |
...
- [[JCC-014 - CompletableFuture]] - base type; understand
  `supplyAsync` and `complete` before patterns
- [[JCC-029 - ExecutorService]] - where computations run
- [[JCC-009 - Future]] - the simpler blocking predecessor

**Builds On This (learn these next):**
- [[JCC-063 - CompletionService]] - batching many `Future` results
...
- [[JCC-060 - Parallel Streams]] - parallel data processing vs
...
+--------------+------------------------------------+
| NEXT EXPLORE | JCC-063 CompletionService,         |
|              | Reactor Mono/Flux                  |
+--------------------------------------------------+
```
