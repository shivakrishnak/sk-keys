...
difficulty: ★★☆
depends_on: JCC-031, JCC-060
used_by: JCC-065, JCC-068
related: JCC-030, JCC-059, JCC-062
tags:
  - java
  - concurrency
  - performance
...
| Field      | Value                                            |
|------------|--------------------------------------------------|
| Depends on | JCC-031 ForkJoinPool, JCC-060 Parallel Streams   |
| Used by    | JCC-065 Amdahl's Law, JCC-068 Lock-Free Data Structures |
| Related    | JCC-030 ThreadPoolExecutor, JCC-059 CompletableFuture Composition, JCC-062 Thread Interruption |
...
- [[JCC-031 - ForkJoinPool]] - the executor that runs fork-join tasks
- [[JCC-060 - Parallel Streams]] - the high-level API built on
  fork-join

**Builds On This (learn these next):**
- [[JCC-065 - Amdahl's Law]] - theoretical limits of this approach
- [[JCC-068 - Lock-Free Data Structures]] - merge step may require
  lock-free synchronisation

**Alternatives / Comparisons:**
- [[JCC-030 - ThreadPoolExecutor]] - simpler for independent,
  non-recursive tasks
- [[JCC-059 - CompletableFuture Composition Patterns]] - for async
...
+--------------+------------------------------------+
| NEXT EXPLORE | JCC-065 Amdahl's Law,              |
