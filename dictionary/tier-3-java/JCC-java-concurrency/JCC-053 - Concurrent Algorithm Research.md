...
difficulty: ★★★
depends_on: JCC-049, JCC-052, JCC-022, JCC-039
used_by:
related: JCC-049, JCC-052, JCC-022
tags:
  - java
  - concurrency
  - advanced
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | JCC-049, JCC-052, JCC-022, JCC-039 |     |
| **Related:**    | JCC-049, JCC-052, JCC-022          |     |
...
- [[JCC-049 - Lock-Free Algorithm Strategy]] - CAS loop and lock-free foundations
- [[JCC-052 - Lock-Free Data Structure Design]] - Treiber stack, ABA problem
- [[JCC-022 - CAS (Compare-And-Swap)]] - the fundamental primitive

**Builds On This (learn these next):**

- [[JCC-046 - Concurrency Architecture Patterns in Java]] - applying algorithms in system design

**Alternatives / Comparisons:**

- [[JCC-016 - ReentrantLock]] - AQS in action, the primary lock implementation
