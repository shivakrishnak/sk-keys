...
difficulty: ★★☆
depends_on: JCC-031, JCC-032
used_by: JCC-061, JCC-065
related: JCC-059, JCC-027, JCC-030
tags:
  - java
  - concurrency
  - performance
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-031 ForkJoinPool, JCC-032 Virtual Threads      |
| Used by    | JCC-061 Fork-Join Framework Pattern, JCC-065 Amdahl's Law |
| Related    | JCC-059 CompletableFuture Composition, JCC-027 Optimistic Locking, JCC-030 ThreadPoolExecutor |
...
- [[JCC-031 - ForkJoinPool]] - the underlying executor
- [[JLG-032 - Stream API]] - sequential streams before enabling
  parallel mode

**Builds On This (learn these next):**
- [[JCC-061 - Fork-Join Framework Pattern]] - explicit fork-join
  for heterogeneous tasks
- [[JCC-065 - Amdahl's Law]] - theoretical ceiling on speedup

**Alternatives / Comparisons:**
- [[JCC-059 - CompletableFuture Composition Patterns]] - for
  I/O-bound async chains, not bulk CPU-bound data
- [[JCC-030 - ThreadPoolExecutor]] - explicit pool for tasks with
...
+--------------+------------------------------------+
| NEXT EXPLORE | JCC-061 Fork-Join Pattern,         |
