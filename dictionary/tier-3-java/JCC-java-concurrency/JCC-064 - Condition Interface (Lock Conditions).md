...
difficulty: ★★☆
depends_on: JCC-016, JCC-013, JCC-015
used_by: JCC-068
related: JCC-017, JCC-035, JCC-039
tags:
  - java
  - concurrency
  - pattern
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JCC-016 ReentrantLock, JCC-013 Future, JCC-015 Thread Lifecycle |
| Used by    | JCC-068 Lock-Free Data Structures                  |
| Related    | JCC-017 synchronized, JCC-035 Semaphore (Java), JCC-039 BlockingQueue |
...
- [[JCC-016 - ReentrantLock]] - `Condition` is obtained from a Lock
- [[JCC-017 - synchronized]] - the simpler alternative (one condition)
- [[JCC-015 - Thread Lifecycle]] - WAITING state entered via `await()`

**Builds On This (learn these next):**
- [[JCC-068 - Lock-Free Data Structures]] - avoiding conditions
  entirely via CAS
- [[JCC-039 - BlockingQueue]] - `ArrayBlockingQueue` source implements
  this exact pattern

**Alternatives / Comparisons:**
- [[JCC-035 - Semaphore (Java)]] - counting semaphore for permit-
...
+--------------+------------------------------------+
| NEXT EXPLORE | JCC-039 BlockingQueue internals,   |
