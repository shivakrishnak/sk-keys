...
difficulty: ★★★
depends_on: JCC-004, JCC-025, JCC-028, JCC-046, JCC-048
used_by:
related: JCC-046, JCC-047, JCC-048
tags:
  - java
  - concurrency
  - advanced
...
nav_order: 50
permalink: /jcc/thread-model-selection-framework/
---
...
| Metadata        |                                             |     |
| :-------------- | :------------------------------------------ | :-- |
| **Depends on:** | JCC-004, JCC-025, JCC-028, JCC-046, JCC-048 |     |
| **Related:**    | JCC-046, JCC-047, JCC-048                   |     |
...
START: What is the dominant workload type?
    ...
    |   |           Check: synchronized pinning? (JCC-047)
    |   |
    |   +-- Java 21+ NOT available?
    |       |
    |       +-- Team knows reactive? Non-blocking libs available?
    |       |   YES -> Spring WebFlux / R2DBC / reactive HTTP
    |       |
...
- [[JCC-028 - Virtual Threads (Project Loom)]] - the Java 21 model
- [[JCC-046 - Concurrency Architecture Patterns in Java]] - patterns used in each model

**Builds On This (learn these next):**

- [[JCC-047 - Virtual Thread Migration Strategy (Loom)]] - how to migrate to the selected VT model

**Alternatives / Comparisons:**

- [[JCC-048 - Concurrent System Design at Scale]] - broader system design context
...
│ NEXT EXPLORE  │ JCC-047 VT Migration               │
└────────────────────────────────────────────────────┘
```
