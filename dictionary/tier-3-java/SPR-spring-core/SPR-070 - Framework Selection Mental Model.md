...
difficulty: ★★★
depends_on: SPR-001, SPR-003, SPR-004, SPR-068, SPR-069
used_by:
related: SPR-059, SPR-063, SPR-066
tags:
  - spring
  - java
  - advanced
...
| Field          | Value                                                                                                                                                                                                                                                             |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[SPR-001 - What Is Spring - History and Philosophy]], [[SPR-003 - Why Spring Boot Changed Java Development]], [[SPR-004 - Spring vs Jakarta EE vs Micronaut vs Quarkus]], [[SPR-068 - IoC-First Thinking]], [[SPR-069 - Spring Configuration Trade-off Framing]] |
| **Used by**    | -                                                                                                                                                                                                                                                                 |
| **Related**    | [[SPR-059 - Spring Architecture at Scale]], [[SPR-063 - Microservice Decomposition with Spring Cloud]], [[SPR-066 - Spring Native and GraalVM Integration]]                                                                                                       |
...
- [[SPR-066 - Spring Native and GraalVM Integration]] - when native image is selected
- [[SPR-059 - Spring Architecture at Scale]] - Spring at team/system scale
- [[SPR-063 - Microservice Decomposition with Spring Cloud]] - Spring in distributed systems
...
| NEXT EXPLORE  | SPR-066 (Native Image), SPR-059 (Scale)  |
+----------------------------------------------------------+
```
