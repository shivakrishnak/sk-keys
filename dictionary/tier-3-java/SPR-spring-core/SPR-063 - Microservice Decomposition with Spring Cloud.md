...
difficulty: ★★★
depends_on: SPR-010, SPR-011, SPR-012, SPR-013, SPR-015
used_by:
related: SPR-059, SPR-062, SPR-064
tags:
  - spring
  - java
  - advanced
...
| Field          | Value                                                                                                                                                                                                         |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[SPR-010 - Spring Cloud Overview]], [[SPR-011 - Spring Cloud Config]], [[SPR-012 - Spring Cloud Gateway]], [[SPR-013 - Spring Cloud Service Discovery (Eureka)]], [[SPR-015 - Spring Cloud Circuit Breaker]] |
| **Used by**    | -                                                                                                                                                                                                             |
| **Related**    | [[SPR-059 - Spring Architecture at Scale]], [[SPR-062 - Spring Security Architecture Design]], [[SPR-064 - Spring Framework Internals Deep Dive]]                                                             |
...
- [[SPR-010 - Spring Cloud Overview]] - the full Spring Cloud portfolio
- [[SPR-012 - Spring Cloud Gateway]] - the API gateway
- [[SPR-015 - Spring Cloud Circuit Breaker]] - resilience patterns

**Builds On This (learn these next):**

- [[SPR-059 - Spring Architecture at Scale]] - when to choose microservices vs modulith
- [[SPR-062 - Spring Security Architecture Design]] - security in distributed services
- [[SPR-075 - Spring Security OAuth2 Resource Server]] - JWT auth across services
...
| NEXT EXPLORE  | SPR-059 (Scale), SPR-062 (Security)       |
+----------------------------------------------------------+
```
