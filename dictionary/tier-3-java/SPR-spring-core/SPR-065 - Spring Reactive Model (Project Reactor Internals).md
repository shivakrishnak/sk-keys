...
difficulty: ★★★
depends_on: SPR-047, SPR-048, SPR-054, SPR-060
used_by:
related: SPR-064, SPR-066, SPR-072
tags:
  - spring
  - java
  - advanced
...
nav_order: 65
permalink: /spr/spring-reactive-model-project-reactor-internals/
---
...
| Field          | Value                                                                                                                                                                   |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Depends on** | [[SPR-047 - WebFlux Introduction]], [[SPR-048 - Reactive Streams Specification]], [[SPR-054 - Flux and Mono]], [[SPR-060 - Spring Migration Strategy (MVC to WebFlux)]] |
| **Used by**    | -                                                                                                                                                                       |
| **Related**    | [[SPR-064 - Spring Framework Internals Deep Dive]], [[SPR-066 - Spring Native and GraalVM Integration]], [[SPR-072 - Spring WebFlux vs Virtual Threads]]                |
...
- [[SPR-047 - WebFlux Introduction]] - the Spring WebFlux web framework built on Reactor
- [[SPR-048 - Reactive Streams Specification]] - the specification Reactor implements
- [[SPR-054 - Flux and Mono]] - Reactor's two core publisher types

**Builds On This (learn these next):**

- [[SPR-072 - Spring WebFlux vs Virtual Threads]] - when Reactor is no longer the right choice
- [[SPR-060 - Spring Migration Strategy (MVC to WebFlux)]] - migration considerations
- [[SPR-066 - Spring Native and GraalVM Integration]] - AOT + Reactor interaction
...
|               | library (Reactive Streams implementation)|
