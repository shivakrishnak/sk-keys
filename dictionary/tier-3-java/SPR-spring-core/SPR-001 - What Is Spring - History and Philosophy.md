...
nav_order: 1
permalink: /spr/what-is-spring-history-and-philosophy/
---
...
```
+----------------------------------------------------------+
| WHAT IT IS    | Open-source Java IoC container + framework|
| PROBLEM       | J2EE EJB complexity; untestable coupled code|
| KEY INSIGHT   | Centralise wiring; business code stays pure|
| USE WHEN      | Any non-trivial Java backend application   |
| AVOID WHEN    | Tiny scripts; GraalVM-first services where |
