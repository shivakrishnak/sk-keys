...
difficulty: ★★★
depends_on: JVM-048, JVM-049, JVM-056
used_by:
related: JVM-041, JVM-047, JVM-065
tags:
  - jvm
  - java
  - architecture
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-048 - GraalVM]], [[JVM-049 - Native Image]], [[JVM-056 - JVM Architecture Decisions at Scale]] |
| **Used by** | (none - decision framework entry) |
| **Related** | [[JVM-041 - JIT Compiler]], [[JVM-047 - AOT Compilation]], [[JVM-065 - Performance Intuition via JVM Internals]] |
...
- [[JVM-048 - GraalVM]] - GraalVM architecture
- [[JVM-049 - Native Image]] - Native Image mechanics
- [[JVM-056 - JVM Architecture Decisions at Scale]] - Fleet-level context

**Builds On This (learn these next):**
- [[JVM-065 - Performance Intuition via JVM Internals]] - Predicting performance differences

**Alternatives / Comparisons:**
- [[JVM-041 - JIT Compiler]] - HotSpot JIT compilation details
- [[JVM-047 - AOT Compilation]] - AOT compilation concepts
...
|               | upgrade? GraalVM JIT.            |
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-049 Native Image,            |
|               | JVM-065 performance intuition     |
+--------------------------------------------------+
```
