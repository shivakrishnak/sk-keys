...
used_by: JVM-008, JVM-041, JVM-042
related: JVM-009, JVM-013, JVM-017
tags:
  - jvm
  - java
  - internals
...
| **Used by** | [[JVM-008 - Bytecode]], [[JVM-041 - JIT Compiler]], [[JVM-042 - C1 C2 Compiler]] |
| **Related** | [[JVM-009 - Class Loader]], [[JVM-013 - Stack Frame]], [[JVM-017 - Escape Analysis]] |
...
- [[JVM-008 - Bytecode]] - The intermediate representation in detail
- [[JVM-009 - Class Loader]] - Phase 2 (class loading) in detail
- [[JVM-041 - JIT Compiler]] - Phase 5 (JIT compilation) in detail

**Alternatives / Comparisons:**
- [[JVM-047 - AOT Compilation]] - Compile to native at build time, skip warm-up
- [[JVM-017 - Escape Analysis]] - Key JIT optimisation in Phase 5
...
|               | verify -> C1 -> C2 -> native     |
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-041 JIT Compiler,            |
|               | JVM-008 Bytecode internals        |
+--------------------------------------------------+
```
...
*Hint:* Investigate AppCDS (Application Class Data Sharing) and [[JVM-047 - AOT Compilation]] (GraalVM Native Image profile-guided optimisation).
