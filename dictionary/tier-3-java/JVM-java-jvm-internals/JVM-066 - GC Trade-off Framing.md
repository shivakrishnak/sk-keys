...
difficulty: ★★★
depends_on: JVM-033, JVM-034, JVM-035, JVM-039
used_by:
related: JVM-055, JVM-061
tags:
  - jvm
  - java
  - gc
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-033 - G1GC]], [[JVM-034 - ZGC]], [[JVM-035 - Shenandoah]], [[JVM-039 - Parallel GC]] |
| **Used by** | (none - terminal synthesis entry) |
| **Related** | [[JVM-055 - GC Tuning Strategy for Production JVMs]], [[JVM-061 - GC Algorithm Design Principles]] |
...
- [[JVM-033 - G1GC]] - The default GC algorithm
- [[JVM-034 - ZGC]] - The low-pause alternative
- [[JVM-035 - Shenandoah]] - Alternative low-pause GC
- [[JVM-039 - Parallel GC]] - The throughput-optimised GC

**Builds On This (learn these next):**
- (none - synthesis and capstone entry for GC section)

**Alternatives / Comparisons:**
- [[JVM-055 - GC Tuning Strategy for Production JVMs]] - Operational tuning of the chosen algorithm
- [[JVM-061 - GC Algorithm Design Principles]] - Why these trade-offs exist
...
|               | General: G1GC (default)           |
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-055 GC tuning strategy,     |
|               | JVM-061 GC algorithm principles  |
+--------------------------------------------------+
```
