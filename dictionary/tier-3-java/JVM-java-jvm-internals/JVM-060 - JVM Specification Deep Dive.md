...
difficulty: ★★★
depends_on: JVM-008, JVM-013, JVM-018, JVM-019
used_by: JVM-063
related: JVM-046, JVM-061, JVM-062
tags:
  - jvm
  - java
  - internals
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-008 - Bytecode]], [[JVM-013 - Stack Frame]], [[JVM-018 - Memory Barrier]], [[JVM-019 - Happens-Before]] |
| **Used by** | [[JVM-063 - JVM Language Design (Bytecode Targeting)]] |
| **Related** | [[JVM-046 - OSR (On-Stack Replacement)]], [[JVM-061 - GC Algorithm Design Principles]], [[JVM-062 - JIT Compilation Research (Truffle, Graal IR)]] |
...
- [[JVM-008 - Bytecode]] - The instruction set the spec defines
- [[JVM-013 - Stack Frame]] - Runtime data structures defined by spec
- [[JVM-018 - Memory Barrier]] - Hardware mechanism behind JMM
- [[JVM-019 - Happens-Before]] - The JMM ordering relation

**Builds On This (learn these next):**
- [[JVM-063 - JVM Language Design (Bytecode Targeting)]] - Using the spec to design new languages

**Alternatives / Comparisons:**
- [[JVM-061 - GC Algorithm Design Principles]] - What the spec does NOT define
- [[JVM-062 - JIT Compilation Research]] - What the spec enables implementations to do
...
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-061 GC design principles,   |
|               | JVM-063 language design           |
+--------------------------------------------------+
```
