...
used_by:
related: JVM-047, JVM-048, JVM-049
tags:
  - jvm
  - java
  - foundational
...
| **Related** | [[JVM-047 - AOT Compilation]], [[JVM-048 - GraalVM]], [[JVM-049 - Native Image]] |
...
- [[JVM-048 - GraalVM]] - GraalVM deep dive
- [[JVM-049 - Native Image]] - Native compilation path
- [[JVM-047 - AOT Compilation]] - Ahead-of-time compilation concepts
...
*Hint:* Look at [[JVM-004 - How Java Code Runs]] and the thread management sections; then explore virtual threads in Java 21 as a potential solution to the blocking concern.
