...
difficulty: ★★★
depends_on: JVM-011, JVM-020, JVM-050
used_by: JVM-059
related: JVM-055, JVM-056, JVM-012
tags:
  - jvm
  - java
  - memory
...
nav_order: 58
permalink: /jvm/heap-sizing-and-memory-planning-strategy/
---
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-011 - Heap Memory]], [[JVM-020 - GC Roots]], [[JVM-050 - TLAB (Thread Local Allocation Buffer)]] |
| **Used by** | [[JVM-059 - JVM Observability Strategy]] |
| **Related** | [[JVM-055 - GC Tuning Strategy for Production JVMs]], [[JVM-056 - JVM Architecture Decisions at Scale]], [[JVM-012 - Metaspace]] |
...
- [[JVM-011 - Heap Memory]] - Heap structure
- [[JVM-020 - GC Roots]] - What determines live set
- [[JVM-050 - TLAB (Thread Local Allocation Buffer)]] - Allocation mechanism

**Builds On This (learn these next):**
- [[JVM-059 - JVM Observability Strategy]] - Monitoring memory in production

**Alternatives / Comparisons:**
- [[JVM-012 - Metaspace]] - Non-heap class metadata
- [[JVM-055 - GC Tuning Strategy for Production JVMs]] - GC algorithm selection
...
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-059 observability,           |
|               | JVM-055 GC tuning                 |
+--------------------------------------------------+
```
