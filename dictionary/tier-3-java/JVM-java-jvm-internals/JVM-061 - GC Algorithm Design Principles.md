...
difficulty: ★★★
depends_on: JVM-020, JVM-029
used_by: JVM-066
related: JVM-033, JVM-034, JVM-035, JVM-060
tags:
  - jvm
  - java
  - gc
...
nav_order: 61
permalink: /jvm/gc-algorithm-design-principles/
---
...
| Field | Value |
|---|---|
| **Depends on** | [[JVM-020 - Object Lifecycle]], [[JVM-029 - Generational GC]] |
| **Used by** | [[JVM-066 - GC Trade-off Framing]] |
| **Related** | [[JVM-033 - G1GC]], [[JVM-034 - ZGC]], [[JVM-035 - Shenandoah]], [[JVM-060 - JVM Specification Deep Dive]] |
...
if (GC_is_marking && oldValue != null && !marked(oldValue)) {
...
- [[JVM-020 - Object Lifecycle]] - Object allocation to collection path
- [[JVM-029 - Generational GC]] - The foundational hypothesis enabling all modern GCs

**Builds On This (learn these next):**
- [[JVM-066 - GC Trade-off Framing]] - Applying these principles to algorithm selection

**Alternatives / Comparisons:**
- [[JVM-033 - G1GC]] - Concrete implementation of these principles
- [[JVM-034 - ZGC]] - Next-generation concurrent GC design
- [[JVM-035 - Shenandoah]] - Alternative approach to concurrent compaction
...
|               | promotions                        |
+--------------------------------------------------+
| NEXT EXPLORE  | JVM-066 GC trade-off framing,   |
|               | JVM-034 ZGC internals             |
+--------------------------------------------------+
```
