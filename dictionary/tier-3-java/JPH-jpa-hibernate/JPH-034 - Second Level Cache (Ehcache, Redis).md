...
nav_order: 34
permalink: /jpa-hibernate/second-level-cache/
---

# JPH-034 - Second Level Cache (Ehcache, Redis)
...
Request 1 (Session A): em.find(Country.class, "US")
  ...
  4. Store in 2LC: key="Country#US", value={name:"United States",...}
...
em.merge(countryUS):  // UPDATE fired
  ...
  3. Next request: cache miss -> DB query -> re-populate 2LC
```
...
Problem: Instance 1 and Instance 2 still cache the OLD value
