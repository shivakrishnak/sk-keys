...
nav_order: 46
permalink: /jpa-hibernate/hibernate-statistics/
---
...
System.out.println("2LC hits: " + stats.getSecondLevelCacheHitCount());
System.out.println("2LC misses: " + stats.getSecondLevelCacheMissCount());
...
│              │ Requires spring-boot-actuator on classpath │
├──────────────┼───────────────────────────────────────────┤
