...
nav_order: 24
permalink: /jpa-hibernate/derived-query-methods/
---

# JPH-024 - Derived Query Methods (findBy, countBy)
...
```
findByEmailAndStatusOrderByCreatedAtDesc(String email, String status)
    |
    v
[ PartTree parsing: ]
    subject = "find"
...
Application context initializing:
    UserRepository.findByEmailAndStatus -> parse method name
    ...
    -> PropertyReferenceException: No property "emailAddress"
       found for type User
