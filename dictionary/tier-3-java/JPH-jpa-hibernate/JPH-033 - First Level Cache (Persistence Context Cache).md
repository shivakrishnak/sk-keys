...
nav_order: 33
permalink: /jpa-hibernate/first-level-cache/
---

# JPH-033 - First Level Cache (Persistence Context Cache)
...
Example at runtime:
  {
    ...
    (Customer.class, 10L) -> {entity: customer10, snapshot: {...}}
  }
```
...
em.find(Product.class, 1L):
  ...
  3. If found: return the cached entity object (NO DB query)
