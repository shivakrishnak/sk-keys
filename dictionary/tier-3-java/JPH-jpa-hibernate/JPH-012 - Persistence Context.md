...
nav_order: 12
permalink: /jpa-hibernate/persistence-context/
---
...
[ em.flush() - dirty check all managed entities ]
    |  p1: price changed -> UPDATE products SET price=29.99 WHERE id=1
...
├──────────────┼───────────────────────────────────────────┤
│ NEXT EXPLORE │ Entity Lifecycle -> Fetch -> @Transactional│
└──────────────────────────────────────────────────────────┘
```
