...
used_by: JLG-042
related: JLG-046, JLG-044, JLG-049
tags:
  - java
  - advanced
  - architecture
...
| **Used by** | [[JLG-042 - Java API Design at Scale]] |
| **Related** | [[JLG-046 - Java Language Specification Deep Dive]], [[JLG-044 - Java Performance Profiling at Scale]], [[JLG-049 - Java Language Design History and Rationale]] |
...
- [[JLG-042 - Java API Design at Scale]] - using JPMS to enforce API boundaries
- [[JLG-046 - Java Language Specification Deep Dive]] - the JVM spec defining module behaviour
...
| NEXT EXPLORE  | JLG-042 (API Design),                   |
|               | JLG-046 (JLS Deep Dive)                 |
+----------------------------------------------------------+
```
