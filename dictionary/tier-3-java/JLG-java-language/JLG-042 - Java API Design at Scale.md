...
difficulty: ★★★
depends_on: JLG-049, JLG-050
related: JLG-043, JLG-051
tags:
  - java
  - advanced
  - architecture
...
| Field          | Value                                                                                            |
| -------------- | ------------------------------------------------------------------------------------------------ |
| **Depends on** | [[JLG-049 - Java Language Design History and Rationale]], [[JLG-050 - Java API Design Thinking]] |
| **Used by**    | -                                                                                                |
| **Related**    | [[JLG-043 - Java Modularity Strategy (JPMS)]], [[JLG-051 - Language Feature Trade-off Framing]]  |
...
- [[JLG-049 - Java Language Design History and Rationale]] - why Java made these design choices
- [[JLG-050 - Java API Design Thinking]] - the design thinking process

**Builds On This (learn these next):**

- [[JLG-043 - Java Modularity Strategy (JPMS)]] - using modules to enforce API surface boundaries
- [[JLG-051 - Language Feature Trade-off Framing]] - evaluating which design patterns to apply
...
|               | mutable state creates corruption at scale|
...
|               | service contracts; publishing module APIs |
| AVOID WHEN    | Internal implementation - package-private |
...
| NEXT EXPLORE  | JLG-043 (JPMS boundaries),               |
|               | JLG-051 (trade-off framing)              |
+----------------------------------------------------------+
```
