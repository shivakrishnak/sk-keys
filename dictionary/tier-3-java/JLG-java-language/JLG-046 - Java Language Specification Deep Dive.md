...
difficulty: ★★★
depends_on: JLG-001, JLG-043
used_by: JLG-047, JLG-048
related: JLG-049, JLG-050, JLG-051
tags:
  - java
  - advanced
  - internals
...
| Field | Value |
|---|---|
| **Depends on** | [[JLG-001 - What Is Java - History and Philosophy]], [[JLG-043 - Java Modularity Strategy (JPMS)]] |
| **Used by** | [[JLG-047 - Project Valhalla - Value Types and Primitives]], [[JLG-048 - Project Panama - Foreign Function and Memory API]] |
| **Related** | [[JLG-049 - Java Language Design History and Rationale]], [[JLG-050 - Java API Design Thinking]], [[JLG-051 - Language Feature Trade-off Framing]] |
...
- [[JLG-043 - Java Modularity Strategy (JPMS)]] - module system knowledge for JLS context

**Builds On This (learn these next):**
- [[JLG-047 - Project Valhalla - Value Types and Primitives]] - JMM implications for value types
- [[JLG-048 - Project Panama - Foreign Function and Memory API]] - FFM memory ordering at native boundary
...
| NEXT EXPLORE  | JLG-047 (Valhalla), JLG-049 (JLS history)|
+----------------------------------------------------------+
```
