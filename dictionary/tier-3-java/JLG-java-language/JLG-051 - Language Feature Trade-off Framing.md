...
used_by: JLG-052
related: JLG-004, JLG-046, JLG-047
tags:
  - java
  - advanced
  - tradeoff
...
| **Related** | [[JLG-004 - Java vs Other JVM Languages (Kotlin, Scala, Groovy)]], [[JLG-046 - Java Language Specification Deep Dive]], [[JLG-047 - Project Valhalla - Value Types and Primitives]] |
...
- [[JLG-049 - Java Language Design History and Rationale]] - why Java features have their specific trade-offs
- [[JLG-050 - Java API Design Thinking]] - how to apply trade-off framing to API decisions

**Builds On This (learn these next):**
- [[JLG-052 - Java Ecosystem Selection Framework]] - applying trade-off framing at the library/framework level
...
| NEXT EXPLORE  | JLG-052 (Ecosystem selection),          |
