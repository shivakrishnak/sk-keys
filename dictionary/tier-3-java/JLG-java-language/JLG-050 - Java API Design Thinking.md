...
difficulty: ★★★
depends_on: JLG-042, JLG-049
used_by: JLG-051
related: JLG-043, JLG-046, JLG-052
tags:
  - java
  - advanced
  - architecture
...
| Field | Value |
|---|---|
| **Depends on** | [[JLG-042 - Java API Design at Scale]], [[JLG-049 - Java Language Design History and Rationale]] |
| **Used by** | [[JLG-051 - Language Feature Trade-off Framing]] |
| **Related** | [[JLG-043 - Java Modularity Strategy (JPMS)]], [[JLG-046 - Java Language Specification Deep Dive]], [[JLG-052 - Java Ecosystem Selection Framework]] |
...
- [[JLG-042 - Java API Design at Scale]] - defensive copying and minimal surface area
- [[JLG-049 - Java Language Design History and Rationale]] - why Java API design looks the way it does

**Builds On This (learn these next):**
- [[JLG-051 - Language Feature Trade-off Framing]] - evaluating when to use specific API patterns
...
| NEXT EXPLORE  | JLG-051 (Feature trade-offs),           |
|               | JLG-043 (JPMS for enforcement)          |
+----------------------------------------------------------+
```
