...
difficulty: ★★☆
depends_on: JLG-043, JLG-009, JLG-001
used_by: JLG-058, JLG-060
related: JLG-024, JLG-025, JLG-064
tags:
  - java
  - internals
  - advanced
...
| Field      | Value                                              |
|------------|----------------------------------------------------|
| Depends on | JLG-043 Java Modularity Strategy, JLG-009 Java Access Modifiers, JLG-001 Java EE Overview |
| Used by    | JLG-058 Class File Format, JLG-060 Hidden Classes |
| Related    | JLG-024 Reflection, JLG-025 Annotation Processing, JLG-064 JLS |
...
- [[JLG-009 - Java Access Modifiers]] - the access model JPMS extends
- [[JLG-043 - Java Modularity Strategy]] - high-level strategy context

**Builds On This (learn these next):**
- [[JLG-058 - Class File Format (javap)]] - module-info.class format
- [[JLG-060 - Hidden Classes (Java 15+)]] - JVM internal class
...
+--------------+------------------------------------+
| NEXT EXPLORE | JLG-058 Class File Format,         |
