...
used_by: JLG-050, JLG-051
related: JLG-046, JLG-047, JLG-052
tags:
  - java
  - advanced
  - first-principles
...
| **Used by** | [[JLG-050 - Java API Design Thinking]], [[JLG-051 - Language Feature Trade-off Framing]] |
| **Related** | [[JLG-046 - Java Language Specification Deep Dive]], [[JLG-047 - Project Valhalla - Value Types and Primitives]], [[JLG-052 - Java Ecosystem Selection Framework]] |
...
- [[JLG-050 - Java API Design Thinking]] - applying design rationale to API design
- [[JLG-051 - Language Feature Trade-off Framing]] - evaluating features using the rationale framework
...
| NEXT EXPLORE  | JLG-050 (API Design),                   |
