...
nav_order: 39
permalink: /obs/observability-at-scale-sampling-aggregation/
---

# OBS-039 - Observability at Scale (Sampling, Aggregation)
...
```
┌──────────────────────────────────────────────────────────┐
│ WHAT IT IS   │ Architecture for maintaining observability│
