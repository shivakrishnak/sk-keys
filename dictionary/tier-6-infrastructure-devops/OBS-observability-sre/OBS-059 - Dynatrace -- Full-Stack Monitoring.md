...
Host OS
   │
   ├── OneAgent system-level component (eBPF, network probes)
...
│              │ verifying Smartscape topology completeness│
├──────────────┼───────────────────────────────────────────┤
...
*Hint: Consider what entity types Dynatrace OneAgent can
auto-discover versus what requires explicit network monitoring
configuration or integration with cloud provider network flow logs.*
...
*Hint: Think about the difference between head-based sampling
...
*Hint: Consider how Dynatrace management zones map to team
ownership boundaries and how alerting profiles can be layered
to satisfy both global platform SLOs and team-specific monitors.*
...
*Why they ask:* Tests understanding of the trade-offs between
...
*Why they ask:* Tests production APM knowledge for async
...
*Why they ask:* Tests strategic thinking about observability
