...
# OBS-018 - Jaeger / Zipkin -- Distributed Tracing
...
checkout-api        [=======================] 3,400ms
  ...
  payment-gateway          [==================] 3,050ms  ← CULPRIT
    stripe-api              [================] 2,990ms
  db-write                                    [=]   80ms
...
checkout-api: 3,400ms
  ...
  payment-gateway: 3,050ms ← SLOW
    stripe-http-call: 2,990ms ← VERY SLOW
      [span tags]: http.url=https://api.stripe.com/v1/charges
...
curl http://elasticsearch:9200/_cat/indices/jaeger*?v&h=index,docs.count,store.size
...
│ CORRELATION  │ Jump from log in Kibana to trace in Jaeger│
├──────────────┼───────────────────────────────────────────┤
