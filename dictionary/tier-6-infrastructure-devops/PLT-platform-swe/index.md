...
**Keywords:** PLT-001–PLT-052 (52 terms)

| ID | Keyword | Difficulty |
|----|---------|------------|
| PLT-001 | What Is Platform Engineering | ★☆☆ |
| PLT-002 | The Platform Engineering Mental Model (Golden Paths, IDP) | ★☆☆ |
| PLT-003 | Platform Engineering vs DevOps vs SRE -- The Map | ★☆☆ |
| PLT-004 | The Modern SWE Ecosystem Map (Platform Tools) | ★☆☆ |
| PLT-005 | Platform Engineering in Practice -- What Teams Face | ★☆☆ |
| PLT-006 | Internal Developer Platform (IDP) Design | ★☆☆ |
| PLT-007 | Developer Experience (DX) Fundamentals | ★☆☆ |
| PLT-008 | Golden Path Templates | ★☆☆ |
...
| PLT-052 | Platform Team Topologies | ★★★ |
