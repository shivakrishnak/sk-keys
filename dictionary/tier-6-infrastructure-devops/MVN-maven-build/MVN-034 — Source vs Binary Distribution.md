...
my-lib-1.0.0-javadoc.jar      ← javadoc JAR (classifier: javadoc)
my-lib-1.0.0.pom              ← project object model (metadata)
...
# Deploy all classifiers to Nexus (automatically included in mvn deploy)
mvn deploy
...
├──────────────┼───────────────────────────────────────────┤
│ ONE-LINER    │ "Binary=run; Source=debug/verify; Docs=read"│
└──────────────────────────────────────────────────────────┘
```
