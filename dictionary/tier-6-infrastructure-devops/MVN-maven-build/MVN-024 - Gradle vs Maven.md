...
nav_order: 24
permalink: /maven-build/gradle-vs-maven/
id: MVN-024
...
# mvn -pl module -am         → ./gradlew :module:build (Gradle handles deps)
...
// Gradle tracks these: if inputs unchanged since last run, task is UP-TO-DATE
...
```kotlin
// Gradle: import Spring Boot BOM (equivalent to Maven <scope>import</scope>)
dependencies {
