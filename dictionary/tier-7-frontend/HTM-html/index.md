...
**Keywords:** HTM-001–HTM-042 (42 terms)

| ID | Keyword | Difficulty |
|----|---------|------------|
| HTM-001 | What Is HTML and How the Web Works | ★☆☆ |
| HTM-002 | The HTML Mental Model (Document Tree) | ★☆☆ |
| HTM-003 | HTML vs CSS vs JavaScript -- Roles | ★☆☆ |
| HTM-004 | The Web Ecosystem Map (Browsers, Standards) | ★☆☆ |
| HTM-005 | HTML in Production -- What to Expect | ★☆☆ |
| HTM-006 | HTML Document Structure (doctype, head, body) | ★☆☆ |
| HTM-007 | HTML Elements and Tags | ★☆☆ |
| HTM-008 | HTML Attributes | ★☆☆ |
| HTM-009 | Semantic HTML (header, nav, main, article, section) | ★☆☆ |
| HTM-010 | HTML Forms and Input Types | ★☆☆ |
| HTM-011 | HTML Links and Anchors | ★☆☆ |
...
| HTM-022 | Open Graph Protocol (og: meta tags) | â˜…â˜…â˜† |
...
| HTM-033 | Web Performance Metrics (CWV: LCP, FID, CLS) | â˜…â˜…â˜… |
