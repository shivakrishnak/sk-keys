...
|----|---------|------------|
| WBP-001 | What Is a JavaScript Bundler and Why It Matters | ★☆☆ |
| WBP-002 | The Bundler Mental Model (Module Graph, Entry Points, Chunks) | ★☆☆ |
| WBP-003 | Webpack vs Vite vs Rollup vs Parcel -- Trade-offs | ★☆☆ |
| WBP-004 | The Build Tool Ecosystem Map (Frontend) | ★☆☆ |
| WBP-005 | Bundlers in Production -- What to Expect | ★☆☆ |
| WBP-006 | Webpack Basics (entry, output, loaders, plugins) | ★☆☆ |
| WBP-007 | Webpack Loaders | ★☆☆ |
