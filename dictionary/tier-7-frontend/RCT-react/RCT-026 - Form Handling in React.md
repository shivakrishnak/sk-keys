...
nav_order: 26
permalink: /react/form-handling-in-react/
---
...
ON CHANGE (as you type):
  Most responsive. Can be annoying (errors before user finishes).
  Best for: password strength indicator, username availability check.
