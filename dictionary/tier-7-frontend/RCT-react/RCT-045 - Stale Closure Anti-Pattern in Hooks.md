...
nav_order: 45
permalink: /react/stale-closure-anti-pattern-in-hooks/
---
...
function Counter() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      console.log("Current count:", count); // always: "Current count: 0"
...
```
┌──────────────────────────────────────────────────────────┐
│ THE BUG   │ Callback reads state from old render snapshot│
