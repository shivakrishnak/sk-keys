...
nav_order: 34
permalink: /react/usereducer-hook/
---
...
state reducer:
  ...
  → (loadingState, { type: 'SUCCESS', data }) → successState
...
Benefit:
  ...
  - Actions are loggable/debuggable (what happened, in order)
  - Reducer is a pure function → easily unit tested
  - Impossible states eliminated (reducer controls all transitions)
```
...
// Only 4 valid status values - impossible states structurally prevented
