...
Object.is(a, b):
  ...
  Objects/arrays:   true ONLY if same reference (same object in memory)
...
2. Object/array props are stable references (useMemo in parent)
3. Function props are stable references (useCallback in parent)
```
