...
difficulty: ★★★
depends_on: DPT-039, DPT-053, DPT-054
used_by: DPT-043, DPT-079
related: DST-001, MSV-001, SAP-008
tags:
  - pattern
  - distributed
  - advanced
...
# DPT-040 - Patterns in Distributed Systems
...
|:---|:---|:---|
| **Depends on:** | DPT-039, DPT-053, DPT-054 | |
| **Used by:** | DPT-043, DPT-079 | |
| **Related:** | DST-001, MSV-001, SAP-008 | |
...
- [[DPT-039 - Pattern-Driven Architecture Design]] - patterns at architectural level
- [[DPT-053 - Outbox Pattern]] - messaging reliability pattern
- [[DPT-054 - Saga Pattern]] - distributed transaction pattern

**Builds On This (learn these next):**
- [[DPT-043 - Pattern Trade-off Framing]] - evaluating patterns against system constraints
- [[DPT-079 - Meta-Pattern Design]] - patterns about patterns at distributed level

**Alternatives / Comparisons:**
- [[DST-001 - Distributed Systems]] - the underlying theory
- [[MSV-001 - Microservices]] - the architectural context
- [[SAP-008 - CQRS Pattern]] - data management pattern for distributed reads/writes
...
│               │ and observe                      │
├───────────────┼──────────────────────────────────┤
│ NEXT EXPLORE  │ DPT-078 Circuit Breaker          │
└─────────────────────────────────────────────────┘
```
