...
difficulty: ★★★
depends_on: DPT-086, DPT-081, DPT-003
used_by:
related: DPT-044, SAP-082, DPT-039
tags:
  - pattern
  - advanced
  - tradeoff
...
|:---|:---|:---|
| **Depends on:** | DPT-086, DPT-081, DPT-003 | |
| **Related:** | DPT-044, SAP-082, DPT-039 | |
...
- [[DPT-086 - Pattern-Recognition Mental Model]] - recognising patterns before framing their trade-offs
- [[DPT-081 - Pattern Selection Framework]] - the selection process that trade-off framing supplements
- [[DPT-003 - Pattern vs Anti-Pattern vs Idiom]] - trade-off framing applies to patterns, not idioms

**Builds On This (learn these next):**
- [[DPT-044 - Over-Engineering Risk Thinking]] - trade-off framing applied specifically to over-engineering decisions

**Alternatives / Comparisons:**
- [[SAP-082 - Architecture Trade-off Framing]] - the same concept at architectural level
- [[DPT-039 - Pattern-Driven Architecture Design]] - pattern trade-offs at system composition level
...
├───────────────┼──────────────────────────────────┤
│ NEXT EXPLORE  │ DPT-044 Over-Engineering Risk    │
└─────────────────────────────────────────────────┘
```
