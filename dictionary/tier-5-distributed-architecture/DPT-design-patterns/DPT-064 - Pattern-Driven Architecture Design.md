...
difficulty: ★★★
depends_on: DPT-001, DPT-061, DPT-005
used_by: DPT-065, DPT-071, DPT-069
related: SAP-001, SAP-015, SAP-018
tags:
  - pattern
  - advanced
  - architecture
...
| DPT-064 | Category: Design Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | DPT-001, DPT-061, DPT-005 | |
| **Used by:** | DPT-065, DPT-071, DPT-069 | |
| **Related:** | SAP-001, SAP-015, SAP-018 | |
...
- [[DPT-061 - Pattern Selection Framework]] - how to select individual patterns
- [[DPT-005 - The Design Patterns Ecosystem Map]] - mapping patterns by category

**Builds On This (learn these next):**
- [[DPT-065 - Patterns in Distributed Systems]] - patterns at distributed system level
- [[DPT-071 - Pattern Trade-off Framing]] - evaluating pattern trade-offs at scale
- [[DPT-069 - Meta-Pattern Design]] - patterns about how patterns are composed

**Alternatives / Comparisons:**
- [[SAP-001 - What Is Software Architecture]] - architecture design without pattern vocabulary
- [[SAP-015 - Clean Architecture]] - a specific architectural pattern composition
- [[SAP-018 - CQRS Pattern]] - one key architectural pattern used in pattern-driven design
...
├───────────────┼──────────────────────────────────┤
│ NEXT EXPLORE  │ DPT-065 Distributed Patterns     │
└─────────────────────────────────────────────────┘
```
