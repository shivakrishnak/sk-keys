...
difficulty: ★★★
depends_on: DPT-067, DPT-066, DPT-001
used_by: DPT-069
related: DPT-070, DPT-003, CDQ-001
tags:
  - pattern
  - advanced
  - architecture
...
| DPT-068 | Category: Design Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | DPT-067, DPT-066, DPT-001 | |
| **Used by:** | DPT-069 | |
| **Related:** | DPT-070, DPT-003, CDQ-001 | |
...
- [[DPT-067 - Formal Pattern Specification]] - the output format of pattern mining
- [[DPT-066 - Pattern Language Theory (Christopher Alexander)]] - the empirical basis for pattern mining
- [[DPT-001 - What Are Design Patterns and Why They Exist]] - what qualifies as a pattern

**Builds On This (learn these next):**
- [[DPT-069 - Meta-Pattern Design]] - designing the pattern mining and publication process itself

**Alternatives / Comparisons:**
- [[DPT-070 - Pattern-Recognition Mental Model]] - using patterns after they are discovered
...
├───────────────┼──────────────────────────────────┤
│ NEXT EXPLORE  │ DPT-067 Pattern Specification    │
└─────────────────────────────────────────────────┘
```
