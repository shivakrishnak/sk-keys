...
difficulty: ★★★
depends_on: DPT-084, DPT-001, DPT-002
used_by: DPT-085, DPT-079
related: DPT-081, DPT-083, SAP-056
tags:
  - pattern
  - advanced
  - architecture
...
# DPT-041 - Formal Pattern Specification
...
|:---|:---|:---|
| **Depends on:** | DPT-084, DPT-001, DPT-002 | |
| **Used by:** | DPT-085, DPT-079 | |
| **Related:** | DPT-081, DPT-083, SAP-056 | |
...
- [[DPT-084 - Pattern Language Theory (Christopher Alexander)]] - the theory underlying the specification format
...
- [[DPT-085 - Pattern Mining and Discovery Research]] - discovering patterns to specify
- [[DPT-079 - Meta-Pattern Design]] - patterns for designing pattern languages

**Alternatives / Comparisons:**
- [[DPT-081 - Pattern Selection Framework]] - using specifications to select patterns
- [[DPT-083 - Anti-Pattern Recognition and Refactoring]] - the anti-pattern specification format
- [[SAP-056 - Architecture Decision Record (ADR)]] - single-decision pattern specification
