...
difficulty: ★★★
depends_on: DPT-055, DPT-003, DPT-004
used_by: DPT-081, DPT-039, DPT-044
related: DPT-028, DPT-011, DPT-058
tags:
  - pattern
  - advanced
  - antipattern
...
| DPT-083 | Category: Design Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | DPT-055, DPT-003, DPT-004 | |
| **Used by:** | DPT-081, DPT-039, DPT-044 | |
| **Related:** | DPT-028, DPT-011, DPT-058 | |
...
- [[DPT-055 - Anti-Patterns Overview]] - catalogue of known anti-patterns
...
- [[DPT-081 - Pattern Selection Framework]] - selecting the correct replacement pattern
- [[DPT-039 - Pattern-Driven Architecture Design]] - applying patterns at architectural scale
- [[DPT-044 - Over-Engineering Risk Thinking]] - the other extreme to avoid

**Alternatives / Comparisons:**
- [[DPT-028 - God Object Anti-Pattern]] - deep dive on the most common object anti-pattern
- [[DPT-011 - Spaghetti Code]] - deep dive on control flow anti-pattern
- [[DPT-058 - Premature Optimization]] - deep dive on the optimisation anti-pattern
