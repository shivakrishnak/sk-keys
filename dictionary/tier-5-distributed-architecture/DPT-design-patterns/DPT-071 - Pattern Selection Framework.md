...
used_by: DPT-039, DPT-086, DPT-043
related: DPT-055, DPT-044, SAP-082
tags:
  - pattern
  - advanced
  - architecture
...
| DPT-081 | Category: Design Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | DPT-001, DPT-003, DPT-004 | |
| **Used by:** | DPT-039, DPT-086, DPT-043 | |
| **Related:** | DPT-055, DPT-044, SAP-082 | |
...
- [[DPT-039 - Pattern-Driven Architecture Design]] - applying patterns at architectural level
- [[DPT-086 - Pattern-Recognition Mental Model]] - the cognitive model behind selection
- [[DPT-043 - Pattern Trade-off Framing]] - evaluating pattern trade-offs systematically

**Alternatives / Comparisons:**
- [[DPT-055 - Anti-Patterns Overview]] - what happens when selection fails
- [[DPT-044 - Over-Engineering Risk Thinking]] - the cost when patterns are over-applied
- [[SAP-045 - YAGNI (You Aren't Gonna Need It)]] - the principle governing pattern restraint
...
├───────────────┼──────────────────────────────────┤
│ NEXT EXPLORE  │ DPT-043 Pattern Trade-off        │
└─────────────────────────────────────────────────┘
```
