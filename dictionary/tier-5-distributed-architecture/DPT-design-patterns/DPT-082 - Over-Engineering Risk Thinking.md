...
difficulty: ★★★
depends_on: DPT-043, DPT-058, SAP-045
used_by:
related: DPT-083, DPT-081, SAP-036
tags:
  - pattern
  - advanced
  - antipattern
...
# DPT-044 - Over-Engineering Risk Thinking
...
|:---|:---|:---|
| **Depends on:** | DPT-043, DPT-058, SAP-045 | |
| **Related:** | DPT-083, DPT-081, SAP-036 | |
...
- `DPT-043 - Pattern Trade-off Framing` - the decision framework
  that identifies when a pattern's cost exceeds its benefit
- `DPT-058 - Premature Optimization` - the performance-specific
  variant of over-engineering
- `DPT-056 - Golden Hammer Anti-Pattern` - the tool-familiarity
  driver of over-engineering

**Builds On This (learn these next):**
- `DPT-083 - Anti-Pattern Recognition and Refactoring` - the
  systematic approach to identifying and removing over-engineering
- `DPT-081 - Pattern Selection Framework` - the positive framing:
...
- `DPT-044` is a meta-pattern: a thinking framework applied
