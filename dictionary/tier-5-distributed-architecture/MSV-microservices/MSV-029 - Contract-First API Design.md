...
nav_order: 29
permalink: /microservices/contract-first-api-design/
---
...
CODE-FIRST WORKFLOW:
  ...
  2. Add SpringDoc/Swagger annotations (@Operation, @Schema)
...
VS CODE-FIRST WITHOUT CONTRACT:
  ...
  Week 4: Payment team generates spec, shares with Order team
  Week 5: Order team discovers field name issue
  Week 5-6: Payment team changes API, Order team re-integrates
...
6. DOCUMENTATION:
   Spec published to developer portal (Stoplight, SwaggerUI)
...
│              │ (both teams start implementing in parallel) │
├──────────────┼───────────────────────────────────────────┤
