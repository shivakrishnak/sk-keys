...
depends_on: MSV-001
used_by: MSV-003
related: MSV-007, MSV-070, MSV-071
tags:
  - microservices
  - architecture
  - tradeoff
...
# MSV-026 - Monolith vs Microservices - The Real Trade-off
...
- `MSV-003 - When NOT to Use Microservices` — concrete decision criteria
- `MSV-070 - Service Decomposition Strategy` — how to split correctly
- `MSV-071 - Microservices Migration Strategy` — how to migrate

**Alternatives / Comparisons:**

- `MSV-077 - Domain-Driven Decomposition Theory` — theoretical basis for boundaries
...
│               │ not to tech trends"              │
├──────────────────────────────────────────────────┤
│ NEXT EXPLORE  │ MSV-003, MSV-070, MSV-071        │
└──────────────────────────────────────────────────┘
```
