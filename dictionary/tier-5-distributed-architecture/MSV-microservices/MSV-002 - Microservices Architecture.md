...
nav_order: 2
permalink: /microservices/microservices-architecture/
---
...
Option A: In-service library (pre-Kubernetes era)
  ...
  Problem: library updates require all services to redeploy.
...
Option B: Sidecar (Kubernetes / service mesh era)
  ...
  Update the sidecar platform-wide without touching services.
```
...
*Hint: Calculate time-to-exhaust: threads / (RPS * latency_in_seconds).*
...
*Hint: Think about where the key validation logic lives and
who controls its update lifecycle.*
...
*Hint: Follow money flows and real-time requirements to identify
...
*Why they ask:* Tests practical communication pattern selection.
...
*Why they ask:* Tests operational thinking in a large fleet.
...
is unnecessarily complex and suggests merging 10 services into
3. How do you evaluate whether they are right?"**

*Why they ask:* Tests architectural judgement and when to
