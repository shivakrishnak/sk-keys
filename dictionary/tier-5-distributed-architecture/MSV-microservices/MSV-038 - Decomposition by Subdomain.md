...
nav_order: 38
permalink: /microservices/decomposition-by-subdomain/
---
...
Subdomain: Credit Scoring
  ...
  Decision: BUILD CUSTOM. This IS your competitive advantage.
...
GENERIC SUBDOMAINS (buy):
  Authentication -> Auth0
    Service: auth-adapter (thin wrapper for token validation)
  Email -> SendGrid
...
4. What is the SaaS cost? SendGrid at 10K emails/day: ~$200/month
