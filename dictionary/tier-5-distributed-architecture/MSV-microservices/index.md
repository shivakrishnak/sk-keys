...
| MSV-068 | Service Mesh Architecture Design | ★★★ |
| MSV-069 | Microservices Observability Architecture | ★★★ |
| MSV-070 | Event-Driven Microservices Design | ★★★ |
| MSV-071 | Service Mesh Internals (Envoy, Istio) | ★★★ |
| MSV-072 | Service-to-Service Protocol Design | ★★★ |
| MSV-073 | Domain-Driven Decomposition Theory | ★★★ |
| MSV-074 | Microservices Research and Anti-Patterns | ★★★ |
