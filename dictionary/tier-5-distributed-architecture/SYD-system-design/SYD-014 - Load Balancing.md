...
difficulty: ★★☆
depends_on: SYD-011
used_by: SYD-012, SYD-019, SYD-049, SYD-016, SYD-020, SYD-037
related: SYD-012, SYD-019, SYD-049, SYD-016
tags:
  - networking
  - performance
  - foundational
...
- [[SYD-011 - Horizontal Scaling]] - the use case that makes load balancers necessary

**Builds On This (learn these next):**
- [[SYD-012 - Round Robin]] - one load balancing algorithm
- [[SYD-019 - Least Connections]] - alternative algorithm for uneven load
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - advanced algorithm for distributed caches

**Alternatives / Comparisons:**
- [[SYD-016 - Sticky Sessions]] - keeping one client's requests on same server (works with LB)
- [[SYD-020 - Session Affinity]] - similar to sticky sessions; LB-aware routing
