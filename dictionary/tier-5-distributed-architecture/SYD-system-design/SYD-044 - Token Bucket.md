...
depends_on: SYD-041
used_by: SYD-064
related: SYD-041, SYD-055, SYD-064
tags:
  - rate-limiting
  - algorithm
  - advanced
...
- [[SYD-041 - Rate Limiting (System)]] - The broader problem that token bucket solves
- [[SYD-016 - Estimation and Back-of-Envelope Thinking]] - Estimating the right capacity and rate values

**Builds On This (learn these next):**
- [[SYD-055 - Leaky Bucket]] - The alternative algorithm with different burst characteristics
- [[SYD-064 - Rate Limiter Design]] - End-to-end system design using token bucket

**Alternatives / Comparisons:**
- [[SYD-055 - Leaky Bucket]] - Queued output vs allowed bursts
- [[SYD-041 - Rate Limiting (System)]] - The problem class this solves
...
║               tokens + elapsed*rate)      ║
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-055: Leaky Bucket       ║
╚══════════════════════════════════════════╝
```
