...
used_by: SYD-056
related: SYD-056, SYD-012, SYD-018
tags:
  - algorithm
  - deep-dive
  - distributed
...
# SYD-049 - Consistent Hashing (Load Balancing)
...
- [[SYD-018 - Load Balancing]] - the distribution problem this solves
- [[SYD-012 - Round Robin]] - the simpler algorithm to compare against

**Builds On This (learn these next):**
- [[SYD-056 - Sharding (System)]] - uses consistent hashing to partition data across nodes

**Alternatives / Comparisons:**
- [[SYD-012 - Round Robin]] - simpler, no affinity, correct for stateless workloads
- [[SYD-019 - Least Connections]] - adaptive but no cache/session affinity
