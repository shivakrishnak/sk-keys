...
difficulty: ★★☆
depends_on: SYD-018, SYD-016
used_by:
related: SYD-016, SYD-018
tags:
  - intermediate
  - architecture
  - pattern
...
- [[SYD-018 - Load Balancing]] - the infrastructure implementing affinity
- [[SYD-016 - Sticky Sessions]] - the related concept; stickiness is the common implementation

**Builds On This (learn these next):**
- [[SYD-011 - Horizontal Scaling]] - affinity-free design is required for true horizontal scalability

**Alternatives / Comparisons:**
- [[SYD-016 - Sticky Sessions]] - often used synonymously; stickiness is a specific type of affinity
- [[SYD-011 - Horizontal Scaling]] - scales better when affinity is eliminated through stateless design
