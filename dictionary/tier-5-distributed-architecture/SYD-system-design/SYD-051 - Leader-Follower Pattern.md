...
difficulty: ★★★
depends_on: SYD-060, SYD-022
used_by: SYD-062, SYD-051
related: SYD-060, SYD-022, SYD-039
tags:
  - distributed
  - reliability
  - architecture
...
# SYD-061 - Leader-Follower Pattern
...
| :-------------- | :----------------------------- | :-------------- |
| **Depends on:** | SYD-060, SYD-022               |                 |
| **Used by:**    | SYD-062, SYD-051               |                 |
| **Related:**    | SYD-060, SYD-022, SYD-039     |                 |
...
- [[SYD-022 - Redundancy Failover]] - foundational concept for leader recovery
- [[SYD-060 - Distributed Locks]] - leader election uses distributed lock semantics

**Builds On This (learn these next):**
- [[SYD-062 - Write-Ahead Logging (System)]] - WAL is the replication mechanism inside leader-follower
- [[SYD-051 - Geo-Replication]] - leader-follower topology extended across regions

**Alternatives / Comparisons:**
- [[SYD-039 - Active-Passive]] - similar concept at the service/deployment level
- [[SYD-022 - Redundancy Failover]] - the general pattern; leader-follower is a specific implementation
...
├──────────────┼──────────────────────────────────┤
│ NEXT EXPLORE │ SYD-062 Write-Ahead Logging      │
└─────────────────────────────────────────────────┘
```
