...
difficulty: ★★★
depends_on: SYD-051, SYD-018, SYD-050
used_by:
related: SYD-051, SYD-028
tags:
  - distributed
  - advanced
  - architecture
...
# SYD-052 - Multi-Region Architecture
...
- [[SYD-051 - Geo-Replication]] - the data replication strategy that multi-region requires
- [[SYD-018 - Load Balancing]] - distributes users across regions
- [[SYD-050 - Disaster Recovery]] - DR capability is a core benefit of multi-region

**Builds On This (learn these next):**
- [[SYD-028 - Active-Active]] - deployment pattern used within multi-region architecture

**Alternatives / Comparisons:**
- [[SYD-051 - Geo-Replication]] - data replication strategy used within multi-region
- [[SYD-028 - Active-Active]] - traffic pattern option within multi-region
