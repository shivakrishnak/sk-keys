...
difficulty: ★★★
depends_on: SYD-056, SYD-062
used_by: SYD-044, SYD-064, SYD-071
related: SYD-056, SYD-057, SYD-049
tags:
  - distributed
  - database
  - architecture
...
# SYD-063 - Data Partitioning Strategies
...
| SYD-063         | Category: System Design          | Difficulty: ★★★ |
| :-------------- | :------------------------------- | :-------------- |
| **Depends on:** | SYD-056, SYD-062                 |                 |
| **Used by:**    | SYD-044, SYD-064, SYD-071       |                 |
| **Related:**    | SYD-056, SYD-057, SYD-049       |                 |
...
- [[SYD-056 - Sharding (System)]] - the concept; this entry covers the strategies
- [[SYD-062 - Write-Ahead Logging (System)]] - WAL enables per-shard recovery

**Builds On This (learn these next):**
- [[SYD-057 - Hot Shard]] - the primary failure mode of poor partition strategy
- [[SYD-044 - URL Shortener Design]] - practical example using hash partitioning
- [[SYD-071 - System Design at Hyperscale]] - how partitioning strategies apply at FAANG scale

**Alternatives / Comparisons:**
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - the algorithm underpinning hash partitioning
