...
difficulty: ★★★
depends_on: SYD-006, SYD-007, SYD-027, SYD-033
used_by: SYD-062
related: SYD-034, SYD-051, SYD-058
tags:
  - architecture
  - performance
  - tradeoff
...
| SYD-053         | Category: System Design                | Difficulty: ★★★ |
| :-------------- | :------------------------------------- | :-------------- |
| **Depends on:** | SYD-006, SYD-007, SYD-027, SYD-033    |                 |
| **Used by:**    | SYD-062                                |                 |
| **Related:**    | SYD-034, SYD-051, SYD-058              |                 |
...
- [[SYD-006 - Vertical Scaling]] - one cost lever
- [[SYD-007 - Horizontal Scaling]] - primary scale lever
- [[SYD-027 - Capacity Planning]] - sizing inputs

**Builds On This (learn these next):**
- [[SYD-062 - Trade-off Navigation Framework]] - broader
  trade-off decision framework
- [[SYD-058 - Formal Capacity Planning Models]] - quantitative
  models for cost and performance

**Alternatives / Comparisons:**
- [[SYD-033 - Read-Heavy vs Write-Heavy Design]] - domain-
  specific cost-performance patterns
- [[SYD-034 - Denormalization for Scale]] - cost in schema
  design
