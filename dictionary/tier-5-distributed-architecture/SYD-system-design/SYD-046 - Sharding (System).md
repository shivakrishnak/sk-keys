...
difficulty: ★★★
depends_on: SYD-011, SYD-063
used_by: SYD-057, SYD-063
related: SYD-049, SYD-057, SYD-063
tags:
  - database
  - distributed
  - scaling
...
| SYD-056         | Category: System Design     | Difficulty: ★★★ |
| :-------------- | :-------------------------- | :-------------- |
| **Depends on:** | SYD-011, SYD-063            |                 |
| **Used by:**    | SYD-057, SYD-063            |                 |
| **Related:**    | SYD-049, SYD-057, SYD-063   |                 |
...
**Symptom:** One shard has 70% of the load; others are idle. See SYD-057 for full analysis.
...
- [[SYD-011 - Horizontal Scaling]] - Sharding is horizontal scaling applied to databases
- [[SYD-063 - Data Partitioning Strategies]] - Sharding is one form of data partitioning

**Builds On This (learn these next):**
- [[SYD-057 - Hot Shard]] - The primary failure mode of sharding
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - The hashing algorithm that makes resharding tractable

**Alternatives / Comparisons:**
- [[SYD-010 - Vertical Scaling]] - The alternative that fails first
- [[SYD-063 - Data Partitioning Strategies]] - Broader partitioning context
...
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-057: Hot Shard          ║
╚══════════════════════════════════════════╝
```
...
*Hint:* Explore the hot shard problem (SYD-057) and strategies like celebrity exception handling, cell-based sharding, and application-level load balancing above the database tier.
