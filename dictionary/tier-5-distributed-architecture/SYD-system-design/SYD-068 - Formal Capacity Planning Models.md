...
difficulty: ★★★
depends_on: SYD-029, SYD-040, SYD-030
used_by:
related: SYD-005, SYD-074, SYD-075
tags:
  - architecture
  - performance
  - production
...
# SYD-031 - Formal Capacity Planning Models
...
| :-------------- | :------------------------------- | :-------------- |
| **Depends on:** | SYD-029, SYD-040, SYD-030        |                 |
| **Used by:**    |                                  |                 |
| **Related:**    | SYD-005, SYD-074, SYD-075        |                 |
...
- [[SYD-040 - Back-of-Envelope Estimation]] - quick estimation
- [[SYD-029 - Capacity Planning]] - planning fundamentals
- [[SYD-030 - Theoretical Foundations of Scalable Systems]] -
  the theory behind the models

**Builds On This (learn these next):**
- [[SYD-074 - Scale Estimation Mental Model]] - practical
  estimation techniques

**Alternatives / Comparisons:**
- [[SYD-005 - Cost-Performance Trade-off Architecture]] -
  applying capacity models to cost decisions
- [[SYD-075 - Trade-off Navigation Framework]] - using models
...
| NEXT EXPLORE  | SYD-074 Scale Estimation Mental Model      |
+-----------------------------------------------------------+
```
