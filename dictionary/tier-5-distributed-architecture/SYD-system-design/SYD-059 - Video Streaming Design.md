...
# SYD-069 - Video Streaming Design
...
- [[SYD-051 - Geo-Replication]] - CDN caching is geo-replication
  applied to video segments at edge nodes worldwide

**Builds On This (learn these next):**
- [[SYD-052 - Multi-Region Architecture]] - deployment pattern
  for global video CDN infrastructure
- [[SYD-029 - Capacity Planning]] - video is the highest-bandwidth
  workload to capacity plan in any consumer system

**Alternatives / Comparisons:**
- [[SYD-052 - Multi-Region Architecture]] - broader deployment
  pattern that video CDN is an implementation of
- [[SYD-068 - Chat System Design]] - contrasting real-time design
...
+-----------------------------------------------------------+
| NEXT EXPLORE| Multi-Region Architecture (SYD-052)        |
+-----------------------------------------------------------+
```
