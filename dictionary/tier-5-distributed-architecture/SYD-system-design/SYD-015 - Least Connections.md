...
difficulty: ★★☆
depends_on: SYD-018, SYD-012
used_by:
related: SYD-012, SYD-018, SYD-049
tags:
  - algorithm
  - intermediate
  - networking
...
- [[SYD-018 - Load Balancing]] - the context where this algorithm is applied
- [[SYD-012 - Round Robin]] - the simpler algorithm to compare against

**Builds On This (learn these next):**
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - advanced algorithm for distributed state routing

**Alternatives / Comparisons:**
- [[SYD-012 - Round Robin]] - simpler but less adaptive to varying request durations
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - better when client-server affinity matters
