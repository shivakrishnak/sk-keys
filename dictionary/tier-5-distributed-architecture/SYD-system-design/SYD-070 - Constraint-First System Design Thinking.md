...
difficulty: ★★★
depends_on: SYD-035, SYD-016, SYD-030
used_by:
related: SYD-074, SYD-075, SYD-008
tags:
  - architecture
  - mental-model
  - first-principles
...
| :-------------- | :------------------------------- | :-------------- |
| **Depends on:** | SYD-035, SYD-016, SYD-030        |                 |
| **Used by:**    |                                  |                 |
| **Related:**    | SYD-074, SYD-075, SYD-008        |                 |
...
- [[SYD-074 - Scale Estimation Mental Model]] - estimating
  constraint thresholds
- [[SYD-075 - Trade-off Navigation Framework]] - evaluating
  solutions against constraints

**Alternatives / Comparisons:**
- [[SYD-008 - Emergent Architecture Patterns]] - what emerges
