...
depends_on: SYD-050
used_by:
related: SYD-050, SYD-051, SYD-038
tags:
  - reliability
  - advanced
  - distributed
...
- [[SYD-050 - Disaster Recovery]] - overall strategy; RTO/RPO are the metrics that define DR targets

**Builds On This (learn these next):**
- [[SYD-051 - Geo-Replication]] - geographic distribution to achieve low RTO/RPO

**Alternatives / Comparisons:**
- [[SYD-038 - MTTR MTBF]] - different but complementary (MTTR is reactive, RTO is proactive)
