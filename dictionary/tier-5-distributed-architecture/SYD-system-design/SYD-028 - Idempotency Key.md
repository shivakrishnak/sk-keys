...
difficulty: ★★☆
depends_on: SYD-043, SYD-060
used_by: SYD-064, SYD-067, SYD-068
related: SYD-043, SYD-060, SYD-062
tags:
  - architecture
  - distributed
  - reliability
...
| SYD-024         | Category: System Design          | Difficulty: ★★☆ |
| :-------------- | :------------------------------- | :-------------- |
| **Depends on:** | SYD-043, SYD-060                 |                 |
| **Used by:**    | SYD-064, SYD-067, SYD-068       |                 |
| **Related:**    | SYD-043, SYD-060, SYD-062       |                 |
...
- [[SYD-043 - Polling vs Webhooks]] - context for where idempotency keys are required (webhook retries)
- [[SYD-060 - Distributed Locks]] - the mechanism used to protect idempotency key critical sections

**Builds On This (learn these next):**
- [[SYD-062 - Write-Ahead Logging (System)]] - WAL provides durability guarantees that support idempotency
- [[SYD-064 - Rate Limiter Design]] - rate limiting + idempotency together protect payment APIs
- [[SYD-067 - Notification System Design]] - notification retries require idempotent event consumers

**Alternatives / Comparisons:**
- [[SYD-060 - Distributed Locks]] - alternative for preventing duplicate execution via mutual exclusion
...
├──────────────┼──────────────────────────────────┤
│ NEXT EXPLORE │ SYD-060 Distributed Locks        │
└─────────────────────────────────────────────────┘
```
