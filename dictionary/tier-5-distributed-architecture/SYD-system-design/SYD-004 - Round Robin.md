...
difficulty: ★☆☆
depends_on: SYD-018, SYD-011
used_by: SYD-019
related: SYD-018, SYD-019, SYD-049
tags:
  - algorithm
  - foundational
  - networking
...
- [[SYD-018 - Load Balancing]] - the context where round robin is used as an algorithm
- [[SYD-011 - Horizontal Scaling]] - why you need a load balancing algorithm in the first place

**Builds On This (learn these next):**
- [[SYD-019 - Least Connections]] - more sophisticated algorithm that adapts to server state
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - advanced algorithm for distributed systems

**Alternatives / Comparisons:**
- [[SYD-019 - Least Connections]] - better for requests with varying processing time
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - better when requests have affinity to specific servers
