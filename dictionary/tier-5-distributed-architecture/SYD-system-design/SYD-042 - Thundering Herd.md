...
difficulty: ★★★
depends_on: SYD-018, SYD-041
used_by:
related: SYD-041, SYD-037
tags:
  - reliability
  - advanced
  - performance
...
- [[SYD-018 - Load Balancing]] - the layer that distributes the herd's load
- [[SYD-041 - Rate Limiting (System)]] - complementary protection against retry storms

**Builds On This (learn these next):**
- [[SYD-037 - Auto Scaling]] - can amplify thundering herd if not carefully configured

**Alternatives / Comparisons:**
- [[SYD-041 - Rate Limiting (System)]] - upstream protection; rate limiting prevents herds from forming
- [[SYD-037 - Auto Scaling]] - reactive capacity addition; auto-scaling responds to but does not prevent herds
