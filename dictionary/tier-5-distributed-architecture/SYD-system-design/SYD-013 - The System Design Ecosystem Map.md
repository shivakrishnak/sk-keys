...
difficulty: ★★☆
depends_on: SYD-001, SYD-035
used_by: SYD-044, SYD-064, SYD-065, SYD-066
related: SYD-001, SYD-035, SYD-016
tags:
  - architecture
  - foundational
  - mental-model
...
# SYD-017 - The System Design Ecosystem Map
...
| SYD-017         | Category: System Design                   | Difficulty: ★★☆ |
| :-------------- | :---------------------------------------- | :-------------- |
| **Depends on:** | SYD-001, SYD-035                          |                 |
| **Used by:**    | SYD-044, SYD-064, SYD-065, SYD-066       |                 |
| **Related:**    | SYD-001, SYD-035, SYD-016                 |                 |
...
- [[SYD-035 - How to Approach Any System Design Problem]] - How to use the map in practice

**Builds On This (learn these next):**
- [[SYD-010 - Vertical Scaling]] - First concept in the scalability domain
- [[SYD-018 - Load Balancing]] - First concept in the compute domain
- [[SYD-021 - SLA SLO SLI]] - First concept in the reliability domain

**Alternatives / Comparisons:**
- [[SYD-015 - The System Design Interview Mental Model]] - Procedural complement to this structural map
- [[SYD-075 - Trade-off Navigation Framework]] - Advanced cross-domain trade-off reasoning
...
║               security                    ║
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-010: Vertical Scaling   ║
╚══════════════════════════════════════════╝
```
