...
difficulty: ★★★
depends_on: SYD-018, SYD-022
used_by:
related: SYD-039, SYD-018, SYD-051
tags:
  - distributed
  - advanced
  - architecture
...
- [[SYD-022 - Redundancy Failover]] - the broader pattern that active-active implements
- [[SYD-018 - Load Balancing]] - distributes traffic across both active nodes

**Builds On This (learn these next):**
- [[SYD-051 - Geo-Replication]] - data synchronisation strategy for active-active regions
- [[SYD-052 - Multi-Region Architecture]] - full multi-region design using active-active

**Alternatives / Comparisons:**
- [[SYD-039 - Active-Passive]] - simpler; one node waits as standby, no conflict resolution
- [[SYD-022 - Redundancy Failover]] - broader pattern; active-active is one implementation
