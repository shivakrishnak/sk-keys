...
difficulty: ★★★
depends_on: SYD-054, SYD-055
used_by:
related: SYD-057, SYD-060, SYD-062
tags:
  - architecture
  - pattern
  - mental-model
...
- [[SYD-054 - System Evolution Strategy]] - how patterns change
- [[SYD-055 - Platform Architecture Design]] - where patterns
  get extracted to
...
| NEXT EXPLORE  | SYD-057 Theoretical Foundations           |
+-----------------------------------------------------------+
```
