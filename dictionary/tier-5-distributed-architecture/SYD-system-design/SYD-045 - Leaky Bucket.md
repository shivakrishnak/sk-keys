...
difficulty: ★★★
depends_on: SYD-041, SYD-054
used_by: SYD-064
related: SYD-041, SYD-054, SYD-064
tags:
  - rate-limiting
  - algorithm
  - advanced
...
- [[SYD-041 - Rate Limiting (System)]] - The problem class leaky bucket addresses
- [[SYD-054 - Token Bucket]] - The complementary admission control algorithm

**Builds On This (learn these next):**
- [[SYD-064 - Rate Limiter Design]] - Full system design incorporating both algorithms
- [[SYD-023 - Push vs Pull Architecture]] - Related pattern for producer-consumer flow control

**Alternatives / Comparisons:**
- [[SYD-054 - Token Bucket]] - Allows burst pass-through; lower latency; weaker downstream guarantee
- [[SYD-041 - Rate Limiting (System)]] - Overview of all rate limiting strategies
