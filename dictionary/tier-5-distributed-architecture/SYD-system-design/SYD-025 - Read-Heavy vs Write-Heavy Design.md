...
difficulty: ★★☆
depends_on: SYD-035, SYD-016
used_by: SYD-058, SYD-059, SYD-044
related: SYD-058, SYD-059, SYD-011
tags:
  - architecture
  - database
  - performance
...
# SYD-042 - Read-Heavy vs Write-Heavy Design
...
| :-------------- | :----------------------------- | :-------------- |
| **Depends on:** | SYD-035, SYD-016               |                 |
| **Used by:**    | SYD-058, SYD-059, SYD-044      |                 |
| **Related:**    | SYD-058, SYD-059, SYD-011      |                 |
...
- [[SYD-035 - How to Approach Any System Design Problem]] - Read/write classification is part of Phase 1
- [[SYD-016 - Estimation and Back-of-Envelope Thinking]] - Estimate read/write ratio at Phase 2

**Builds On This (learn these next):**
- [[SYD-058 - Denormalization for Scale]] - Read-heavy optimization technique
- [[SYD-059 - Fan-Out on Write vs Read]] - Core trade-off in write-heavy social systems

**Alternatives / Comparisons:**
- [[SYD-011 - Horizontal Scaling]] - The scaling response based on read/write diagnosis
...
║               < 1:10 = LSM-tree DB        ║
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-058: Denormalization    ║
╚══════════════════════════════════════════╝
```
