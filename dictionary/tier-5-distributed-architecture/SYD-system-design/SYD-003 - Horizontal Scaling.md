...
difficulty: ★☆☆
depends_on: SYD-010, SYD-018
used_by: SYD-037
related: SYD-010, SYD-018, SYD-037, SYD-029
tags:
  - performance
  - foundational
  - distributed
...
- [[SYD-010 - Vertical Scaling]] - the single-machine approach; understand before comparing to horizontal
- [[SYD-018 - Load Balancing]] - the infrastructure that makes horizontal scaling possible

**Builds On This (learn these next):**
- [[SYD-037 - Auto Scaling]] - automate horizontal scaling based on metrics
- [[SYD-029 - Capacity Planning]] - forecast how many instances you need at each load level

**Alternatives / Comparisons:**
- [[SYD-010 - Vertical Scaling]] - opposite strategy; upgrade one machine instead of adding more
- [[SYD-041 - Rate Limiting (System)]] - protect the shared bottlenecks that horizontal scaling exposes
