...
depends_on: SYD-001
used_by: SYD-003
related: SYD-003, SYD-004, SYD-005
tags:
  - architecture
  - foundational
  - mental-model
...
| SYD-002         | Category: System Design    | Difficulty: ★★☆ |
| :-------------- | :------------------------- | :-------------- |
| **Depends on:** | SYD-001                    |                 |
| **Used by:**    | SYD-003                    |                 |
| **Related:**    | SYD-003, SYD-004, SYD-005  |                 |
...
- [[SYD-003 - How to Approach Any System Design Problem]] - Operationalising the mental model
- [[SYD-004 - Estimation and Back-of-Envelope Thinking]] - Step 2 of the framework in depth

**Alternatives / Comparisons:**
- [[SYD-005 - The System Design Ecosystem Map]] - The vocabulary you need before applying the framework
- [[SYD-062 - Trade-off Navigation Framework]] - Advanced trade-off analysis for senior roles
...
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-003: Approach any SDI   ║
╚══════════════════════════════════════════╝
```
