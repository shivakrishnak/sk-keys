...
difficulty: ★★★
depends_on: SYD-003, SYD-033, SYD-053
used_by:
...
- [[SYD-053 - Cost-Performance Trade-off Architecture]] - the cost
...
- [[SYD-061 - Scale Estimation Mental Model]] - how scale changes
...
+------------------------------------------+
| NEXT EXPLORE  | SYD-057, SYD-060, SYD-061|
+------------------------------------------+
```
