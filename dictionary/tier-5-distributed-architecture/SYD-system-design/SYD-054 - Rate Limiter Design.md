...
difficulty: ★★★
depends_on: SYD-041, SYD-054, SYD-055
used_by: SYD-067, SYD-068
related: SYD-041, SYD-054, SYD-060
tags:
  - architecture
  - security
  - reliability
...
| SYD-064         | Category: System Design        | Difficulty: ★★★ |
| :-------------- | :----------------------------- | :-------------- |
| **Depends on:** | SYD-041, SYD-054, SYD-055     |                 |
...
- [[SYD-041 - Rate Limiting (System)]] - the concept; this entry covers the full system design
- [[SYD-054 - Token Bucket]] - the primary algorithm for smooth rate limiting
- [[SYD-055 - Leaky Bucket]] - alternative algorithm for strict rate enforcement

**Builds On This (learn these next):**
- [[SYD-060 - Distributed Locks]] - used in rate limiter critical sections
- [[SYD-067 - Notification System Design]] - applies rate limiting to notification sends

**Alternatives / Comparisons:**
- [[SYD-060 - Distributed Locks]] - heavier alternative for per-user serialization
...
├──────────────┼──────────────────────────────────┤
│ NEXT EXPLORE │ SYD-065 News Feed Design         │
└─────────────────────────────────────────────────┘
```
