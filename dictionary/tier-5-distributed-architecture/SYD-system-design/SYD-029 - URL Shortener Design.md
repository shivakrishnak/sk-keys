...
difficulty: ★★☆
depends_on: SYD-063, SYD-029
used_by: SYD-064
related: SYD-064, SYD-041, SYD-049
tags:
  - architecture
  - design
  - intermediate
...
- [[SYD-029 - Capacity Planning]] - estimate read/write QPS before designing
- [[SYD-063 - Data Partitioning Strategies]] - shard mappings table when it grows large

**Builds On This (learn these next):**
- [[SYD-064 - Rate Limiter Design]] - protect the create endpoint from abuse
- [[SYD-041 - Rate Limiting (System)]] - complementary protection layer

**Alternatives / Comparisons:**
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - distribute redirect service across nodes
...
├──────────────┼──────────────────────────────────┤
│ NEXT EXPLORE │ SYD-064 Rate Limiter Design      │
└─────────────────────────────────────────────────┘
```
