...
difficulty: ★★☆
depends_on: SYD-001, SYD-015
used_by: SYD-044, SYD-064, SYD-065
related: SYD-015, SYD-016, SYD-017
tags:
  - architecture
  - foundational
  - mental-model
...
# SYD-035 - How to Approach Any System Design Problem
...
| :-------------- | :----------------------------------- | :-------------- |
| **Depends on:** | SYD-001, SYD-015                     |                 |
| **Used by:**    | SYD-044, SYD-064, SYD-065            |                 |
| **Related:**    | SYD-015, SYD-016, SYD-017            |                 |
...
- [[SYD-015 - The System Design Interview Mental Model]] - The interview-specific version of this approach

**Builds On This (learn these next):**
- [[SYD-016 - Estimation and Back-of-Envelope Thinking]] - Phase 2 in depth
- [[SYD-044 - URL Shortener Design]] - Applying the approach to a concrete problem
- [[SYD-065 - News Feed Design]] - A more complex application

**Alternatives / Comparisons:**
- [[SYD-017 - The System Design Ecosystem Map]] - The vocabulary map that complements this approach
- [[SYD-075 - Trade-off Navigation Framework]] - Deep-dive into Phase 6
...
║               offs                        ║
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-016: Estimation         ║
╚══════════════════════════════════════════╝
```
