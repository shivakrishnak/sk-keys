...
depends_on: SYD-050
used_by: SYD-052
related: SYD-052, SYD-028, SYD-050
tags:
  - distributed
  - advanced
  - reliability
...
- [[SYD-050 - Disaster Recovery]] - overall strategy; geo-replication is the data layer for cross-region DR

**Builds On This (learn these next):**
- [[SYD-052 - Multi-Region Architecture]] - deployment pattern that uses geo-replication

**Alternatives / Comparisons:**
- [[SYD-052 - Multi-Region Architecture]] - broader deployment pattern
- [[SYD-028 - Active-Active]] - can be implemented with geo-replication as the data layer
