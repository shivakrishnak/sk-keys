...
depends_on: SYD-018
used_by: SYD-020
related: SYD-020, SYD-018, SYD-011
tags:
  - intermediate
  - architecture
  - pattern
...
- [[SYD-018 - Load Balancing]] - the context where stickiness is configured

**Builds On This (learn these next):**
- [[SYD-020 - Session Affinity]] - related concept; affinity is the mechanism, stickiness is the policy
- [[SYD-011 - Horizontal Scaling]] - horizontal scaling works best when stickiness is eliminated

**Alternatives / Comparisons:**
- [[SYD-020 - Session Affinity]] - often used synonymously; affinity is more general
- [[SYD-011 - Horizontal Scaling]] - true horizontal scalability requires stateless design, not stickiness
