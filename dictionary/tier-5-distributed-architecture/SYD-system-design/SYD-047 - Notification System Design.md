...
difficulty: ★★★
depends_on: SYD-037, SYD-044, SYD-038
used_by: SYD-051
related: SYD-037, SYD-048, SYD-035
tags:
  - architecture
  - design
  - advanced
...
| SYD-047         | Category: System Design         | Difficulty: ★★★ |
| :-------------- | :------------------------------ | :-------------- |
| **Depends on:** | SYD-037, SYD-044, SYD-038      |                 |
| **Used by:**    | SYD-051                         |                 |
| **Related:**    | SYD-037, SYD-048, SYD-035      |                 |
...
- [[SYD-037 - Polling vs Webhooks]] - delivery mechanism context
- [[SYD-038 - Idempotency Key]] - critical for preventing duplicate notifications
- [[SYD-044 - Rate Limiter Design]] - rate limiting notification sends

**Builds On This (learn these next):**
- [[SYD-048 - Chat System Design]] - real-time messaging vs async notifications
- [[SYD-051 - System Design at Hyperscale]] - notification at billion-user scale

**Alternatives / Comparisons:**
- [[SYD-035 - Fan-Out on Write vs Read]] - fan-out strategy applies to notifications too
...
├──────────────┼──────────────────────────────────┤
│ NEXT EXPLORE │ SYD-048 Chat System Design       │
└─────────────────────────────────────────────────┘
```
