...
difficulty: ★★★
depends_on: SYD-042, SYD-058
used_by: SYD-065, SYD-067
related: SYD-058, SYD-023, SYD-065
tags:
  - architecture
  - distributed
  - advanced
...
# SYD-059 - Fan-Out on Write vs Read
...
| :-------------- | :-------------------------- | :-------------- |
| **Depends on:** | SYD-042, SYD-058            |                 |
| **Used by:**    | SYD-065, SYD-067            |                 |
| **Related:**    | SYD-058, SYD-023, SYD-065   |                 |
...
- [[SYD-042 - Read-Heavy vs Write-Heavy Design]] - Fan-out is the core read/write trade-off of social feeds
- [[SYD-058 - Denormalization for Scale]] - Fan-out on write is a form of denormalization

**Builds On This (learn these next):**
- [[SYD-065 - News Feed Design]] - End-to-end system design applying this pattern
- [[SYD-067 - Notification System Design]] - Related fanout pattern for notifications

**Alternatives / Comparisons:**
- [[SYD-023 - Push vs Pull Architecture]] - The generalised version of this pattern
...
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-023: Push vs Pull       ║
╚══════════════════════════════════════════╝
```
