...
difficulty: ★★★
depends_on: SYD-042
used_by: SYD-059, SYD-065
related: SYD-056, SYD-042, SYD-059
tags:
  - database
  - performance
  - advanced
...
# SYD-058 - Denormalization for Scale
...
- [[SYD-042 - Read-Heavy vs Write-Heavy Design]] - Denormalization is a read-heavy optimisation technique

**Builds On This (learn these next):**
- [[SYD-059 - Fan-Out on Write vs Read]] - The fan-out problem that arises from denormalization at scale
- [[SYD-065 - News Feed Design]] - Real-world system that uses heavy denormalization

**Alternatives / Comparisons:**
- [[SYD-056 - Sharding (System)]] - Alternative scale strategy that may not require denormalization
