...
difficulty: ★★★
depends_on: SYD-001, SYD-071, SYD-008
used_by: SYD-031
related: SYD-032, SYD-074, SYD-075
tags:
  - distributed
  - architecture
  - first-principles
...
| :-------------- | :------------------------------- | :-------------- |
| **Depends on:** | SYD-001, SYD-071, SYD-008        |                 |
| **Used by:**    | SYD-031                          |                 |
| **Related:**    | SYD-032, SYD-074, SYD-075        |                 |
...
- [[SYD-071 - System Design at Hyperscale]] - where these
  laws become practical constraints

**Builds On This (learn these next):**
- [[SYD-031 - Formal Capacity Planning Models]] - applying
...
| NEXT EXPLORE  | SYD-031 Formal Capacity Planning Models    |
+-----------------------------------------------------------+
```
