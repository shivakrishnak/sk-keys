...
difficulty: ★★☆
depends_on: SYD-022, SYD-018
used_by:
related: SYD-028, SYD-022, SYD-050
tags:
  - reliability
  - intermediate
  - architecture
...
- [[SYD-022 - Redundancy Failover]] - the broader pattern that active-passive implements
- [[SYD-018 - Load Balancing]] - routes traffic away from the failed primary

**Builds On This (learn these next):**
- [[SYD-050 - Disaster Recovery]] - active-passive across regions is the basis for DR

**Alternatives / Comparisons:**
- [[SYD-028 - Active-Active]] - more complex but better resource utilisation and no failover time
- [[SYD-050 - Disaster Recovery]] - larger-scale version of active-passive across regions
