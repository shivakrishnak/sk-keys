...
- [[SYD-021 - SLA SLO SLI]] - error budget is derived from SLO

**Builds On This (learn these next):**
- [[SYD-038 - MTTR MTBF]] - incident recovery time affects error budget burn rate

**Alternatives / Comparisons:**
- [[SYD-038 - MTTR MTBF]] - MTTR/MTBF determine the burn rate from incidents
- [[SYD-021 - SLA SLO SLI]] - error budget is derived from these and feeds back into them
