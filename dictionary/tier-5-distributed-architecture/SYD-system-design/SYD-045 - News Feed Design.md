...
difficulty: ★★★
depends_on: SYD-035, SYD-042
used_by: SYD-051
related: SYD-035, SYD-034, SYD-023
tags:
  - architecture
  - design
  - advanced
...
| SYD-045         | Category: System Design       | Difficulty: ★★★ |
| :-------------- | :---------------------------- | :-------------- |
| **Depends on:** | SYD-035, SYD-042              |                 |
| **Used by:**    | SYD-051                       |                 |
| **Related:**    | SYD-035, SYD-034, SYD-023    |                 |
...
- [[SYD-035 - Fan-Out on Write vs Read]] - the fundamental algorithmic choice
- [[SYD-042 - Data Partitioning Strategies]] - partitioning the feed cache and post store

**Builds On This (learn these next):**
- [[SYD-051 - System Design at Hyperscale]] - extends this to billion-user scale
- [[SYD-046 - Search Autocomplete Design]] - another read-heavy system design

**Alternatives / Comparisons:**
- [[SYD-034 - Denormalization for Scale]] - related technique of pre-computing read views
...
├──────────────┼──────────────────────────────────┤
│ NEXT EXPLORE │ SYD-046 Search Autocomplete      │
└─────────────────────────────────────────────────┘
```
