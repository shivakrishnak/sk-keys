...
difficulty: ★★★
depends_on: SYD-001, SYD-035, SYD-071
used_by:
related: SYD-008, SYD-030, SYD-075
tags:
  - architecture
  - production
  - mental-model
...
# SYD-073 - System Design Research and Case Studies
...
| SYD-073         | Category: System Design          | Difficulty: ★★★ |
| :-------------- | :------------------------------- | :-------------- |
| **Depends on:** | SYD-001, SYD-035, SYD-071        |                 |
| **Used by:**    |                                  |                 |
| **Related:**    | SYD-008, SYD-030, SYD-075        |                 |
...
- [[SYD-071 - System Design at Hyperscale]] - understanding
  the scale context of hyperscale case studies

**Builds On This (learn these next):**
- [[SYD-075 - Trade-off Navigation Framework]] - applying
