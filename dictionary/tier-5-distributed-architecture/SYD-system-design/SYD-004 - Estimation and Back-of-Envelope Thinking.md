...
difficulty: ★★☆
depends_on: SYD-001
used_by: SYD-003, SYD-027
related: SYD-003, SYD-026, SYD-027
tags:
  - architecture
  - foundational
  - mental-model
...
| SYD-004         | Category: System Design     | Difficulty: ★★☆ |
| :-------------- | :-------------------------- | :-------------- |
| **Depends on:** | SYD-001                     |                 |
| **Used by:**    | SYD-003, SYD-027            |                 |
| **Related:**    | SYD-003, SYD-026, SYD-027   |                 |
...
- [[SYD-003 - How to Approach Any System Design Problem]] - Where estimation fits in the design process

**Builds On This (learn these next):**
- [[SYD-026 - Back-of-Envelope Estimation]] - Extended estimation reference with more examples
- [[SYD-027 - Capacity Planning]] - Formal capacity planning building on BOE

**Alternatives / Comparisons:**
- [[SYD-006 - Vertical Scaling]] - One architectural response to under-provisioned estimates
- [[SYD-007 - Horizontal Scaling]] - The response when vertical scaling is insufficient
...
║               = req/sec baseline          ║
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-027: Capacity Planning  ║
╚══════════════════════════════════════════╝
```
