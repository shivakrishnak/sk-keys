...
depends_on: SYD-056
used_by:
related: SYD-056, SYD-049, SYD-053
tags:
  - database
  - distributed
  - antipattern
...
- [[SYD-056 - Sharding (System)]] - Hot shard is the primary failure mode of sharding

**Builds On This (learn these next):**
- [[SYD-053 - Thundering Herd]] - The retry storm amplification of hot shard incidents
- [[SYD-049 - Consistent Hashing (Load Balancing)]] - Consistent hashing reduces hot shard probability

**Alternatives / Comparisons:**
- [[SYD-063 - Data Partitioning Strategies]] - Alternative partitioning approaches that avoid hot shards
...
╠══════════════════════════════════════════╣
║ NEXT EXPLORE  SYD-042: Read vs Write      ║
╚══════════════════════════════════════════╝
```
