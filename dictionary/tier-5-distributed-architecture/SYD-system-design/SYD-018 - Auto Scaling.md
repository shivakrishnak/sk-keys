...
difficulty: ★★☆
depends_on: SYD-011, SYD-018, SYD-029
used_by:
related: SYD-029, SYD-018, SYD-011
tags:
  - cloud
  - performance
  - intermediate
...
- [[SYD-011 - Horizontal Scaling]] - the underlying technique that auto-scaling automates
- [[SYD-018 - Load Balancing]] - required to distribute traffic to new instances
- [[SYD-029 - Capacity Planning]] - forecasting to set auto-scaling parameters correctly

**Builds On This (learn these next):**
- [[SYD-053 - Thundering Herd]] - failure mode that auto-scaling can trigger or amplify

**Alternatives / Comparisons:**
- [[SYD-010 - Vertical Scaling]] - manual alternative; scale up one machine instead of out
- [[SYD-029 - Capacity Planning]] - complementary: forecasting replaces reactive scaling for predictable load
