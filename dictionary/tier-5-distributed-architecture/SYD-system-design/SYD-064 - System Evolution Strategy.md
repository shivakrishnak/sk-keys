...
difficulty: ★★★
depends_on: SYD-001, SYD-035, SYD-017
used_by: SYD-007, SYD-008
related: SYD-071, SYD-032, SYD-075
tags:
  - architecture
  - pattern
  - bestpractice
...
# SYD-006 - System Evolution Strategy
...
| SYD-006         | Category: System Design          | Difficulty: ★★★ |
| :-------------- | :------------------------------- | :-------------- |
| **Depends on:** | SYD-001, SYD-035, SYD-017        |                 |
| **Used by:**    | SYD-007, SYD-008                 |                 |
| **Related:**    | SYD-071, SYD-032, SYD-075        |                 |
...
- [[SYD-035 - How to Approach Any System Design Problem]] -
  structured thinking
- [[SYD-017 - The System Design Ecosystem Map]] - understanding
  the full landscape

**Builds On This (learn these next):**
- [[SYD-007 - Platform Architecture Design]] - large-scale
  system evolution at platform level
- [[SYD-008 - Emergent Architecture Patterns]] - patterns that
...
| NEXT EXPLORE  | SYD-008 Emergent Architecture Patterns     |
+-----------------------------------------------------------+
```
