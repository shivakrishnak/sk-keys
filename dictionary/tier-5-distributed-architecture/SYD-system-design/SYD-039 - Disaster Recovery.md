...
difficulty: ★★★
depends_on: SYD-027, SYD-022
used_by: SYD-051, SYD-052
related: SYD-027, SYD-051
tags:
  - reliability
  - advanced
  - distributed
...
- [[SYD-027 - RTO RPO]] - the metrics that define what disaster recovery must achieve
- [[SYD-022 - Redundancy Failover]] - smaller-scale failover that DR extends to cross-region

**Builds On This (learn these next):**
- [[SYD-051 - Geo-Replication]] - data replication strategy for cross-region DR
- [[SYD-052 - Multi-Region Architecture]] - full multi-region design that includes DR capability

**Alternatives / Comparisons:**
- [[SYD-027 - RTO RPO]] - the metrics that define DR targets
- [[SYD-022 - Redundancy Failover]] - single-region version of the same pattern
