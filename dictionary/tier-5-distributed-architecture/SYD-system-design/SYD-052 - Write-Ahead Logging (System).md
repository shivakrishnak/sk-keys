...
difficulty: ★★★
depends_on: SYD-061, SYD-060
used_by: SYD-063, SYD-051
related: SYD-061, SYD-024, SYD-063
tags:
  - distributed
  - database
  - reliability
...
# SYD-062 - Write-Ahead Logging (System)
...
| SYD-062         | Category: System Design         | Difficulty: ★★★ |
| :-------------- | :------------------------------ | :-------------- |
| **Depends on:** | SYD-061, SYD-060                |                 |
| **Used by:**    | SYD-063, SYD-051                |                 |
| **Related:**    | SYD-061, SYD-024, SYD-063      |                 |
...
- [[SYD-061 - Leader-Follower Pattern]] - WAL is the replication mechanism in leader-follower
- [[SYD-060 - Distributed Locks]] - WAL operations require ordering guarantees locks provide

**Builds On This (learn these next):**
- [[SYD-063 - Data Partitioning Strategies]] - WAL per shard enables distributed WAL
- [[SYD-051 - Geo-Replication]] - WAL shipping across regions is the foundation

**Alternatives / Comparisons:**
- [[SYD-024 - Idempotency Key]] - application-level durability alternative for event processing
...
├──────────────┼──────────────────────────────────┤
│ NEXT EXPLORE │ SYD-063 Data Partitioning        │
└─────────────────────────────────────────────────┘
```
