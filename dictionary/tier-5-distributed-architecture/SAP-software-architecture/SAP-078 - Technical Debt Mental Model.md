...
difficulty: ★★★
depends_on: SAP-002, SAP-056, SAP-044
used_by: SAP-025, SAP-026, SAP-081
related: SAP-082, SAP-029, SAP-024
tags:
  - architecture
  - advanced
  - mental-model
...
|:---|:---|:---|
| **Depends on:** | SAP-002, SAP-056, SAP-044 | |
| **Used by:** | SAP-025, SAP-026, SAP-081 | |
| **Related:** | SAP-082, SAP-029, SAP-024 | |
...
- [[SAP-056 - Architecture Decision Record (ADR)]] - the tool for tracking intentional debt
- [[SAP-044 - SOLID Principles]] - the design principles whose violation creates structural debt

**Builds On This (learn these next):**
- [[SAP-025 - Legacy Modernization Strategy]] - applying this model to real legacy systems
- [[SAP-026 - Architecture Fitness Functions]] - automated debt detection
- [[SAP-081 - Evolutionary Architecture Design]] - designing to minimise debt accumulation

**Alternatives / Comparisons:**
- [[SAP-082 - Architecture Trade-off Framing]] - broader trade-off model (debt is one type)
- [[SAP-029 - Architecture Necessity Assessment]] - deciding which debt to incur deliberately
