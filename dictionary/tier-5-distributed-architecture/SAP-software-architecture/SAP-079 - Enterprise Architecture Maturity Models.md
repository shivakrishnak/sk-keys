...
difficulty: ★★★
depends_on: SAP-051, SAP-013, SAP-014, SAP-015
used_by: SAP-085
related: SAP-027, SAP-026, SAP-037
tags:
  - architecture
  - advanced
  - bestpractice
...
| SAP-084 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-051, SAP-013, SAP-014, SAP-015 | |
| **Used by:** | SAP-085 | |
| **Related:** | SAP-027, SAP-026, SAP-037 | |
...
- SAP-026 - Architecture Fitness Functions (automated maturity measurement)
...
║ NEXT EXPLORE  SAP-085 EA Programme Design        ║
╚══════════════════════════════════════════════════╝
```
