...
difficulty: ★★★
depends_on: SAP-034, SAP-039, SAP-013
used_by: SAP-056, SAP-061, SAP-064
related: SAP-034, SAP-039, SAP-064
tags:
  - architecture
  - advanced
  - pattern
...
| SAP-055 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-034, SAP-039, SAP-013 | |
| **Used by:** | SAP-056, SAP-061, SAP-064 | |
| **Related:** | SAP-034, SAP-039, SAP-064 | |
...
- SAP-034 - Anti-Corruption Layer (ACL is a tool within modernisation strategy)
- SAP-061 - Evolutionary Architecture (broader continuous evolution approach)
...
+----------------------------------------------------------+
| NEXT EXPLORE   | SAP-034, SAP-056, SAP-061               |
+----------------------------------------------------------+
```
