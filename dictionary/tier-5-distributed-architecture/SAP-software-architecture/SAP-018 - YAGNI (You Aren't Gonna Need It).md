...
difficulty: ★★☆
depends_on: SAP-044, SAP-036
used_by: 
related: SAP-044, SAP-035, SAP-036
tags:
  - architecture
  - principles
  - pattern
...
# SAP-045 - YAGNI (You Aren't Gonna Need It)
...
- SAP-044 - SOLID Principles (OCP encourages extensibility; YAGNI counterbalances it by asking "do we actually need this extension point yet?")
- SAP-036 - KISS (closely related: KISS prevents unnecessary complexity in implementation; YAGNI prevents unnecessary implementation entirely; they are complementary restraint principles)

**Builds On This (learn these next):**

- SAP-035 - DRY (related to YAGNI: DRY prevents knowledge duplication, YAGNI prevents speculative features; understanding both together defines the scope of what to build and how to build it)
- SAP-036 - KISS (complement: YAGNI = don't build what you don't need; KISS = don't make what you do build more complex than necessary)

**Alternatives / Comparisons:**

- SAP-036 - KISS (YAGNI and KISS are different but complementary; YAGNI is about feature scope, KISS is about implementation complexity; both are restraint principles against over-engineering)
