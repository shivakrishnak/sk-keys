...
related: SAP-051, SAP-013, SAP-015
tags:
  - architecture
  - intermediate
  - mental-model
...
| SAP-014 | Category: Software Architecture Patterns | Difficulty: ★★☆ |
|:---|:---|:---|
...
- SAP-015 - ArchiMate (the modelling language for filling Zachman cells)

**Alternatives / Comparisons:**
- SAP-051 - TOGAF Framework (process vs classification)
- SAP-013 - TOGAF ADM (process that Zachman lacks)
...
║ NEXT EXPLORE  SAP-051 TOGAF, SAP-015 ArchiMate   ║
╚══════════════════════════════════════════════════╝
```
