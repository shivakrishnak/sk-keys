...
difficulty: ★★★
depends_on: SAP-023, SAP-024, SAP-026
used_by: SAP-081
related: SAP-023, SAP-026, SAP-029
tags:
  - architecture
  - advanced
  - governance
...
| SAP-027 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-023, SAP-024, SAP-026 | |
| **Used by:** | SAP-081 | |
| **Related:** | SAP-023, SAP-026, SAP-029 | |
...
- SAP-026 - Architecture Fitness Functions (automated component of governance)
- SAP-023 - ADR Strategy (documentation component of governance)
...
+----------------------------------------------------------+
| NEXT EXPLORE   | SAP-026, SAP-081, SAP-029               |
+----------------------------------------------------------+
```
