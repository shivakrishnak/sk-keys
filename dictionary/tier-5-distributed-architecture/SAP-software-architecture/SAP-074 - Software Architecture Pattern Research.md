...
difficulty: ★★★
depends_on: SAP-079, SAP-003, SAP-001
used_by: SAP-081
related: SAP-079, SAP-081, SAP-082
tags:
  - architecture
  - advanced
  - pattern
...
| SAP-080 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-079, SAP-003, SAP-001 | |
| **Used by:** | SAP-081 | |
| **Related:** | SAP-079, SAP-081, SAP-082 | |
...
- SAP-079 - Architecture Theory (foundational theory enabling pattern research)
...
+----------------------------------------------------------+
| NEXT EXPLORE   | SAP-081, SAP-082, PoEAA, EIP catalogues |
+----------------------------------------------------------+
```
