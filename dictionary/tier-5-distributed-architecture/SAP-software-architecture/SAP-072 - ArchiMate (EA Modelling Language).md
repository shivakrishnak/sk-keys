...
difficulty: ★★☆
depends_on: SAP-066, SAP-069
used_by: SAP-073, SAP-074
related: SAP-058, SAP-071, SAP-070
tags:
  - architecture
  - intermediate
  - pattern
...
| SAP-072 | Category: Software Architecture Patterns | Difficulty: ★★☆ |
|:---|:---|:---|
| **Depends on:** | SAP-066, SAP-069 | |
...
- SAP-071 - Zachman Framework (classification vs notation)
- SAP-069 - TOGAF Framework (process that ArchiMate supports)
...
║ NEXT EXPLORE  SAP-073 EA Maturity, SAP-074 EA    ║
║               Programme Design                  ║
╚══════════════════════════════════════════════════╝
```
