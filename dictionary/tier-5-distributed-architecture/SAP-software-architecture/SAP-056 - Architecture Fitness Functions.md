...
difficulty: ★★★
depends_on: SAP-002, SAP-006, SAP-053
used_by: SAP-057, SAP-061
related: SAP-053, SAP-054, SAP-061
tags:
  - architecture
  - advanced
  - bestpractice
...
| SAP-056 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-002, SAP-006, SAP-053 | |
| **Used by:** | SAP-057, SAP-061 | |
| **Related:** | SAP-053, SAP-054, SAP-061 | |
...
- SAP-054 - Architecture Review Process Design (human-led review vs automated)
...
+----------------------------------------------------------+
| NEXT EXPLORE   | SAP-057, SAP-061, TST-001               |
+----------------------------------------------------------+
```
