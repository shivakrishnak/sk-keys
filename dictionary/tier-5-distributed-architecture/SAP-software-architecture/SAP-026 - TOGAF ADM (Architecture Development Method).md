...
difficulty: ★★☆
depends_on: SAP-051, SAP-050
used_by: SAP-084, SAP-085
related: SAP-038, SAP-049, SAP-057
tags:
  - architecture
  - intermediate
  - pattern
...
| SAP-013 | Category: Software Architecture Patterns | Difficulty: ★★☆ |
|:---|:---|:---|
| **Depends on:** | SAP-051, SAP-050 | |
...
- SAP-014 - Zachman Framework (what to describe, not how to develop)
- SAP-025 - Legacy Modernization Strategy (applies ADM to legacy context)
...
║ NEXT EXPLORE  SAP-014 Zachman, SAP-084 EA Maturity║
╚══════════════════════════════════════════════════╝
```
...
*Hint:* Compare how Architecture Fitness Functions (SAP-026) provide a continuous automated form of Phase G governance, and how "Architecture as Code" practices enable Phase D Technology Architecture to be expressed as infrastructure code that delivery teams use directly.