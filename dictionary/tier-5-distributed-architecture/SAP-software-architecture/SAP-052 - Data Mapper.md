...
difficulty: ★★★
depends_on: SAP-040, SAP-065
used_by: SAP-040, SAP-020
...
| Field          | Value            |
| -------------- | ---------------- |
| **Depends on** | SAP-040, SAP-065 |
| **Used by**    | SAP-040, SAP-020 |
| **Related**    | SAP-040, SAP-042 |
...
- SAP-040 - Repository Pattern (the interface that sits in front of the Data Mapper; understanding Repository explains the separation: Repository defines WHAT operations are available, Data Mapper defines HOW they are implemented)
- SAP-065 - Domain Model (Data Mapper exists to decouple the domain model from persistence; understanding what a domain model is and why it should know nothing about SQL is the motivation for Data Mapper)

**Builds On This (learn these next):**

- SAP-040 - Repository Pattern (repositories use Data Mapper internally; learning Repository shows the full persistence pattern stack)
- SAP-020 - Unit of Work Pattern (coordinates multiple Data Mapper operations into a single atomic transaction; Hibernate's Session is an implementation of both Data Mapper and Unit of Work)

**Alternatives / Comparisons:**

- SAP-042 - Active Record (simpler; domain object manages its own persistence; correct for data-centric apps; wrong for complex domains)
- SAP-040 - Repository Pattern (complementary; Repository is the interface, Data Mapper is the implementation; not alternatives but collaborators)
