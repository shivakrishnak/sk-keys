...
difficulty: ★★☆
depends_on: SAP-037, SAP-038, SAP-049
used_by: SAP-051, SAP-013, SAP-025
related: SAP-057, SAP-023, SAP-026
tags:
  - architecture
  - intermediate
  - bestpractice
...
| SAP-050 | Category: Software Architecture Patterns | Difficulty: ★★☆ |
|:---|:---|:---|
| **Depends on:** | SAP-037, SAP-038, SAP-049 | |
| **Used by:** | SAP-051, SAP-013, SAP-025 | |
| **Related:** | SAP-057, SAP-023, SAP-026 | |
...
Start from business strategy and capability gaps (SAP-049). Define the target across the same BDAT domains. The To-Be should be specific enough to be actionable but not so detailed that it becomes a design specification (design is done during implementation).
...
- SAP-051 - TOGAF Framework (formalises As-Is/To-Be as part of ADM)
- SAP-025 - Legacy Modernization Strategy (As-Is/To-Be applied to legacy)
- SAP-057 - Technology Roadmap

**Alternatives / Comparisons:**
- SAP-023 - Architecture Decision Records (ADR) Strategy (captures decisions, not states)
- SAP-026 - Architecture Fitness Functions (validates current state against target)
...
║                there?"                           ║
║ NEXT EXPLORE  SAP-051 TOGAF formalises this      ║
╚══════════════════════════════════════════════════╝
```
