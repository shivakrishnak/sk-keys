...
# SAP-061 - Loose Coupling of Frontend Modules
...
- SAP-048 - Coupling (the foundational concept this entry applies to the frontend module context)
- SAP-012 - Cohesion (the complementary principle; high cohesion within modules enables loose coupling between them)

**Builds On This (learn these next):**

- SAP-062 - Micro-Frontend Architecture (the organisational application of loose coupling at team and deployment level)
- SAP-075 - Modular Monolith Patterns (how to achieve module boundary discipline in a single deployment unit)
