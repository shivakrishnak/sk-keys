...
difficulty: ★★★
depends_on: SAP-034, SAP-044
used_by: SAP-075
related: SAP-034, SAP-063, SAP-064, SAP-008
tags:
  - architecture
  - pattern
  - advanced
...
# SAP-007 - Vertical Slice Architecture
...
- SAP-034 - Layered Architecture (what Vertical Slice Architecture explicitly reacts against; understanding the problem makes the solution clear)
- SAP-044 - SOLID Principles (specifically Single Responsibility Principle applied at the feature/module level, not just the class level)

**Builds On This (learn these next):**

- SAP-075 - Modular Monolith Patterns (slices naturally evolve into modules; a modular monolith is VSA with enforced inter-module boundaries)
- SAP-008 - CQRS Pattern (the most common companion pattern; command slices handle writes, query slices handle reads)

**Alternatives / Comparisons:**

- SAP-034 - Layered Architecture (organises by technical tier instead of feature; preferred when teams are organised by technical specialty)
- SAP-064 - Clean Architecture (organises by dependency direction and ring; more prescriptive about cross-feature structure)
