...
difficulty: ★★★
depends_on: SAP-001, SAP-005, SAP-056
used_by: SAP-027, SAP-079
related: SAP-005, SAP-056, SAP-079
tags:
  - architecture
  - advanced
  - documentation
...
| SAP-028 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-001, SAP-005, SAP-056 | |
| **Used by:** | SAP-027, SAP-079 | |
| **Related:** | SAP-005, SAP-056, SAP-079 | |
...
- SAP-056 - Architecture Decision Record (ADR) (narrative complement to diagrams)
...
+----------------------------------------------------------+
| NEXT EXPLORE   | SAP-079, SAP-027, SAP-056               |
+----------------------------------------------------------+
```
