...
difficulty: ★★☆
depends_on: SAP-065, SAP-019, SAP-044
used_by: SAP-020
related: SAP-020, SAP-066, SAP-065
tags:
  - architecture
  - pattern
  - intermediate
...
| Field          | Value                     |
| -------------- | ------------------------- |
| **Depends on** | SAP-065, SAP-019, SAP-044 |
| **Used by**    | SAP-020                   |
| **Related**    | SAP-020, SAP-066, SAP-065 |
...
- SAP-065 - Domain Model (repositories return domain objects; you need a domain model before the repository has anything to return)
- SAP-019 - Ports and Adapters (Repository is a specific application of a driven port to database persistence; the domain defines the interface)
- SAP-044 - SOLID Principles (specifically the Dependency Inversion Principle; services depend on repository interfaces, not JPA implementations)

**Builds On This (learn these next):**

- SAP-020 - Unit of Work Pattern (coordinates multiple repository operations in a single atomic transaction)

**Alternatives / Comparisons:**

- SAP-066 - Data Mapper (a related but simpler pattern; maps between domain objects and database rows without the collection-like interface)
