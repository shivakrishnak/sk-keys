...
difficulty: ★★★
depends_on: SAP-044, SAP-047
used_by: 
related: SAP-008, SAP-047
tags:
  - architecture
  - principles
  - pattern
...
# SAP-009 - Command-Query Separation (CQS)
...
- SAP-044 - SOLID Principles (SRP at the method level: each method should have one purpose, either reading or writing; CQS is a specific application of SRP to method design)
- SAP-047 - Tell Don't Ask (TDA tells objects to perform behavior = commands; the CQS command/query distinction clarifies when to tell vs when it's acceptable to query)

**Builds On This (learn these next):**

- SAP-008 - CQRS (Command Query Responsibility Segregation: CQS at the architecture level; separate read models from write models; CQRS is the microservices-scale application of the CQS principle)

**Alternatives / Comparisons:**

- SAP-008 - CQRS (CQS at method level; CQRS at service/architecture level; the same invariant applied at different scales)
