...
used_by: SAP-068, SAP-069
related: SAP-023, SAP-010, SAP-057
tags:
  - architecture
  - intermediate
  - bestpractice
...
| SAP-067 | Category: Software Architecture Patterns | Difficulty: ★★☆ |
|:---|:---|:---|
| **Depends on:** | SAP-065, SAP-066 | |
| **Used by:** | SAP-068, SAP-069 | |
| **Related:** | SAP-023, SAP-010, SAP-057 | |
...
- SAP-023 - Domain Model (DDD-level capability modelling)
...
║ NEXT EXPLORE  SAP-068 As-Is/To-Be, SAP-069 TOGAF ║
╚══════════════════════════════════════════════════╝
```
