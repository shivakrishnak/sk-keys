...
difficulty: ★★★
depends_on: SAP-079, SAP-002, SAP-056
used_by: SAP-029
related: SAP-079, SAP-056, SAP-029
tags:
  - architecture
  - advanced
  - tradeoff
...
| SAP-082 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-079, SAP-002, SAP-056 | |
| **Used by:** | SAP-029 | |
| **Related:** | SAP-079, SAP-056, SAP-029 | |
...
- SAP-079 - Architecture Theory provides the quality attribute taxonomy for framing
- SAP-029 - Architecture Necessity Assessment applies trade-off framing to necessity questions
...
|                | costs + conditions.                     |
+----------------------------------------------------------+
| NEXT EXPLORE   | SAP-079, SAP-029, SAP-024               |
+----------------------------------------------------------+
```
