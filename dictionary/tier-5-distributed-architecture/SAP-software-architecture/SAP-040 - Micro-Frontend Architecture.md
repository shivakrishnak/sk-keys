...
difficulty: ★★★
depends_on: SAP-061, SAP-048
used_by: SAP-058
related: SAP-061, SAP-075, SAP-077
tags:
  - architecture
  - frontend
  - advanced
...
# SAP-062 - Micro-Frontend Architecture
...
- SAP-061 - Loose Coupling of Frontend Modules (the design principle that micro-frontends implement at deployment scale)
- SAP-048 - Coupling (the fundamental concept; understanding coupling is required to evaluate micro-frontend trade-offs)

**Builds On This (learn these next):**

- SAP-075 - Modular Monolith Patterns (the simpler alternative for teams not yet needing independent deployment)
- SAP-058 - Architecture Review (the process that evaluates whether micro-frontend complexity is justified for a given team context)
