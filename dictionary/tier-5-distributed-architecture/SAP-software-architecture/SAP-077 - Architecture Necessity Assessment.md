...
difficulty: ★★★
depends_on: SAP-082, SAP-001, SAP-045
used_by:
related: SAP-082, SAP-045, SAP-064
tags:
  - architecture
  - advanced
  - tradeoff
...
| SAP-029 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-082, SAP-001, SAP-045 | |
| **Used by:** | - | |
| **Related:** | SAP-082, SAP-045, SAP-064 | |
...
When an architectural component is proposed, ask: "What specific current problem does this solve? What happens if we don't have it?" If the answer is "nothing bad happens right now but might in the future," apply YAGNI (SAP-045): defer until needed.
...
- SAP-045 - YAGNI (design-level; necessity assessment is YAGNI applied to architecture)
- SAP-082 - Architecture Trade-off Framing (evaluating options; necessity assessment gates whether evaluation is even needed)
...
+----------------------------------------------------------+
| NEXT EXPLORE   | SAP-045, SAP-082, SAP-064               |
+----------------------------------------------------------+
```
