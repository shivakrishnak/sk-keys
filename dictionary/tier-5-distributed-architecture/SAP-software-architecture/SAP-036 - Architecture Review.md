...
difficulty: ★★★
depends_on: SAP-056, SAP-057, SAP-044, SAP-012, SAP-048
used_by: SAP-056, SAP-057
related: SAP-023, SAP-024, SAP-026, SAP-064
tags:
  - architecture
  - advanced
  - pattern
...
| Field          | Value                                       |
| -------------- | ------------------------------------------- |
| **Depends on** | SAP-056, SAP-057, SAP-044, SAP-012, SAP-048 |
| **Used by**    | SAP-056, SAP-057                            |
| **Related**    | SAP-023, SAP-024, SAP-026, SAP-064          |
...
- SAP-056 - Architecture Decision Record (ADR) (the primary input to reviews; understanding ADRs is required to evaluate review quality)
- SAP-012 - Cohesion and SAP-048 - Coupling (the metrics most frequently assessed during architecture review)

**Builds On This (learn these next):**

- SAP-024 - Architecture Review Process Design (how to design an effective review process at scale)
- SAP-026 - Architecture Fitness Functions (the automated continuous complement to periodic human reviews)
- SAP-027 - Architecture Governance at Scale (how reviews fit into the broader governance model)

**Alternatives / Comparisons:**

- SAP-026 - Architecture Fitness Functions (automated continuous variant; complements reviews for measurable constraints but cannot replace judgment for strategic assessment)
...
_Hint:_ Look at how architectural debt is formally managed in ISO/IEC 25010 quality model and how SAP-056 ADR format handles "accepted debt" with explicit revisit triggers - combining both gives you the documentation framework needed.
