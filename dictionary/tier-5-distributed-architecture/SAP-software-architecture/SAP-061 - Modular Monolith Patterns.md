...
difficulty: ★★★
depends_on: SAP-034, SAP-012, SAP-048
used_by:
related: SAP-061, SAP-062, SAP-076
tags:
  - architecture
  - pattern
  - deep-dive
...
| Field          | Value                     |
| -------------- | ------------------------- |
| **Depends on** | SAP-034, SAP-012, SAP-048 |
| **Used by**    | -                         |
| **Related**    | SAP-061, SAP-062, SAP-076 |
...
- SAP-034 - Layered Architecture (modular monolith is an evolution of layered architecture where the horizontal layers are replaced by vertical modules with their own layers)
- SAP-012 - Cohesion and SAP-048 - Coupling (the principles that define module boundaries; high cohesion within modules, low coupling between modules)

**Builds On This (learn these next):**

- SAP-061 - Loose Coupling of Frontend Modules (the frontend equivalent of Modular Monolith; same principles applied to JavaScript/TypeScript frontend module organization)
- SAP-062 - Micro-Frontend Architecture (the distributed form of Modular Monolith for frontends; understanding Modular Monolith first helps avoid premature micro-frontend adoption)
- SAP-076 - Plugin Architecture (a way to extend the modular monolith without modifying core modules)
...
- SAP-007 - Vertical Slice Architecture (complementary; vertical slices are an internal organization pattern within each module of a modular monolith)
