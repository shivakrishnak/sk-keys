...
- SAP-065 - Domain Model (value objects are the building blocks of domain models; understanding domain models provides the context for why typed domain values matter)
- SAP-044 - SOLID Principles (value object immutability follows from Single Responsibility and Open/Closed principles; understanding SOLID explains why value objects should not have setters)

**Builds On This (learn these next):**

- SAP-067 - Aggregate Root (aggregate roots use value objects as typed attributes for their internal state; value objects appear throughout aggregate design)
- SAP-043 - Entities (the complementary concept; understanding both value objects and entities together defines when identity matters and when it does not)

**Alternatives / Comparisons:**

- SAP-043 - Entities (the contrast; use an entity when identity matters and the object is tracked over time; use a value object when the concept is defined purely by its attributes)
