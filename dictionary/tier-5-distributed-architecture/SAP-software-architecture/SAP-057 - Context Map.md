...
difficulty: ★★★
depends_on: SAP-070, SAP-072, SAP-073
used_by: SAP-070, SAP-072, SAP-073
related: SAP-070, SAP-072, SAP-073, SAP-074
tags:
  - architecture
  - ddd
  - pattern
...
| Field          | Value                              |
| -------------- | ---------------------------------- |
| **Depends on** | SAP-070, SAP-072, SAP-073          |
| **Used by**    | SAP-070, SAP-072, SAP-073          |
| **Related**    | SAP-070, SAP-072, SAP-073, SAP-074 |
...
- SAP-070 - Anti-Corruption Layer (one of the core relationship patterns shown on a Context Map; understanding ACL is required to understand what the map is documenting when it shows an ACL relationship)
- SAP-072 - Shared Kernel (another core relationship pattern; understanding Shared Kernel and ACL gives you the two most important integration patterns the map documents)
- SAP-073 - Open Host Service (the third major pattern; a context map is largely a picture of which contexts use ACL, Shared Kernel, OHS, or other relationship patterns)

**Builds On This (learn these next):**

- SAP-070 - Anti-Corruption Layer (the Context Map shows WHERE ACLs are needed; ACL is the implementation of the "Protected" relationship shown on the map)
- SAP-072 - Shared Kernel (the Context Map shows where Shared Kernel exists; Shared Kernel requires governance to maintain)
- SAP-073 - Open Host Service (the Context Map shows which contexts publish OHS; the Published Language formalizes the contract)
