...
- SAP-012 - Cohesion (connascence within a single module is a cohesion concern; understanding cohesion provides the context for intra-module connascence analysis)
- SAP-048 - Coupling (connascence between modules is a coupling concern; understanding coupling types provides the foundation that connascence formalizes and extends)

**Builds On This (learn these next):**

- SAP-012 - Cohesion (after learning connascence types, cohesion analysis becomes more precise: high-strength connascence within a module signals low cohesion)
- SAP-048 - Coupling (connascence gives precise names to the coupling types described abstractly in coupling theory)

**Alternatives / Comparisons:**

- SAP-048 - Coupling (connascence is a formal extension of coupling analysis, not an alternative; use coupling taxonomy for high-level assessment, connascence for precise refactoring decisions)
