...
difficulty: ★★★
depends_on: SAP-058, SAP-023, SAP-056
used_by: SAP-027, SAP-026
related: SAP-058, SAP-023, SAP-082
tags:
  - architecture
  - advanced
  - governance
...
# SAP-024 - Architecture Review Process Design
...
| SAP-024 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-058, SAP-023, SAP-056 | |
| **Used by:** | SAP-027, SAP-026 | |
| **Related:** | SAP-058, SAP-023, SAP-082 | |
...
- [[SAP-058 - Architecture Review]] - the informal/ad-hoc predecessor
- [[SAP-056 - Architecture Decision Record (ADR)]] - the output artifact of every review
- [[SAP-023 - Architecture Decision Records (ADR) Strategy]] - the strategy layer above individual ADRs

**Builds On This (learn these next):**
- [[SAP-026 - Architecture Fitness Functions]] - automated review gates
- [[SAP-027 - Architecture Governance at Scale]] - scaling review across many teams
- [[SAP-082 - Architecture Trade-off Framing]] - the criteria used inside reviews

**Alternatives / Comparisons:**
- [[SAP-023 - Architecture Decision Records (ADR) Strategy]] - ADR-only (no review gate)
- [[SAP-081 - Evolutionary Architecture Design]] - fitness-function-only approach
...
│               │ is poured                       │
├───────────────┼──────────────────────────────────┤
│ NEXT EXPLORE  │ SAP-026 Fitness Functions        │
└─────────────────────────────────────────────────┘
```
