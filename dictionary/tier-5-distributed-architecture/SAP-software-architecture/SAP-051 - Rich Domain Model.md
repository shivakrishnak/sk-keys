...
difficulty: ★★★
depends_on: SAP-065, SAP-021
used_by: SAP-067
related: SAP-065, SAP-067
tags:
  - architecture
  - ddd
  - pattern
...
- SAP-065 - Domain Model (the foundational concept; Rich Domain Model is the concrete expression of the Domain Model pattern)
- SAP-021 - Anemic Domain Model (the anti-pattern; understanding what a Rich Domain Model replaces reveals why the investment is worthwhile)

**Builds On This (learn these next):**

- SAP-067 - Aggregate Root (how to define consistency boundaries in a system of rich domain objects; aggregates are the organizing principle for rich models)

**Alternatives / Comparisons:**

- SAP-021 - Anemic Domain Model (correct for simple CRUD with no meaningful business rules; the trade-off is explicit)
