...
used_by: SAP-063
related: SAP-063, SAP-064, SAP-040, SAP-070
tags:
  - architecture
  - pattern
  - advanced
...
- SAP-034 - Layered Architecture (the simpler predecessor; understanding its limitations explains why Ports and Adapters inverts the dependency direction)
- SAP-044 - SOLID Principles (specifically the Dependency Inversion Principle that the port/adapter pattern implements mechanically)

**Builds On This (learn these next):**

- SAP-063 - Hexagonal Architecture (the same pattern described as a shape; Ports and Adapters is the mechanism, Hexagonal is the architecture)
- SAP-040 - Repository Pattern (a specific application of a driven port to database persistence; the most common concrete example)
- SAP-070 - Anti-Corruption Layer (a more complex driven adapter that translates between two domain models at a bounded context boundary)
