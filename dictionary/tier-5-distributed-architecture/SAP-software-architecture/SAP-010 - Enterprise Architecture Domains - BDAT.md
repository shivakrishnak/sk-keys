...
difficulty: ★☆☆
depends_on: SAP-037
used_by: SAP-049, SAP-051, SAP-013
related: SAP-060, SAP-028, SAP-014
tags:
  - architecture
  - foundational
  - mental-model
...
| SAP-038 | Category: Software Architecture Patterns | Difficulty: ★☆☆ |
|:---|:---|:---|
| **Depends on:** | SAP-037 | |
| **Used by:** | SAP-049, SAP-051, SAP-013 | |
| **Related:** | SAP-060, SAP-028, SAP-014 | |
...
- SAP-028 - Formal Architecture Specification (C4, ADL, UML) (application-level decomposition)
- SAP-060 - Enterprise Application Architecture (application-domain focus)
