...
difficulty: ★★☆
depends_on: SAP-044, SAP-048
used_by: 
related: SAP-044, SAP-047, SAP-048
tags:
  - architecture
  - principles
  - pattern
...
- SAP-044 - SOLID Principles (specifically SRP and ISP: LoD violations often indicate that the object being navigated through is not presenting the right interface to its callers)
- SAP-048 - Coupling (LoD is a rule for controlling structural coupling; understanding coupling types helps classify which LoD violations are most harmful)

**Builds On This (learn these next):**

- SAP-047 - Tell Don't Ask (the behavioral companion to LoD: LoD says don't navigate to distant objects; TDA says tell the immediate object to perform the behavior, don't ask it for state and decide externally)
- SAP-044 - SOLID Principles (ISP: LoD violations often expose ISP violations; the intermediate object that exposes navigation chains may need a more focused interface)

**Alternatives / Comparisons:**

- SAP-048 - Coupling (LoD violations create Connascence of Position and structural coupling; understanding coupling types provides the theoretical foundation for why LoD matters)
- SAP-010 - Connascence (precise framework for describing exactly WHAT type of coupling a LoD violation creates)
