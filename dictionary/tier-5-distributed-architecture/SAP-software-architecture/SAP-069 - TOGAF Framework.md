...
difficulty: ★★☆
depends_on: SAP-065, SAP-066, SAP-067, SAP-068
used_by: SAP-070, SAP-073, SAP-074
related: SAP-071, SAP-072, SAP-057
tags:
  - architecture
  - intermediate
  - bestpractice
...
| SAP-069 | Category: Software Architecture Patterns | Difficulty: ★★☆ |
|:---|:---|:---|
| **Depends on:** | SAP-065, SAP-066, SAP-067, SAP-068 | |
| **Used by:** | SAP-070, SAP-073, SAP-074 | |
| **Related:** | SAP-071, SAP-072, SAP-057 | |
...
The iterative cycle of phases (see SAP-070) that guides the development of enterprise architecture from a business vision through to implementation governance. The ADM is the core of TOGAF.
...
- SAP-071 - Zachman Framework (classification vs process)
- SAP-072 - ArchiMate (modelling language that pairs with TOGAF)
...
║                architecture"                     ║
║ NEXT EXPLORE  SAP-070 ADM, SAP-071 Zachman       ║
╚══════════════════════════════════════════════════╝
```
