...
- SAP-040 - Repository Pattern (the Unit of Work coordinates multiple repositories; you must understand repositories before the coordination pattern makes sense)
- SAP-065 - Domain Model (Unit of Work tracks domain object changes; the objects being tracked are domain model entities)

**Builds On This (learn these next):**

- SAP-040 - Repository Pattern (repositories participate in a Unit of Work; understanding both together reveals the full persistence pattern)
- SAP-066 - Data Mapper (the mapping layer that translates between domain objects and database rows, which the Unit of Work coordinates)
