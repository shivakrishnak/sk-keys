...
difficulty: ★★★
depends_on: SAP-034, SAP-019, SAP-065, SAP-044
used_by: SAP-064, SAP-017
related: SAP-064, SAP-017, SAP-034, SAP-019
tags:
  - architecture
  - pattern
  - advanced
...
| Field          | Value                              |
| -------------- | ---------------------------------- |
| **Depends on** | SAP-034, SAP-019, SAP-065, SAP-044 |
| **Used by**    | SAP-064, SAP-017                   |
| **Related**    | SAP-064, SAP-017, SAP-034, SAP-019 |
...
- SAP-019 - Ports and Adapters (the pattern Hexagonal Architecture is named after; understanding ports and adapters is required)
- SAP-034 - Layered Architecture (the simpler predecessor; Hexagonal Architecture evolved as a response to its limitations)
- SAP-044 - SOLID Principles (specifically the Dependency Inversion Principle that underpins port direction)

**Builds On This (learn these next):**

- SAP-064 - Clean Architecture (applies similar isolation with explicit concentric use-case and entity rings)
- SAP-017 - Onion Architecture (another concentric ring variant with the same inward dependency rule)

**Alternatives / Comparisons:**

- SAP-034 - Layered Architecture (simpler; allows infrastructure to influence domain design; no port abstraction requirement)
- SAP-007 - Vertical Slice Architecture (organises by feature rather than by domain/infrastructure boundary; different axis of separation)
