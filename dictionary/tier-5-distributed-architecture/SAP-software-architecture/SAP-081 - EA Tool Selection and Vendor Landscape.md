...
difficulty: ★★★
depends_on: SAP-051, SAP-015, SAP-084
used_by: SAP-030
related: SAP-085, SAP-013, SAP-024
tags:
  - architecture
  - advanced
  - governance
...
| SAP-086 | Category: Software Architecture Patterns | Difficulty: ★★★ |
|:---|:---|:---|
| **Depends on:** | SAP-051, SAP-015, SAP-084 | |
| **Used by:** | SAP-030 | |
| **Related:** | SAP-085, SAP-013, SAP-024 | |
...
- SAP-024 - Architecture Review Process Design (governance tooling overlap)
- SAP-028 - C4 Model (lightweight diagramming alternative)
...
║                LeanIX at L4"                     ║
║ NEXT EXPLORE  SAP-030 EA Framework Theory        ║
╚══════════════════════════════════════════════════╝
```
