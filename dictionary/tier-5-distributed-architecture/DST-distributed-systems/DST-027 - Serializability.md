...
difficulty: ★★★
depends_on: DST-035, DST-038, DST-047
used_by: DST-047, DST-048
related: DST-035, DST-036, DST-038, DST-047, DST-048
tags:
  - distributed
  - consistency
  - database
...
| Metadata        |                                             |     |
| :-------------- | :------------------------------------------ | :-- |
| **Depends on:** | DST-035, DST-038, DST-047                   |     |
| **Used by:**    | DST-047, DST-048                            |     |
| **Related:**    | DST-035, DST-036, DST-038, DST-047, DST-048 |     |
...
- DST-035 - Consistency Models (serializability in the distributed context)
- DST-038 - Linearizability (single-op strong consistency; serializability extends to transactions)
- DST-047 - ACID Properties (the transaction model serializability fulfills)

**Builds On This (learn these next):**

- DST-047 - ACID Properties (full correctness model for transactions)
- DST-048 - Distributed Transactions (2PC, Saga for cross-database serializability)

**Alternatives / Comparisons:**

- DST-038 - Linearizability (single-operation recency vs. multi-operation transaction correctness)
- DST-036 - Strong Consistency (linearizability in the storage layer)
...
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-047 ACID Properties,       |
|                  | DST-048 Distributed Txns       |
+------------------+--------------------------------+
```
