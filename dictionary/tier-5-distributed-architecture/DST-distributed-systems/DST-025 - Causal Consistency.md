...
difficulty: ★★★
depends_on: DST-035, DST-023, DST-041
used_by: DST-039, DST-069
related: DST-035, DST-036, DST-023, DST-040, DST-041
tags:
  - distributed
  - consistency
  - deep-dive
...
| Metadata        |                                             |     |
| :-------------- | :------------------------------------------ | :-- |
| **Depends on:** | DST-035, DST-023, DST-041                   |     |
| **Used by:**    | DST-039, DST-069                            |     |
| **Related:**    | DST-035, DST-036, DST-023, DST-040, DST-041 |     |
...
- DST-035 - Consistency Models (causal consistency in the broader spectrum)
- DST-023 - Eventual Consistency (the weaker model causal consistency extends)
- DST-041 - Vector Clocks (the mechanism for tracking causality)

**Builds On This (learn these next):**

- DST-039 - CRDTs (data types designed for causal + conflict-free consistency)
- DST-040 - Lamport Clock (logical time foundation for causal ordering)
- DST-069 - Consistency Level Selection (practical decision guide)

**Alternatives / Comparisons:**

- DST-036 - Strong Consistency (stronger: linearizability vs causal ordering)
- DST-023 - Eventual Consistency (weaker: no causality guarantee)
...
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-041 Vector Clocks,         |
|                  | DST-039 CRDTs                  |
+------------------+--------------------------------+
```
