...
difficulty: ★★★
depends_on: DST-022, DST-024
used_by: DST-034, DST-036, DST-023, DST-037, DST-038, DST-039
related: DST-022, DST-034, DST-036, DST-023, DST-037
tags:
  - distributed
  - consistency
  - deep-dive
...
| Metadata        |                                                      |     |
| :-------------- | :--------------------------------------------------- | :-- |
| **Depends on:** | DST-022, DST-024                                     |     |
| **Used by:**    | DST-034, DST-036, DST-023, DST-037, DST-038, DST-039 |     |
| **Related:**    | DST-022, DST-034, DST-036, DST-023, DST-037          |     |
...
- DST-022 - CAP Theorem (consistency vs. availability under partition)
- DST-024 - Replication Strategies (how data copies are maintained)

**Builds On This (learn these next):**

- DST-036 - Strong Consistency (linearizability deep dive)
- DST-023 - Eventual Consistency (convergence deep dive)
- DST-037 - Causal Consistency (middle-ground model)
- DST-034 - PACELC (latency-consistency trade-off in normal operation)

**Alternatives / Comparisons:**

- DST-022 - CAP Theorem (the theorem that frames why models exist)
- DST-038 - Serializability (ACID consistency vs. distributed consistency)
...
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-036 Strong Consistency,    |
