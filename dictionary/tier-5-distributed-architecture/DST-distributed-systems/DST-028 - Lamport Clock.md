...
difficulty: ★★★
depends_on: DST-001, DST-035
used_by: DST-036, DST-037, DST-038, DST-041
related: DST-037, DST-038, DST-041, DST-045
tags:
  - distributed
  - algorithm
  - deep-dive
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | DST-001, DST-035                   |     |
| **Used by:**    | DST-036, DST-037, DST-038, DST-041 |     |
| **Related:**    | DST-037, DST-038, DST-041, DST-045 |     |
...
- DST-035 - Consistency Models (why causal ordering matters)

**Builds On This (learn these next):**

- DST-041 - Vector Clocks (extends Lamport to detect concurrent events)
- DST-036 - Strong Consistency (linearizability requires total ordering that Lamport enables)
- DST-037 - Causal Consistency (uses Lamport/vector clocks for dependency tracking)
- DST-038 - Linearizability (Lamport clocks underpin Paxos, which achieves linearizability)

**Alternatives / Comparisons:**

- DST-041 - Vector Clocks (richer: detects concurrency, O(n) space)
- DST-045 - Physical Clocks / TrueTime (stronger: real-time ordering, requires hardware sync)
