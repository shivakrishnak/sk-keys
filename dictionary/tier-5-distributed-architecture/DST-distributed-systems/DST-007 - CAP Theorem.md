...
used_by: DST-034, DST-069
related: DST-034, DST-035, DST-023, DST-024
tags:
  - distributed
  - consistency
  - availability
...
- [[DST-035 - Consistency Models]] - the spectrum of consistency CAP's "C" sits at the top of

**Builds On This (learn these next):**

- [[DST-034 - PACELC]] - extends CAP with the latency-consistency trade-off
- [[DST-069 - Consistency Model Selection Framework]] - applying CAP to system design decisions

**Alternatives / Comparisons:**

- [[DST-023 - Eventual Consistency]] - the AP choice's consistency model
- [[DST-024 - BASE]] - the philosophical alternative to ACID for AP systems
