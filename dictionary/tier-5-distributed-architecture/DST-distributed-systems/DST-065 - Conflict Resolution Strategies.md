...
# DST-021 - Conflict Resolution Strategies
...
- DST-020 - CRDT (understanding what conflict-free alternatives look like)

**Builds On This (learn these next):**
- DST-067 - Anti-Entropy (how conflicting versions are discovered and resolved)

**Alternatives / Comparisons:**
- DST-020 - CRDT (alternative: design away conflicts mathematically)
...
|                  | happens, not after             |
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-020 CRDT; DST-067 Anti-    |
