...
difficulty: ★★☆
depends_on: DST-022, DST-035, DST-024
used_by: DST-037, DST-039, DST-069
related: DST-022, DST-034, DST-035, DST-036, DST-037
tags:
  - distributed
  - consistency
  - foundational
...
| Metadata        |                                             |     |
| :-------------- | :------------------------------------------ | :-- |
| **Depends on:** | DST-022, DST-035, DST-024                   |     |
| **Used by:**    | DST-037, DST-039, DST-069                   |     |
| **Related:**    | DST-022, DST-034, DST-035, DST-036, DST-037 |     |
...
- DST-022 - CAP Theorem (why eventual consistency is the AP choice)
- DST-035 - Consistency Models (eventual consistency in the broader spectrum)
- DST-024 - Replication Strategies (how async replication enables eventual consistency)

**Builds On This (learn these next):**

- DST-037 - Causal Consistency (stronger model preserving cause-effect ordering)
- DST-039 - CRDTs (data types enabling correct eventual consistency without conflicts)
- DST-069 - Consistency Level Selection (practical per-operation guide)

**Alternatives / Comparisons:**

- DST-036 - Strong Consistency (the stronger trade-off: correctness at coordination cost)
- DST-037 - Causal Consistency (intermediate: preserves causality, not full ordering)
