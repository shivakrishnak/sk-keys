...
difficulty: ★★★
depends_on: DST-045, DST-051
used_by: DST-046, DST-050
related: DST-046, DST-050, DST-051
tags:
  - distributed
  - consensus
  - algorithm
...
| Metadata        |                           |     |
| :-------------- | :------------------------ | :-- |
| **Depends on:** | DST-045, DST-051          |     |
| **Used by:**    | DST-046, DST-050          |     |
| **Related:**    | DST-046, DST-050, DST-051 |     |
...
- DST-045 - Leader Election (Multi-Paxos requires a stable leader for Phase 1 amortization)
- DST-051 - Quorum (Paxos safety depends on majority quorum intersection)

**Builds On This (learn these next):**

- DST-046 - Raft (practical, understandable reimplementation of Multi-Paxos concepts)
- DST-050 - State Machine Replication (Paxos/Multi-Paxos as the consensus layer for SMR)

**Alternatives / Comparisons:**

- DST-046 - Raft (equivalent safety properties, better specified and more widely deployed)
- DST-051 - Quorum (the mathematical foundation shared by all consensus algorithms)
