...
difficulty: ★★★
depends_on: DST-015, DST-014
used_by:
related: DST-015, DST-016, DST-047
tags:
  - distributed
  - transactions
  - consistency
...
# DST-017 - Three-Phase Commit (3PC)
...
- DST-015 - Two-Phase Commit (2PC) (3PC is a direct extension of 2PC — understanding 2PC is mandatory)
- DST-014 - Failure Modes (understanding crash vs. partition failures explains why 3PC fails in async networks)
...
- DST-015 - Two-Phase Commit (2PC blocking vs. 3PC non-blocking trade-off)
- DST-016 - Two-Phase Commit practical (XA implementations that use 2PC, not 3PC)
- DST-047 - Paxos (Paxos-commit is the practical non-blocking alternative to 3PC)
...
|                  | network partitions             |
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-047 Paxos (correct fix),   |
|                  | DST-015 Two-Phase Commit       |
+------------------+--------------------------------+
```
