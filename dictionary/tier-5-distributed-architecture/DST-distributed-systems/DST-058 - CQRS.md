...
difficulty: ★★★
depends_on: DST-056, DST-062
related: DST-062, DST-056, DST-015
tags:
  - distributed
  - architecture
  - pattern
...
- DST-056 - Saga Pattern (command side orchestrates sagas for distributed transactions)
- DST-062 - Event Sourcing (write side alternative; CQRS + ES is the classic combination)

**Builds On This (learn these next):**

- DST-062 - Event Sourcing (natural extension of CQRS write side)
- DST-056 - Saga Pattern (commanding distributed workflows in CQRS systems)

**Alternatives / Comparisons:**

- DST-015 - Eventual Consistency (CQRS read model is eventually consistent — understand the trade-off)
