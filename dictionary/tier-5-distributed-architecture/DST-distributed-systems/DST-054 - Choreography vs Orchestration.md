...
difficulty: ★★★
depends_on: DST-056
related: DST-056, DST-062, DST-015, DST-061
tags:
  - distributed
  - pattern
  - architecture
...
# DST-057 - Choreography vs Orchestration
...
- DST-056 - Saga Pattern (choreography and orchestration are the two ways to implement sagas — understand sagas first)

**Builds On This (learn these next):**

- DST-062 - Event Sourcing (event sourcing stores state as events — natural pairing with choreography)
- DST-015 - Outbox Pattern (reliable event publishing required for both choreography and orchestration)

**Alternatives / Comparisons:**

- DST-056 - Saga Pattern (the context in which choreography vs orchestration is most often decided)
- DST-061 - CQRS (often combined with choreography — events update read models)
...
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-056 Saga, DST-062 Event    |
