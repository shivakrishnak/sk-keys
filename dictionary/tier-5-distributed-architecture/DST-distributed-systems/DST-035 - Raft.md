...
difficulty: ★★★
depends_on: DST-045, DST-049, DST-051
used_by: DST-050
related: DST-047, DST-049, DST-050
tags:
  - distributed
  - consensus
  - algorithm
...
| Metadata        |                           |     |
| :-------------- | :------------------------ | :-- |
| **Depends on:** | DST-045, DST-049, DST-051 |     |
| **Used by:**    | DST-050                   |     |
| **Related:**    | DST-047, DST-049, DST-050 |     |
...
- DST-045 - Leader Election (Raft's first subproblem — who sequences operations)
- DST-049 - Log Replication (Raft's second subproblem — how operations propagate)
- DST-051 - Quorum (the mathematical basis for Raft's safety guarantees)

**Builds On This (learn these next):**

- DST-050 - State Machine Replication (Raft as the consensus layer for SMR)
- DST-047 - Paxos (the alternative consensus algorithm; compare trade-offs)

**Alternatives / Comparisons:**

- DST-047 - Paxos (equivalent safety properties, different design philosophy)
- DST-049 - Log Replication (the mechanism Raft uses for state propagation)
