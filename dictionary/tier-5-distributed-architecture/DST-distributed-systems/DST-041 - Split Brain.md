...
difficulty: ★★★
depends_on: DST-051, DST-045, DST-022
used_by: DST-013
related: DST-051, DST-013, DST-022, DST-045
tags:
  - distributed
  - reliability
  - architecture
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | DST-051, DST-045, DST-022          |     |
| **Used by:**    | DST-013                            |     |
| **Related:**    | DST-051, DST-013, DST-022, DST-045 |     |
...
- DST-051 - Quorum (the mathematical prevention mechanism for split brain)
- DST-045 - Leader Election (the distributed election process that split brain corrupts)
- DST-022 - CAP Theorem (split brain is the partition scenario in CAP — you must choose C or A)

**Builds On This (learn these next):**

- DST-013 - Fencing / Epoch (the storage-level enforcement mechanism that completes split-brain prevention after quorum failure)

**Alternatives / Comparisons:**

- DST-051 - Quorum (mathematical prevention vs. STONITH physical prevention)
- DST-013 - Fencing / Epoch (fencing token as the operational complement to quorum)
- DST-022 - CAP Theorem (formal framework for the availability-consistency trade-off split brain forces)
