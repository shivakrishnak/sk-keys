...
used_by: DST-049, DST-050
related: DST-049, DST-051, DST-036, DST-023
tags:
  - distributed
  - replication
  - reliability
...
# DST-048 - Replication Strategies
...
- DST-022 - CAP Theorem (replication strategy is a specific CAP trade-off)
- DST-035 - Consistency Models (each replication strategy produces a specific consistency model)

**Builds On This (learn these next):**

- DST-049 - Log Replication (the mechanism used in single-leader replication)
- DST-050 - State Machine Replication (consensus-based replication for strong consistency)

**Alternatives / Comparisons:**

- DST-051 - Quorum (mathematical basis for leaderless replication guarantees)
- DST-036 - Eventual Consistency (the consistency model produced by async replication)
- DST-023 - Strong Consistency (the consistency model produced by sync replication)
