...
difficulty: ★★★
depends_on: DST-040, DST-041, DST-035
used_by: DST-036, DST-038, DST-050
related: DST-040, DST-041, DST-038, DST-043
tags:
  - distributed
  - algorithm
  - deep-dive
...
# DST-011 - Total Order - Partial Order
...
| Metadata        |                                    |     |
| :-------------- | :--------------------------------- | :-- |
| **Depends on:** | DST-040, DST-041, DST-035          |     |
| **Used by:**    | DST-036, DST-038, DST-050          |     |
| **Related:**    | DST-040, DST-041, DST-038, DST-043 |     |
...
- DST-040 - Lamport Clock (provides one total extension of the happens-before partial order)
- DST-041 - Vector Clock (captures the partial order precisely)
- DST-035 - Consistency Models (how ordering guarantees relate to consistency)

**Builds On This (learn these next):**

- DST-036 - Strong Consistency (linearizability requires total order)
- DST-038 - Linearizability (the consistency model that requires total order)
- DST-050 - State Machine Replication (requires total order broadcast)

**Alternatives / Comparisons:**

- DST-043 - Total Order Partial Order (implementation-focused treatment of same topic)
- DST-040 - Lamport Clock (provides total order extension of partial order)
...
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-050 State Machine Rep.,    |
