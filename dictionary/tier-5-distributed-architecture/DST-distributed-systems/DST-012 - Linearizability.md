...
difficulty: ★★★
depends_on: DST-008, DST-009, DST-015
used_by: DST-017, DST-020, DST-021
related: DST-008, DST-009, DST-013, DST-015, DST-019
tags:
  - distributed
  - consistency
  - deep-dive
...
| Metadata        |                                             |     |
| :-------------- | :------------------------------------------ | :-- |
| **Depends on:** | DST-008, DST-009, DST-015                   |     |
| **Used by:**    | DST-017, DST-020, DST-021                   |     |
| **Related:**    | DST-008, DST-009, DST-013, DST-015, DST-019 |     |
...
- DST-008 - Consistency Models (linearizability in the broader spectrum)
- DST-009 - Strong Consistency (practical strong consistency = linearizability)
- DST-015 - Lamport Clock (logical time ordering underpins linearizability reasoning)

**Builds On This (learn these next):**

- DST-017 - Leader Election (requires linearizability to be safe)
- DST-020 - Distributed Locking (linearizable CAS = correct distributed lock)
- DST-021 - Consensus Algorithms (the mechanism implementing linearizability)

**Alternatives / Comparisons:**

- DST-013 - Serializability (transaction-level correctness vs. single-op linearizability)
- DST-019 - Raft (a specific consensus algorithm implementing linearizability)
