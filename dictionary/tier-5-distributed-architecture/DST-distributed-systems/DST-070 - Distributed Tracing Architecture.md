...
# DST-071 - Distributed Tracing Architecture
...
| :-------------- | :--------------------------------- | :-------------- |
| **Depends on:** | DST-056, DST-057, DST-058          |                 |
| **Used by:**    | DST-068                            |                 |
| **Related:**    | DST-056, DST-057, DST-058, DST-031 |                 |
...
- [[DST-056 - Observability]]
- [[DST-057 - Distributed Tracing]]
- [[DST-058 - OpenTelemetry]]

**Builds On This (learn these next):**

- [[DST-031 - Sampling Strategies]]
