...
difficulty: ★★☆
depends_on: DST-022, DST-023, DST-047
used_by: DST-023, DST-069
related: DST-022, DST-034, DST-023, DST-047, DST-048
tags:
  - distributed
  - consistency
  - foundational
...
| Metadata        |                                             |     |
| :-------------- | :------------------------------------------ | :-- |
| **Depends on:** | DST-022, DST-023, DST-047                   |     |
| **Used by:**    | DST-023, DST-069                            |     |
| **Related:**    | DST-022, DST-034, DST-023, DST-047, DST-048 |     |
...
- DST-022 - CAP Theorem (why BASE exists: AP systems in CAP)
- DST-023 - Eventual Consistency (the "E" in BASE)
- DST-047 - ACID Properties (what BASE contrasts with)

**Builds On This (learn these next):**

- DST-023 - Eventual Consistency (deep dive into BASE's consistency model)
- DST-069 - Consistency Level Selection (practical guide for choosing BASE vs ACID per operation)

**Alternatives / Comparisons:**

- DST-047 - ACID Properties (the opposite pole: immediate consistency + atomicity)
- DST-048 - Distributed Transactions (attempts to bring ACID to distributed BASE systems)
...
+------------------+--------------------------------+
| NEXT EXPLORE     | DST-023 Eventual Consistency,  |
|                  | DST-047 ACID Properties        |
+------------------+--------------------------------+
```
