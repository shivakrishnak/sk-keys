...
# DST-077 - Failure-First Thinking
...
| :-------------- | :------------------------------------------ | :-------------- |
| **Depends on:** | DST-001, DST-002, DST-004, DST-027, DST-009 |                 |
...
2. IMPACT ANALYSIS
   ...
   - What is the blast radius? (DST-070)
...
| NEXT EXPLORE    DST-070, FMEA, Chaos engineering    |
+-----------------------------------------------------+
```
